...
Use this folder for locale-specific translation guidance that supplements `.kodu/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/kodu/pull/12345

## Do Not Translate (Locale Additions)

- `Kodu` (preserve casing)
