...
- PR #10809: https://github.com/anomalyco/kodu/pull/10809
- PR #11496: https://github.com/anomalyco/kodu/pull/11496

## Do Not Translate (Locale Additions)

- `Kodu` (preserve casing in prose; keep `kodu` only in commands, package names, paths, or code)
- `Kodu CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
