...
- PR #15835: https://github.com/anomalyco/kodu/pull/15835

## Do Not Translate (Locale Additions)

- `Kodu` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `kodu` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Kodu` in prose, `kodu` only for exact technical identifiers
...
- Avoid changing `kodu` to `Kodu` inside commands, URLs, package names, or code literals
