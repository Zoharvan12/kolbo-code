...
- PR #13942: https://github.com/anomalyco/kodu/pull/13942

## Do Not Translate (Locale Additions)

- `Kodu` (preserve casing in prose; keep `kodu` only when it is part of commands, package names, paths, or code)
- `Kodu Zen`
- `Kodu CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `kodu` in prose when referring to the product name; use `Kodu`
