...
Kodu is also available as a desktop application. Download directly from the [releases page](https://github.com/anomalyco/kodu/releases) or [kodu.ai/download](https://kodu.ai/download).
...
1. `$KODU_INSTALL_DIR` - Custom installation directory
2. `$XDG_BIN_DIR` - XDG Base Directory Specification compliant path
3. `$HOME/bin` - Standard user binary directory (if it exists or can be created)
4. `$HOME/.kodu/bin` - Default fallback
...
Kodu includes two built-in agents you can switch between with the `Tab` key.
...
Learn more about [agents](https://kodu.ai/docs/agents).

### Documentation

For more info on how to configure Kodu, [**head over to our docs**](https://kodu.ai/docs).

### Contributing

If you're interested in contributing to Kodu, please read our [contributing docs](./CONTRIBUTING.md) before submitting a pull request.
...
- 100% open source
- Not coupled to any provider. Although we recommend the models we provide through [Kodu Zen](https://kodu.ai/zen), Kodu can be used with Claude, OpenAI, Google, or even local models. As models evolve, the gaps between them will close and pricing will drop, so being provider-agnostic is important.
- Out-of-the-box LSP support
- A focus on TUI. Kodu is built by neovim users and the creators of [terminal.shop](https://terminal.shop); we are going to push the limits of what's possible in the terminal.
...
**Join our community** [Discord](https://discord.gg/kodu) | [X.com](https://x.com/kodu)
