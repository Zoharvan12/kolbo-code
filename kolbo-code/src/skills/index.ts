...
import motionDesignSkill from "./motion-design.md";
...
const guidanceSkillContent: Record<(typeof GUIDANCE_SKILLS)[number], string> = {
  ...
  "motion-design": motionDesignSkill,
};
...
- motion-design: announcement videos, product reveals, multi-scene videos, cinematic feel, camera shake, whip pan transitions, beat-driven timing, word reveal animations, professional motion graphics, brand videos, launch videos
