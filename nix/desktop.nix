...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  preBuild = ''
    ...
    cp ${kodu}/bin/kodu packages/desktop/src-tauri/sidecars/opencode-cli-${stdenv.hostPlatform.rust.rustcTarget}
  '';
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/Kodu $out/bin/opencode-desktop
    sed -i 's|^Exec=Kodu$|Exec=opencode-desktop|' $out/share/applications/Kodu.desktop
  '';

  meta = {
    description = "Kodu Desktop App";
    homepage = "https://kodu.ai";
    license = lib.licenses.mit;
    mainProgram = "opencode-desktop";
    inherit (kodu.meta) platforms;
  };
})
