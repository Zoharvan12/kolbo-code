export const dict = {
  ...
  "error.page.authExpired.title": "انتهت صلاحية جلستك",
  "error.page.authExpired.description": "بيانات اعتماد API الخاصة بك غير صالحة أو منتهية الصلاحية. أعد تشغيل التطبيق لتسجيل الدخول مرة أخرى.",
  "error.page.authExpired.restart": "إعادة التشغيل وتسجيل الدخول",
  ...
  "sidebar.sessions.empty": "لا توجد جلسات بعد",
