export const dict = {
  ...
  "command.prompt.mode.shell": "شل",
  "command.prompt.mode.normal": "موجه",
  ...
  "dialog.provider.kodu.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.kodu.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.koduGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.sort.label": "فرز",
  "dialog.model.sort.name": "الاسم",
  "dialog.model.sort.price": "السعر",
  ...
  "provider.connect.apiKey.description": "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Kodu.",
  ...
  "provider.connect.koduZen.line2": "باستخدام مفتاح API واحد، ستحصل على إمكانية الوصول إلى نماذج مثل Claude و GPT و Gemini و GLM والمزيد.",
  "provider.connect.koduZen.visit.prefix": "قم بزيارة ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix": " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Kodu.",
  ...
  "provider.custom.field.providerID.placeholder": "مزود الخدمة الخاص بي",
  ...
  "provider.custom.models.id.placeholder": "معرف النموذج",
  ...
  "provider.custom.headers.key.placeholder": "اسم الرأس",
  ...
  "model.tag.cost.low": "تكلفة منخفضة",
  "model.tag.cost.medium": "تكلفة متوسطة",
  "model.tag.cost.high": "تكلفة عالية",
  "model.tag.default": "افتراضي",
  ...
  "model.tooltip.pricing": "التسعير: {{value}}",
  "model.tooltip.typicalCost.unit": "رصيد لكل رسالة",
  "model.tooltip.typicalCost.hint": "رسالة نموذجية. المحادثات الأطول تستهلك أكثر.",
  ...
  "prompt.mode.shell": "شل",
  "prompt.mode.normal": "موجه",
  "prompt.approval.label": "وضع الموافقة",
  "prompt.approval.auto": "تشغيل تلقائي",
  "prompt.approval.ask": "السؤال أولاً",
  "prompt.approval.auto.long": "تشغيل تلقائي دون سؤال",
  "prompt.approval.ask.long": "التأكيد قبل التشغيل",
  "prompt.mode.shell.exit": "esc للخروج",
  "session.child.promptDisabled": "لا يمكن تقديم جلسات الوكيل الفرعي.",
  "session.child.backToParent": "العودة إلى الجلسة الرئيسية.",
  "session.working.for": "نعمل منذ {{time}}",
  ...
  "prompt.action.uploading": "جارٍ تحميل المرفقات…",
  "prompt.action.dictate": "إملاء (تحويل الصوت إلى نص)",
  "prompt.action.dictateStop": "إيقاف الإملاء",
  "prompt.voice.listening": "جاري الاستماع…",
  "prompt.voice.error.notLoggedIn": "سجّل الدخول إلى Kolbo لاستخدام ميزة الإملاء الصوتي",
  "prompt.voice.error.mic": "الميكروفون غير متاح - تحقق من أذونات النظام",
  "prompt.voice.error.connection": "خدمة الصوت غير متاحة - حاول مرة أخرى",
  ...
  "prompt.toast.fileTooLarge.title": "الملف كبير جداً",
  "prompt.toast.fileTooLarge.description": "يجب أن تكون ملفات الوسائط أقل من 200 ميغابايت.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في kodu.json",
  ...
  "dialog.server.add.namePlaceholder": "المضيف المحلي",
  ...
  "context.stats.creditsBalance": "رصيد النقاط",
  ...
  "context.usage.credits": "الرصيد",
  "context.usage.credits.image": "صورة",
  "context.usage.credits.video": "فيديو",
  "context.usage.credits.audio": "صوت",
  "context.usage.credits.threeD": "ثلاثي الأبعاد",
  ...
  "language.he": "العبرية",
  "language.hi": "الهندية",
  "dialog.login.status.browserOpened": "تم فتح المتصفح - قم بتسجيل الدخول هناك",
  "dialog.login.confirmationCode": "رمز التأكيد",
  "dialog.login.copy": "نسخ",
  "dialog.login.copied": "تم النسخ",
  "session.header.zoom.out": "تصغير (Ctrl/Cmd -)",
  "session.header.zoom.in": "تكبير (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "تصغير",
  "session.header.zoom.in.ariaLabel": "تكبير",
  "session.header.colorScheme.toLightMode": "التحويل إلى الوضع الفاتح",
  "session.header.colorScheme.toDarkMode": "التبديل إلى الوضع المظلم",
  "session.header.tab.terminal": "الطرفية",
  "session.header.tab.review": "مراجعة",
  "session.header.tab.files": "الملفات",
  "settings.general.row.downloadFolder.title": "مجلد التنزيل",
  "settings.general.row.downloadFolder.description": "المكان الذي يتم فيه حفظ الملفات التي تم تنزيلها",
  "settings.general.row.downloadFolder.change": "تغيير",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (kodu.json)",
  ...
  "session.tab.artifacts": "الأدوات (Artifacts)",
  "session.tab.canvas": "اللوحة",
  "session.header.tab.canvas": "اللوحة",
  "command.canvas.toggle": "تبديل اللوحة",
  "canvas.empty": "ستظهر هنا الصور والفيديوهات والملفات الصوتية والأصول ثلاثية الأبعاد التي تم إنشاؤها في هذه الجلسة.",
  "canvas.density": "التخطيط",
  "canvas.density.cols": "{{count}} في كل صف",
  "canvas.select": "تحديد",
  "canvas.cancelSelection": "إلغاء التحديد",
  "canvas.clearSelection": "مسح",
  "canvas.selected.count": "تم تحديد {{count}}",
  "canvas.downloadSelected": "تنزيل",
  "canvas.downloadSelected.toast": "تم تنزيل {{count}} ملفات",
  "canvas.downloadSelected.toastDescription": "تم الحفظ في مجلد التنزيلات",
  "canvas.downloadSelected.partialFailed": "فشل تنزيل {{count}}",
  "canvas.hideSelected": "إخفاء",
  "canvas.hideSelected.toast": "تم إخفاء {{count}} من اللوحة",
  "canvas.hide.tooltip": "إخفاء من اللوحة",
  "canvas.tab.session": "الجلسة",
  "canvas.tab.library": "المكتبة",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "لا توجد وسائط بعد",
  "canvas.library.empty.caption.filtered": "لا توجد نتائج تطابق الفلاتر الحالية.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "قم بإنشاء أو تحميل شيء لملء مكتبتك.",
  "canvas.library.search.placeholder": "بحث في المكتبة…",
  "canvas.library.project.all": "كل المشاريع",
  "canvas.library.project.pick": "اختر مشروعاً",
  "canvas.library.filter.type.all": "الكل",
  "canvas.library.filter.type.images": "الصور",
  "canvas.library.filter.type.videos": "الفيديوهات",
  "canvas.library.filter.type.audio": "الصوتيات",
  "canvas.library.filter.category.all": "الكل",
  "canvas.library.filter.category.ai": "AI",
  "canvas.library.filter.category.uploaded": "تم تحميله",
  "canvas.library.filter.category.favorites": "المفضلة",
  "canvas.library.filter.category.trash": "سلة المهملات",
  "canvas.library.folder.pick": "المجلد",
  "canvas.library.folder.all": "كل المجلدات",
  "canvas.library.folder.owned": "مجلداتي",
  "canvas.library.folder.shared": "مشاركة معي",
  "canvas.library.filter.category.edited": "معدّل",
  "canvas.library.filter.category.training-lab": "مختبر التدريب",
  "canvas.library.favorite.add": "إضافة للمفضلة",
  "canvas.library.favorite.remove": "إزالة من المفضلة",
  "canvas.library.nsfw.hidden": "محتوى غير مخصص للجميع — اضغط للكشف",
  "canvas.library.nsfw.reveal": "كشف",
  "canvas.library.error": "فشل تحميل المكتبة",
  "canvas.library.retry": "إعادة المحاولة",
  "canvas.library.signedOut": "سجل الدخول إلى Kolbo لتصفح مكتبتك",
  "artifact.preview": "معاينة",
  "artifact.code": "الكود",
  "artifact.openInTab": "فتح في علامة تبويب جديدة",
  "artifact.publish": "نشر",
  "artifact.publish.title": "نشر الملف",
  "artifact.publish.defaultTitle": "ملف Kolbo Code",
  "artifact.publish.loading": "جاري النشر…",
  "artifact.publish.urlLabel": "رابط عام",
  "artifact.publish.copy": "نسخ",
  "artifact.publish.copied": "تم النسخ",
  "artifact.publish.open": "فتح في المتصفح",
  "session.panel.reviewAndFiles": "المراجعة والملفات",
  "session.panel.close": "إغلاق اللوحة",
  ...
  "session.review.noUncommittedChanges": "لا توجد تغييرات غير مثبتة بعد",
  ...
  "session.new.title": "ما الذي سنبدع فيه اليوم؟",
  "session.new.subtitle": "من صفحة هبوط إلى صور، فيديو، أو موسيقى — صف لنا الفكرة.",
  ...
  "session.new.starter.landing.title": "بناء صفحة هبوط",
  "session.new.starter.landing.body": "صف المنتج أو الفكرة — وسأقوم بتصميم ونشر صفحة احترافية.",
  "session.new.starter.landing.prompt": "أنشئ صفحة هبوط لتطبيق اشتراك قهوة باسم Brew — قسم رئيسي داكن، زر CTA باللون البرتقالي الدافئ، ثلاث بطاقات للمميزات، وقسم للأسعار.",
  "session.new.starter.images.title": "توليد 4 صور",
  "session.new.starter.images.body": "أخبرني بالمفهوم — وسأقوم بإنشاء 4 تنويعات باستخدام النموذج المناسب للنمط.",
  "session.new.starter.images.prompt": "استخدم أداة Creative Director لإنشاء 4 صور تروي قصة قصيرة عن رائد فضاء يكتشف حديقة خفية على سطح القمر — مع الحفاظ على نفس الشخصية في جميع الإطارات الأربعة.",
  "session.new.starter.video.title": "إنشاء فيديو قصير",
  "session.new.starter.video.body": "اشرح اللقطة — وسأقوم بتوليدها (Kling, Seedance, Sora) والعمل على تحسين الحركة.",
  "session.new.starter.video.prompt": "أنشئ فيديو قصيراً يحتوي على عدة لقطات لمدينة مستقبلية عند الغسق باستخدام Seedance 2 — لقطة افتتاحية واسعة، ثم تحريك بمستوى الشارع، ثم لقطة قريبة لإشارات النيون.",
  "session.new.starter.music.title": "تأليف موسيقى أو تعليق صوتي",
  "session.new.starter.music.body": "صف الأجواء أو النص — وسأقوم بإنتاج الصوت باستخدام Suno أو ElevenLabs.",
  "session.new.starter.music.prompt": "ألّف مقطعاً موسيقياً بأسلوب lofi مع بيانو هادئ وإيقاعات ناعمة — أجواء دراسة مريحة.",
  "session.new.starter.ugc.title": "إنشاء إعلان UGC",
  "session.new.starter.ugc.body": "زودني بالمنتج، وسأقوم بإنتاج إعلان UGC بأسلوب الحديث المباشر مع صانع محتوى ثابت.",
  "session.new.starter.ugc.prompt": "أنشئ إعلان UGC لمدة 15 ثانية بأسلوب الحديث المباشر لسيروم عناية بالبشرة — صانع محتوى يبدو طبيعياً يحمل المنتج، تصوير بأسلوب السيلفي العفوي، إضاءة طبيعية، مع مراجعة صوتية قصيرة.",
  "session.new.starter.productAnimation.title": "تحريك المنتج",
  "session.new.starter.productAnimation.body": "أرني المنتج، وسأضفي عليه الحيوية والحركة.",
  "session.new.starter.productAnimation.prompt": "قم بتحريك هذا المنتج — دوران سينمائي بطيء بزاوية 360 درجة لحذاء رياضي على خلفية استوديو نظيفة مع إضاءة خافتة ومتحركة.",
  "session.new.starter.productPhotoshoot.title": "جلسة تصوير للمنتج",
  "session.new.starter.productPhotoshoot.body": "صور منتجات بجودة استوديو احترافية دون الحاجة لاستوديو — فقط صف لي النتيجة المطلوبة.",
  "session.new.starter.productPhotoshoot.prompt": "أنشئ جلسة تصوير احترافية لزجاجة عطر زجاجية — لقطة ترويجية نمط حياة على رخام مع ظلال ناعمة، بالإضافة إلى صورة للمنتج بخلفية بيضاء نقية.",
  "session.new.starter.aiInfluencer.title": "مؤثر ذكاء اصطناعي",
  "session.new.starter.aiInfluencer.body": "أنشئ شخصية افتراضية ثابتة يمكنك إعادة استخدامها في لقطات مختلفة.",
  "session.new.starter.aiInfluencer.prompt": "أنشئ مؤثر ذكاء اصطناعي ثابت الملامح — امرأة خبيرة في التكنولوجيا في أواخر العشرينيات — وثبّت هويتها باستخدام Visual DNA حتى أتمكن من إعادة استخدامها في المنشورات ومقاطع الفيديو المستقبلية.",
  ...
  "session.header.open.finder": "فايندر",
  ...
  "common.showArchivedSessions": "إظهار الجلسات المؤرشفة",
  "common.hideArchivedSessions": "إخفاء الجلسات المؤرشفة",
  "common.delete": "حذف",
  "common.close": "إغلاق",
  "common.edit": "تحرير",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "إظهار أجزاء أداة shell موسعة بشكل افتراضي في الشريط الزمني",
  "settings.general.row.editToolPartsExpanded.title": "توسيع أجزاء أداة edit",
  "settings.general.row.editToolPartsExpanded.description": "إظهار أجزاء أدوات edit و write و patch موسعة بشكل افتراضي في الشريط الزمني",
  "settings.general.row.showSessionProgressBar.title": "إظهار شريط تقدم الجلسة",
  "settings.general.row.showSessionProgressBar.description": "عرض شريط تقدم متحرك أعلى الجلسة عند عمل الوكيل",
  ...
  "settings.general.row.releaseNotes.description": "عرض نوافذ What's New بعد التحديثات",
