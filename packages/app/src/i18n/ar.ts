export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Kodu",
  ...
  "provider.connect.koduZen.line1": "يمنحك Kodu Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "prompt.toast.fileTooLarge.description": "يجب أن تكون ملفات الصوت والفيديو أقل من {{max}}.",
  ...
  "dialog.server.description": "تبديل خادم Kodu الذي يتصل به هذا التطبيق.",
  ...
  "language.he": "العبرية",
  "language.hi": "الهندية",
  "dialog.login.title": "مرحباً بك في Kolbo Code",
  "dialog.login.subtitle": "قم بتسجيل الدخول باستخدام حساب Kolbo.AI الخاص بك للمتابعة",
  "dialog.login.button.continue": "المتابعة مع Kolbo",
  ...
  "toast.update.description": "نسخة جديدة من Kodu ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Kodu",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Kodu نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Kodu داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Kodu",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Kodu على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Kodu يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Kodu.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Kodu",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Kodu.",
