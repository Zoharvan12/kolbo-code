export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Kodu",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "prompt.toast.fileTooLarge.description": "Arquivos de áudio e vídeo devem ter menos de {{max}}.",
  ...
  "dialog.server.description": "Trocar para qual servidor Kodu este aplicativo se conecta.",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": "Bem-vindo ao Kolbo Code",
  "dialog.login.subtitle": "Faça login com sua conta Kolbo.AI para continuar",
  "dialog.login.button.continue": "Continuar com Kolbo",
  ...
  "toast.update.description": "Uma nova versão do Kodu ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Kodu",
  ...
  "sidebar.gettingStarted.line1": "Kodu inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Kodu dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Kodu",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Kodu aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Kodu segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Kodu é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Kodu iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Kodu.",
