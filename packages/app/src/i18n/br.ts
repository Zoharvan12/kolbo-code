export const dict = {
  ...
  "dialog.provider.kodu.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.kodu.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.koduGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.sort.name": "Nome",
  "dialog.model.sort.price": "Preço",
  ...
  "provider.connect.apiKey.description": "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Kodu.",
  ...
  "provider.connect.koduZen.line2": "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.koduZen.visit.prefix": "Visite ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix": " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Kodu.",
  ...
  "model.tag.cost.low": "Custo baixo",
  "model.tag.cost.medium": "Custo médio",
  "model.tag.cost.high": "Custo alto",
  "model.tag.default": "Padrão",
  ...
  "model.tooltip.pricing": "Preço: {{value}}",
  "model.tooltip.typicalCost.unit": "créditos por mensagem",
  "model.tooltip.typicalCost.hint": "Mensagem típica. Conversas mais longas consomem mais.",
  ...
  "prompt.approval.auto": "Execução automática",
  "prompt.approval.ask": "Perguntar primeiro",
  "prompt.approval.auto.long": "Executar automaticamente sem perguntar",
  "prompt.approval.ask.long": "Confirmar antes de executar",
  "prompt.mode.shell.exit": "esc para sair",
  "session.child.promptDisabled": "Sessões de subagente não podem ser solicitadas.",
  "session.child.backToParent": "Voltar para a sessão principal.",
  "session.working.for": "Trabalhando há {{time}}",
  ...
  "prompt.action.uploading": "Carregando anexos…",
  "prompt.action.dictate": "Ditar (voz para texto)",
  "prompt.action.dictateStop": "Parar ditado",
  "prompt.voice.listening": "Ouvindo…",
  "prompt.voice.error.notLoggedIn": "Faça login no Kolbo para usar o ditado por voz",
  "prompt.voice.error.mic": "Microfone indisponível — verifique as permissões do sistema",
  "prompt.voice.error.connection": "Serviço de voz indisponível — tente novamente",
  ...
  "prompt.toast.fileTooLarge.description": "Arquivos de mídia devem ter menos de 200 MB.",
  ...
  "dialog.plugins.empty": "Plugins configurados em kodu.json",
  ...
  "context.usage.credits.image": "Imagem",
  "context.usage.credits.video": "Vídeo",
  "context.usage.credits.audio": "Áudio",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.status.browserOpened": "Navegador aberto — faça login lá",
  "dialog.login.confirmationCode": "Código de confirmação",
  "dialog.login.copy": "Copiar",
  "dialog.login.copied": "Copiado",
  "session.header.zoom.out": "Reduzir zoom (Ctrl/Cmd -)",
  "session.header.zoom.in": "Aumentar zoom (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Reduzir zoom",
  "session.header.zoom.in.ariaLabel": "Aumentar zoom",
  "session.header.colorScheme.toLightMode": "Mudar para o modo claro",
  "session.header.colorScheme.toDarkMode": "Mudar para o modo escuro",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Revisão",
  "session.header.tab.files": "Arquivos",
  "settings.general.row.downloadFolder.title": "Pasta de downloads",
  "settings.general.row.downloadFolder.description": "Onde os arquivos baixados são salvos",
  "settings.general.row.downloadFolder.change": "Mudar",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (kodu.json)",
  ...
  "session.tab.artifacts": "Artefatos",
  "session.tab.canvas": "Canvas",
  "session.header.tab.canvas": "Canvas",
  "command.canvas.toggle": "Alternar Canvas",
  "canvas.empty": "Imagens, vídeos, áudios e ativos 3D gerados a partir desta sessão aparecerão aqui.",
  "canvas.density": "Layout",
  "canvas.density.cols": "{{count}} por linha",
  "canvas.select": "Selecionar",
  "canvas.cancelSelection": "Cancelar seleção",
  "canvas.clearSelection": "Limpar",
  "canvas.selected.count": "{{count}} selecionados",
  "canvas.downloadSelected": "Baixar",
  "canvas.downloadSelected.toast": "{{count}} arquivos baixados",
  "canvas.downloadSelected.toastDescription": "Salvo na sua pasta de downloads",
  "canvas.downloadSelected.partialFailed": "{{count}} downloads falharam",
  "canvas.hideSelected": "Ocultar",
  "canvas.hideSelected.toast": "{{count}} item(s) oculto(s) da tela",
  "canvas.hide.tooltip": "Ocultar da tela",
  "canvas.tab.session": "Sessão",
  "canvas.tab.library": "Biblioteca",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "Nenhum arquivo ainda",
  "canvas.library.empty.caption.filtered": "Nada corresponde aos filtros atuais.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "Gere ou envie algo para preencher sua biblioteca.",
  "canvas.library.search.placeholder": "Pesquisar na biblioteca…",
  "canvas.library.project.all": "Todos os projetos",
  "canvas.library.project.pick": "Escolher projeto",
  "canvas.library.filter.type.all": "Tudo",
  "canvas.library.filter.type.images": "Imagens",
  "canvas.library.filter.type.videos": "Vídeos",
  "canvas.library.filter.type.audio": "Áudio",
  "canvas.library.filter.category.all": "Tudo",
  "canvas.library.filter.category.ai": "IA",
  "canvas.library.filter.category.uploaded": "Enviados",
  "canvas.library.filter.category.favorites": "Favoritos",
  "canvas.library.filter.category.trash": "Lixeira",
  "canvas.library.folder.pick": "Pasta",
  "canvas.library.folder.all": "Todas as pastas",
  "canvas.library.folder.owned": "Minhas pastas",
  "canvas.library.folder.shared": "Compartilhadas comigo",
  "canvas.library.filter.category.edited": "Editado",
  "canvas.library.filter.category.training-lab": "Lab de treino",
  "canvas.library.favorite.add": "Favoritar",
  "canvas.library.favorite.remove": "Remover dos favoritos",
  "canvas.library.nsfw.hidden": "NSFW — toque para revelar",
  "canvas.library.nsfw.reveal": "Revelar",
  "canvas.library.error": "Falha ao carregar biblioteca",
  "canvas.library.retry": "Tentar novamente",
  "canvas.library.signedOut": "Faça login no Kolbo para navegar em sua biblioteca",
  "artifact.preview": "Visualizar",
  "artifact.code": "Código",
  "artifact.openInTab": "Abrir em nova guia",
  "artifact.publish": "Publicar",
  "artifact.publish.title": "Publicar artefato",
  "artifact.publish.defaultTitle": "Artefato do Kolbo Code",
  ...
  "artifact.publish.open": "Abrir no navegador",
  "session.panel.reviewAndFiles": "Revisão e arquivos",
  "session.panel.close": "Fechar painel",
  ...
  "session.review.noSnapshot": "O rastreamento de snapshot está desabilitado na configuração, então as alterações da sessão estão indisponíveis",
  "session.review.noChanges": "Sem alterações",
  "session.review.noUncommittedChanges": "Nenhuma alteração não confirmada ainda",
  "session.review.noBranchChanges": "Nenhuma alteração de branch ainda",
  ...
  "session.todo.dismiss": "Dispensar",
  ...
  "session.new.title": "O que vamos criar hoje?",
  "session.new.subtitle": "De uma página de destino a imagens, vídeo ou música — descreva a ideia.",
  ...
  "session.new.starter.landing.title": "Criar uma página de destino",
  "session.new.starter.landing.body": "Descreva o produto ou ideia — eu vou projetar e publicar uma página impecável.",
  "session.new.starter.landing.prompt": "Crie uma landing page para um app de assinatura de café chamado Brew — hero escuro, CTA laranja quente, três cartões de recursos e uma seção de preços.",
  "session.new.starter.images.title": "Gerar 4 imagens",
  "session.new.starter.images.body": "Conte-me o conceito — eu criarei 4 variações com o modelo ideal para o estilo.",
  "session.new.starter.images.prompt": "Use a ferramenta Creative Director para gerar 4 imagens que contam uma pequena história sobre um astronauta que encontra um jardim escondido na lua — mantenha o mesmo personagem consistente em todos os 4 quadros.",
  "session.new.starter.video.title": "Criar um vídeo curto",
  "session.new.starter.video.body": "Apresente a cena — eu irei gerá-la (Kling, Seedance, Sora) e iterar no movimento.",
  "session.new.starter.video.prompt": "Faça um vídeo curto com várias tomadas de uma cidade futurista ao entardecer usando Seedance 2 — plano geral aberto, depois uma panorâmica ao nível da rua e por fim um close em letreiros de neon.",
  "session.new.starter.music.title": "Compor música ou narração",
  "session.new.starter.music.body": "Descreva a vibe ou o roteiro — eu produzirei áudio com Suno ou ElevenLabs.",
  "session.new.starter.music.prompt": "Componha uma faixa lofi com piano suave e batidas tranquilas — clima relaxante para estudar.",
  "session.new.starter.ugc.title": "Criar um anúncio UGC",
  "session.new.starter.ugc.body": "Me dê o produto — eu produzirei um anúncio UGC estilo 'talking-head' com um criador consistente.",
  "session.new.starter.ugc.prompt": "Crie um anúncio UGC de 15 segundos estilo 'talking-head' para um sérum de cuidados com a pele — um criador autêntico segurando o produto, enquadramento casual de selfie, iluminação natural, com uma breve avaliação falada.",
  "session.new.starter.productAnimation.title": "Animar um produto",
  "session.new.starter.productAnimation.body": "Mostre-me o produto — eu o trarei à vida com movimento.",
  "session.new.starter.productAnimation.prompt": "Anime este produto em movimento — uma rotação cinematográfica lenta de 360° de um tênis em um fundo de estúdio limpo com luz suave em movimento.",
  "session.new.starter.productPhotoshoot.title": "Ensaio fotográfico de produto",
  "session.new.starter.productPhotoshoot.body": "Fotos de produto com qualidade de estúdio, sem precisar de estúdio — descreva o visual.",
  "session.new.starter.productPhotoshoot.prompt": "Crie um ensaio fotográfico de estúdio para um frasco de perfume de vidro — foto de destaque estilo lifestyle sobre mármore com sombras suaves, além de uma foto de produto com fundo branco limpo.",
  "session.new.starter.aiInfluencer.title": "Influenciador de IA",
  "session.new.starter.aiInfluencer.body": "Crie uma persona virtual consistente que você pode reutilizar em várias fotos.",
  "session.new.starter.aiInfluencer.prompt": "Crie um influenciador de IA consistente — uma mulher antenada em tecnologia na casa dos 20 e poucos anos — e bloqueie sua identidade com Visual DNA para que eu possa reutilizá-la em futuros posts e vídeos.",
  ...
  "common.showArchivedSessions": "Mostrar sessões arquivadas",
  "common.hideArchivedSessions": "Ocultar sessões arquivadas",
  ...
  "debugBar.nav.tip": "Última transição de rota concluída tocando em uma página de sessão, medida desde o início do roteador até a primeira pintura após o estabelecimento.",
  ...
  "debugBar.inp.tip": "Duração aproximada da interação nos últimos 5 segundos. Isso é semelhante ao INP, não o INP oficial do Web Vitals.",
  ...
  "settings.section.desktop": "Área de Trabalho",
  ...
  "settings.general.row.followup.description": "Escolha se os prompts de acompanhamento orientam imediatamente ou esperam na fila",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "Mostrar partes da ferramenta shell expandidas por padrão na linha do tempo",
  "settings.general.row.editToolPartsExpanded.title": "Expandir partes da ferramenta de edição",
  "settings.general.row.editToolPartsExpanded.description": "Mostrar partes das ferramentas de edição, escrita e patch expandidas por padrão na linha do tempo",
  "settings.general.row.showSessionProgressBar.title": "Mostrar barra de progresso da sessão",
  "settings.general.row.showSessionProgressBar.description": "Exibe a barra de progresso animada no topo da sessão quando o agente estiver trabalhando",
