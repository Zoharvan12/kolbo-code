export const dict = {
  ...
  "error.page.authExpired.title": "Sua sessão expirou",
  "error.page.authExpired.description": "Suas credenciais de API são inválidas ou expiraram. Reinicie o aplicativo para entrar novamente.",
  "error.page.authExpired.restart": "Reiniciar e entrar",
  ...
  "sidebar.sessions.empty": "Nenhuma sessão ainda",
