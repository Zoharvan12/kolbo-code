...
export const dict = {
  ...
  "dialog.provider.kodu.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.kodu.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.koduGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Kodu",
  ...
  "provider.connect.apiKey.description": "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Kodu-u.",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.koduZen.line2": "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.koduZen.visit.prefix": "Posjeti ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix": " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Kodu-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Kodu-u.",
  ...
  "model.tag.cost.low": "Nizak trošak",
  "model.tag.cost.medium": "Srednji trošak",
  "model.tag.cost.high": "Visok trošak",
  ...
  "model.tooltip.typicalCost.unit": "kredita po poruci",
  "model.tooltip.typicalCost.hint": "Tipična poruka. Duži razgovori troše više.",
  ...
  "session.child.promptDisabled": "Sesije subagenta ne mogu biti pozvane.",
  ...
  "prompt.action.uploading": "Učitavanje priloga…",
  "prompt.action.dictate": "Diktiranje (glas u tekst)",
  "prompt.action.dictateStop": "Zaustavi diktiranje",
  "prompt.voice.listening": "Slušam…",
  "prompt.voice.error.notLoggedIn": "Prijavite se na Kolbo da biste koristili glasovno diktiranje",
  "prompt.voice.error.mic": "Mikrofon nije dostupan — provjerite sistemske dozvole",
  "prompt.voice.error.connection": "Glasovna usluga nije dostupna — pokušajte ponovo",
  ...
  "prompt.toast.fileTooLarge.title": "Datoteka prevelika",
  "prompt.toast.fileTooLarge.description": "Medijske datoteke moraju biti manje od 200 MB.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u kodu.json",
  ...
  "dialog.server.description": "Promijeni na koji se Kodu server ova aplikacija povezuje.",
  ...
  "context.stats.creditsBalance": "Stanje kredita",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": `Dobrodošli u ${BRAND}`,
  "dialog.login.subtitle": "Prijavite se sa svojim Kolbo.AI računom da nastavite",
  "dialog.login.button.continue": "Nastavi sa Kolbo",
  "dialog.login.status.browserOpened": "Pregledač otvoren — prijavite se tamo",
  "dialog.login.confirmationCode": "Kod potvrde",
  "dialog.login.copy": "Kopiraj",
  "dialog.login.copied": "Kopirano",
  "session.header.zoom.out": "Umanji (Ctrl/Cmd -)",
  "session.header.zoom.in": "Uvećaj (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Smanji",
  "session.header.zoom.in.ariaLabel": "Uvećaj",
  "session.header.colorScheme.toLightMode": "Prebaci na svijetli način",
  "session.header.colorScheme.toDarkMode": "Prebaci na tamni način",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Pregled",
  "session.header.tab.files": "Datoteke",
  "settings.general.row.downloadFolder.title": "Mapa za preuzimanje",
  "settings.general.row.downloadFolder.description": "Gdje se spremaju preuzete datoteke",
  "settings.general.row.downloadFolder.change": "Promijeni",
  ...
  "toast.update.description": "Nova verzija Kodu-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Kodu timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (kodu.json) provider/model names",
  ...
  "session.review.noUncommittedChanges": "Nema nekomitovanih promjena još",
  "session.review.noBranchChanges": "Nema promjena grane još",
  ...
  "session.header.open.fileExplorer": "Istraživač datoteka",
  ...
  "sidebar.gettingStarted.line1": "Kodu uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "sidebar.empty.description": "Otvorite projekat da biste započeli",
  ...
  "settings.desktop.wsl.description": "Pokreni Kodu server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Kodu-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Kodu izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Kodu prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Kodu-a.",
  ...
  "settings.general.row.releaseNotes.description": "Prikaži pop-up obavijesti o novostima nakon ažuriranja",
  "settings.updates.row.startup.title": "Provjeri ažuriranja pri pokretanju",
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Kodu pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Kodu-a.",
  ...
  "session.working.for": "Radi se {{time}}",
  "session.new.starter.ugc.title": "Kreiraj UGC reklamu",
  "session.new.starter.ugc.body": "Daj mi proizvod — ja ću napraviti UGC reklamu sa osobom koja govori, koristeći dosljednog kreatora.",
  "session.new.starter.ugc.prompt": "Kreiraj UGC reklamu od 15 sekundi sa osobom koja govori o serumu za njegu kože — autentičan kreator koji drži proizvod, opušten selfie kadar, prirodno osvjetljenje, uz kratku usmenu recenziju.",
  "session.new.starter.productAnimation.title": "Animiraj proizvod",
  "session.new.starter.productAnimation.body": "Pokaži mi proizvod — ja ću ga oživjeti kroz pokret.",
  "session.new.starter.productAnimation.prompt": "Animiraj ovaj proizvod u pokretu — spora, filmska rotacija patike od 360° na čistoj studijskoj pozadini sa blagim pokretnim svjetlom.",
  "session.new.starter.productPhotoshoot.title": "Profesionalno fotografisanje proizvoda",
  "session.new.starter.productPhotoshoot.body": "Fotografije proizvoda studijskog kvaliteta, bez studija — opiši željeni izgled.",
  "session.new.starter.productPhotoshoot.prompt": "Kreiraj studijsko fotografisanje za staklenu bočicu parfema — lifestyle hero kadar na mermeru sa blagim sjenkama, plus čista fotografija proizvoda na bijeloj pozadini.",
  "session.new.starter.aiInfluencer.title": "AI influencer",
  "session.new.starter.aiInfluencer.body": "Kreiraj dosljednu virtuelnu osobu koju možeš ponovo koristiti u različitim snimcima.",
  "session.new.starter.aiInfluencer.prompt": "Kreiraj dosljednog AI influencera — tehnološki potkovanu ženu u kasnim 20-im godinama — i zaključaj njen identitet pomoću Visual DNA kako bih je mogao koristiti u budućim objavama i video zapisima.",
}
