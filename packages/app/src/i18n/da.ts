...
export const dict = {
  ...
  "command.project.previous": "Tidligere projekt",
  ...
  "dialog.provider.kodu.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.kodu.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.koduGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Kodu",
  ...
  "provider.connect.apiKey.description": "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Kodu.",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.koduZen.line2": "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.koduZen.visit.prefix": "Besøg ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix": " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Kodu.",
  ...
  "model.tag.cost.low": "Lav omkostning",
  "model.tag.cost.medium": "Mellem omkostning",
  "model.tag.cost.high": "Høj omkostning",
  ...
  "model.tooltip.typicalCost.unit": "kreditter pr. besked",
  "model.tooltip.typicalCost.hint": "Typisk besked. Længere samtaler bruger mere.",
  ...
  "session.child.promptDisabled": "Subagent sessioner kan ikke prompts.",
  ...
  "prompt.action.uploading": "Uploader vedhæftninger…",
  "prompt.action.dictate": "Dikter (tale til tekst)",
  "prompt.action.dictateStop": "Stop diktering",
  "prompt.voice.listening": "Lytter…",
  "prompt.voice.error.notLoggedIn": "Log ind på Kolbo for at bruge stemmediktering",
  "prompt.voice.error.mic": "Mikrofonen er utilgængelig — tjek systemtilladelser",
  "prompt.voice.error.connection": "Stemmetjenesten er utilgængelig — prøv igen",
  ...
  "prompt.toast.fileTooLarge.description": "Mediefiler skal være under 200 MB.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i kodu.json",
  ...
  "dialog.server.description": "Skift hvilken Kodu-server denne app forbinder til.",
  ...
  "context.stats.creditsBalance": "Kreditbalance",
  ...
  "dialog.login.subtitle": "Log ind med din Kolbo.AI-konto for at fortsætte",
  "dialog.login.button.continue": "Fortsæt med Kolbo",
  "dialog.login.status.browserOpened": "Browser åbnet — log ind der",
  "dialog.login.confirmationCode": "Bekræftelseskode",
  "dialog.login.copy": "Kopier",
  "dialog.login.copied": "Kopieret",
  "session.header.zoom.out": "Zoom ud (Ctrl/Cmd -)",
  "session.header.zoom.in": "Zoom ind (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Zoom ud",
  "session.header.zoom.in.ariaLabel": "Zoom ind",
  "session.header.colorScheme.toLightMode": "Skift til lys tilstand",
  "session.header.colorScheme.toDarkMode": "Skift til mørk tilstand",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Gennemgå",
  "session.header.tab.files": "Filer",
  "settings.general.row.downloadFolder.title": "Download-mappe",
  "settings.general.row.downloadFolder.description": "Hvor downloadede filer gemmes",
  "settings.general.row.downloadFolder.change": "Ændre",
  ...
  "toast.update.description": "En ny version af Kodu ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Kodu-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (kodu.json) udbyder/modelnavne",
  ...
  "session.review.noUncommittedChanges": "Ingen ikke-committerede ændringer endnu",
  ...
  "sidebar.gettingStarted.line1": "Kodu inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Kodu-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Kodu",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Kodu ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Kodu følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Kodu er temabestemt.",
  ...
  "settings.general.row.releaseNotes.description": "Vis What's New popups efter opdateringer",
  "settings.updates.row.startup.title": "Tjek for opdateringer ved opstart",
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Kodu starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Kodu.",
  ...
  "session.working.for": "Arbejder i {{time}}",
  "session.new.starter.ugc.title": "Lav en UGC-annonce",
  "session.new.starter.ugc.body": "Giv mig produktet — så laver jeg en UGC-reklame med en fast creator.",
  "session.new.starter.ugc.prompt": "Lav en 15-sekunders UGC-reklame for et hudplejeserum — en autentisk creator der holder produktet, afslappet selfie-vinkel, naturligt lys og en kort mundtlig anmeldelse.",
  "session.new.starter.productAnimation.title": "Animér et produkt",
  "session.new.starter.productAnimation.body": "Vis mig produktet — så bringer jeg det til live med bevægelse.",
  "session.new.starter.productAnimation.prompt": "Animér dette produkt i bevægelse — en langsom filmisk 360-graders rotation af en sneaker på en ren studiebaggrund med blødt, flydende lys.",
  "session.new.starter.productPhotoshoot.title": "Produktfotografering",
  "session.new.starter.productPhotoshoot.body": "Produktfotos i studiekvalitet uden et studie — beskriv stilen.",
  "session.new.starter.productPhotoshoot.prompt": "Lav en professionel produktoptagelse af en parfumeflaske i glas — et lifestyle-billede på marmor med bløde skygger, samt et skarpt pack-shot på hvid baggrund.",
  "session.new.starter.aiInfluencer.title": "AI-influencer",
  "session.new.starter.aiInfluencer.body": "Skab en konsistent virtuel person, som du kan genbruge i forskellige opslag.",
  "session.new.starter.aiInfluencer.prompt": "Skab en konsistent AI-influencer — en tech-savvy kvinde i slutningen af 20'erne — og lås hendes identitet med Visual DNA, så jeg kan genbruge hende i fremtidige opslag og videoer.",
}
