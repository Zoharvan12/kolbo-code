export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Kodu",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "prompt.toast.fileTooLarge.description": "Audio- und Videodateien müssen unter {{max}} liegen.",
  ...
  "dialog.server.description": "Wechseln Sie den Kodu-Server, mit dem sich diese App verbindet.",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": "Willkommen bei Kolbo Code",
  "dialog.login.subtitle": "Melden Sie sich mit Ihrem Kolbo.AI-Konto an, um fortzufahren",
  "dialog.login.button.continue": "Mit Kolbo fortfahren",
  ...
  "toast.update.description": "Eine neue Version von Kodu ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Kodu-Team",
  ...
  "sidebar.gettingStarted.line1": "Kodu enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Kodu-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Kodu ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Kodu auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Kodu dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Kodu anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Kodu automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Kodu.",
