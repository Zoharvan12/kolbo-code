export const dict = {
  ...
  "command.prompt.mode.normal": "Eingabeaufforderung",
  ...
  "dialog.provider.kodu.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.kodu.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.koduGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.sort.label": "Sortieren",
  "dialog.model.sort.name": "Name",
  "dialog.model.sort.price": "Preis",
  ...
  "provider.connect.apiKey.description": "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Kodu zu nutzen.",
  ...
  "provider.connect.koduZen.line2": "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.koduZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix": ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Kodu zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Kodu zu nutzen.",
  ...
  "provider.custom.field.providerID.placeholder": "meinanbieter",
  ...
  "provider.custom.field.baseURL.placeholder": "https://api.meinanbieter.com/v1",
  ...
  "model.tag.cost.low": "Geringe Kosten",
  "model.tag.cost.medium": "Mittlere Kosten",
  "model.tag.cost.high": "Hohe Kosten",
  "model.tag.default": "Standard",
  ...
  "model.tooltip.pricing": "Preisgestaltung: {{value}}",
  "model.tooltip.typicalCost.unit": "Guthaben pro Nachricht",
  "model.tooltip.typicalCost.hint": "Typische Nachricht. Längere Chats verbrauchen mehr.",
  ...
  "prompt.mode.normal": "Eingabeaufforderung",
  "prompt.approval.label": "Genehmigungsmodus",
  "prompt.approval.auto": "Automatisch",
  "prompt.approval.ask": "Erst fragen",
  "prompt.approval.auto.long": "Automatisch ohne Nachfrage ausführen",
  "prompt.approval.ask.long": "Vor Ausführung bestätigen",
  "prompt.mode.shell.exit": "esc zum Verlassen",
  "session.child.promptDisabled": "Subagent-Sitzungen können nicht aufgefordert werden.",
  "session.child.backToParent": "Zur Hauptsitzung zurück.",
  "session.working.for": "Aktiv seit {{time}}",
  ...
  "prompt.dropzone.label": "Bilder, Videos, PDFs oder Textdateien hier ablegen",
  ...
  "prompt.action.uploading": "Anhänge werden hochgeladen…",
  "prompt.action.dictate": "Diktieren (Sprache zu Text)",
  "prompt.action.dictateStop": "Diktat beenden",
  "prompt.voice.listening": "Höre zu…",
  "prompt.voice.error.notLoggedIn": "Melden Sie sich bei Kolbo an, um die Sprachdiktatfunktion zu nutzen",
  "prompt.voice.error.mic": "Mikrofon nicht verfügbar — bitte Systemberechtigungen prüfen",
  "prompt.voice.error.connection": "Sprachdienst nicht verfügbar — bitte erneut versuchen",
  ...
  "prompt.toast.fileTooLarge.description": "Mediendateien müssen unter 200 MB liegen.",
  ...
  "dialog.plugins.empty": "In kodu.json konfigurierte Plugins",
  ...
  "context.stats.creditsBalance": "Guthaben",
  ...
  "context.usage.credits": "Guthaben",
  "context.usage.credits.image": "Bild",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.status.browserOpened": "Browser geöffnet — dort anmelden",
  "dialog.login.confirmationCode": "Bestätigungscode",
  "dialog.login.copy": "Kopieren",
  "dialog.login.copied": "Kopiert",
  "session.header.zoom.out": "Verkleinern (Ctrl/Cmd -)",
  "session.header.zoom.in": "Vergrößern (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Verkleinern",
  "session.header.zoom.in.ariaLabel": "Vergrößern",
  "session.header.colorScheme.toLightMode": "In den Hellmodus wechseln",
  "session.header.colorScheme.toDarkMode": "In den Dunkelmodus wechseln",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Überprüfung",
  "session.header.tab.files": "Dateien",
  "settings.general.row.downloadFolder.title": "Download-Ordner",
  "settings.general.row.downloadFolder.description": "Wo heruntergeladene Dateien gespeichert werden",
  "settings.general.row.downloadFolder.change": "Ändern",
  ...
  "toast.update.downloading": "Update wird heruntergeladen... {{pct}}%",
  "toast.update.downloadingSize": "Update wird heruntergeladen... {{size}}",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (kodu.json) auf Anbieter-/Modellnamen",
  ...
  "session.tab.artifacts": "Artefakte",
  "session.tab.canvas": "Canvas",
  "session.header.tab.canvas": "Canvas",
  "command.canvas.toggle": "Canvas umschalten",
  "canvas.empty": "Generierte Bilder, Videos, Audios und 3D-Assets aus dieser Sitzung erscheinen hier.",
  "canvas.density": "Layout",
  "canvas.density.cols": "{{count}} pro Zeile",
  "canvas.select": "Auswählen",
  "canvas.cancelSelection": "Auswahl abbrechen",
  "canvas.clearSelection": "Leeren",
  "canvas.selected.count": "{{count}} ausgewählt",
  "canvas.downloadSelected": "Herunterladen",
  "canvas.downloadSelected.toast": "{{count}} Dateien heruntergeladen",
  "canvas.downloadSelected.toastDescription": "In deinem Download-Ordner gespeichert",
  "canvas.downloadSelected.partialFailed": "{{count}} Downloads fehlgeschlagen",
  "canvas.hideSelected": "Ausblenden",
  "canvas.hideSelected.toast": "{{count}} Element(e) vom Canvas ausgeblendet",
  "canvas.hide.tooltip": "Vom Canvas ausblenden",
  "canvas.tab.session": "Sitzung",
  "canvas.tab.library": "Bibliothek",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "Noch keine Medien",
  "canvas.library.empty.caption.filtered": "Keine Ergebnisse für die aktuellen Filter.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "Generiere oder lade etwas hoch, um deine Bibliothek zu füllen.",
  "canvas.library.search.placeholder": "Bibliothek durchsuchen…",
  "canvas.library.project.all": "Alle Projekte",
  "canvas.library.project.pick": "Projekt auswählen",
  "canvas.library.filter.type.all": "Alle",
  "canvas.library.filter.type.images": "Bilder",
  "canvas.library.filter.type.videos": "Videos",
  "canvas.library.filter.type.audio": "Audio",
  "canvas.library.filter.category.all": "Alle",
  "canvas.library.filter.category.ai": "KI",
  "canvas.library.filter.category.uploaded": "Hochgeladen",
  "canvas.library.filter.category.favorites": "Favoriten",
  "canvas.library.filter.category.trash": "Papierkorb",
  "canvas.library.folder.pick": "Ordner",
  "canvas.library.folder.all": "Alle Ordner",
  "canvas.library.folder.owned": "Meine Ordner",
  "canvas.library.folder.shared": "Mit mir geteilt",
  "canvas.library.filter.category.edited": "Bearbeitet",
  "canvas.library.filter.category.training-lab": "Trainingslabor",
  "canvas.library.favorite.add": "Zu Favoriten hinzufügen",
  "canvas.library.favorite.remove": "Aus Favoriten entfernen",
  "canvas.library.nsfw.hidden": "NSFW — zum Anzeigen tippen",
  "canvas.library.nsfw.reveal": "Anzeigen",
  "canvas.library.error": "Fehler beim Laden der Bibliothek",
  "canvas.library.retry": "Wiederholen",
  "canvas.library.signedOut": "Melde dich bei Kolbo an, um deine Bibliothek zu durchsuchen",
  "artifact.preview": "Vorschau",
  "artifact.code": "Code",
  "artifact.openInTab": "In neuem Tab öffnen",
  "artifact.publish": "Veröffentlichen",
  "artifact.publish.title": "Artefakt veröffentlichen",
  "artifact.publish.defaultTitle": "Kolbo Code Artefakt",
  "artifact.publish.loading": "Wird veröffentlicht…",
  "artifact.publish.urlLabel": "Öffentliche URL",
  "artifact.publish.copy": "Kopieren",
  "artifact.publish.copied": "Kopiert",
  "artifact.publish.open": "Im Browser öffnen",
  "session.panel.reviewAndFiles": "Überprüfung und Dateien",
  "session.panel.close": "Panel schließen",
  ...
  "session.review.noVcs.createGit.description": "Änderungen in diesem Projekt verfolgen, überprüfen und rückgängig machen",
  ...
  "session.review.noSnapshot": "Snapshot-Tracking ist in der Konfiguration deaktiviert, daher sind Sitzungsänderungen nicht verfügbar",
  "session.review.noChanges": "Keine Änderungen",
  "session.review.noUncommittedChanges": "Noch keine nicht festgeschriebenen Änderungen",
  ...
  "session.todo.dismiss": "Schließen",
  ...
  "session.followupDock.delete": "Löschen",
  ...
  "session.new.title": "Was erschaffen wir heute?",
  "session.new.subtitle": "Von Landingpages bis hin zu Bildern, Videos oder Musik — beschreibe deine Idee.",
  ...
  "session.new.starter.landing.title": "Landingpage erstellen",
  "session.new.starter.landing.body": "Beschreibe das Produkt oder die Idee — ich designe und erstelle eine professionelle Seite.",
  "session.new.starter.landing.prompt": "Erstelle eine Landingpage für eine Kaffee-Abo-App namens Brew — dunkler Hero-Bereich, warmer oranger CTA, drei Feature-Karten und eine Pricing-Sektion.",
  "session.new.starter.images.title": "4 Bilder generieren",
  "session.new.starter.images.body": "Nenne mir das Konzept — ich erstelle 4 Variationen mit dem passenden Modell für den Stil.",
  "session.new.starter.images.prompt": "Verwende das Creative Director-Tool, um 4 Bilder zu generieren, die eine kurze Geschichte über einen Astronauten erzählen, der auf dem Mond einen versteckten Garten findet — halte denselben Charakter über alle 4 Frames hinweg konsistent.",
  "session.new.starter.video.title": "Kurzes Video erstellen",
  "session.new.starter.video.body": "Präsentiere die Szene — ich generiere sie (Kling, Seedance, Sora) und arbeite an der Bewegung.",
  "session.new.starter.video.prompt": "Erstelle ein kurzes Video mit mehreren Shots einer futuristischen Stadt in der Dämmerung mit Seedance 2 — weiter Establishing-Shot, dann ein Schwenk auf Straßenebene, dann eine Nahaufnahme auf Neon-Schildern.",
  "session.new.starter.music.title": "Musik oder Voiceover komponieren",
  "session.new.starter.music.body": "Beschreibe den Vibe oder das Skript — ich produziere Audio mit Suno oder ElevenLabs.",
  "session.new.starter.music.prompt": "Komponiere einen Lofi-Track mit weichem Klavier und sanften Beats — entspannte Lern-Vibes.",
  "session.new.starter.ugc.title": "UGC-Werbung erstellen",
  "session.new.starter.ugc.body": "Gib mir das Produkt — ich produziere eine Talking-Head UGC-Werbung mit einem konsistenten Creator.",
  "session.new.starter.ugc.prompt": "Erstelle eine 15-sekündige UGC-Talking-Head-Werbung für ein Hautpflegeserum — ein authentischer Creator hält das Produkt, lässige Selfie-Perspektive, natürliches Licht, mit einer kurzen gesprochenen Bewertung.",
  "session.new.starter.productAnimation.title": "Produkt animieren",
  "session.new.starter.productAnimation.body": "Zeig mir das Produkt — ich erwecke es mit Bewegung zum Leben.",
  "session.new.starter.productAnimation.prompt": "Animiere dieses Produkt — eine langsame, filmische 360°-Rotation eines Sneakers vor einem cleanen Studio-Hintergrund mit sanft wanderndem Licht.",
  "session.new.starter.productPhotoshoot.title": "Produkt-Fotoshooting",
  "session.new.starter.productPhotoshoot.body": "Produktfotos in Studioqualität, ganz ohne Studio — beschreibe mir den Look.",
  "session.new.starter.productPhotoshoot.prompt": "Erstelle ein Studio-Fotoshooting für einen Parfümflakon aus Glas — Lifestyle-Hero-Shot auf Marmor mit weichen Schatten, dazu eine Produktaufnahme vor sauberem, weißem Hintergrund.",
  "session.new.starter.aiInfluencer.title": "AI Influencer",
  "session.new.starter.aiInfluencer.body": "Erstelle eine konsistente virtuelle Persönlichkeit, die du in verschiedenen Aufnahmen wiederverwenden kannst.",
  "session.new.starter.aiInfluencer.prompt": "Erstelle einen konsistenten AI Influencer — eine technikbegeisterte Frau Ende 20 — und fixiere ihre Identität mit Visual DNA, damit ich sie für zukünftige Posts und Videos wiederverwenden kann.",
  ...
  "common.showArchivedSessions": "Archivierte Sitzungen anzeigen",
  "common.hideArchivedSessions": "Archivierte Sitzungen ausblenden",
  ...
  "debugBar.nav.tip": "Letzter abgeschlossener Routenübergang, der eine Sitzungsseite berührt, gemessen vom Start des Routers bis zum ersten Rendern nach dem Einschwingen.",
  ...
  "debugBar.inp.tip": "Ungefähre Interaktionsdauer in den letzten 5 Sekunden. Dies ist INP-ähnlich, nicht das offizielle Web Vitals INP.",
  ...
  "settings.general.row.followup.description": "Wählen Sie, ob Folgefragen sofort steuern oder in einer Warteschlange warten",
  ...
  "settings.general.row.reasoningSummaries.description": "Zusammenfassungen des Modell-Reasonings in der Timeline anzeigen",
  "settings.general.row.shellToolPartsExpanded.title": "Shell-Tool-Abschnitte ausklappen",
  "settings.general.row.shellToolPartsExpanded.description": "Shell-Tool-Abschnitte standardmäßig in der Timeline ausgeklappt anzeigen",
  "settings.general.row.editToolPartsExpanded.title": "Edit-Tool-Abschnitte ausklappen",
  "settings.general.row.editToolPartsExpanded.description": "Edit-, Write- und Patch-Tool-Abschnitte standardmäßig in der Timeline ausgeklappt anzeigen",
  "settings.general.row.showSessionProgressBar.title": "Sitzungs-Fortschrittsbalken anzeigen",
  "settings.general.row.showSessionProgressBar.description": "Zeigt den animierten Fortschrittsbalken oben in der Sitzung an, während der Agent arbeitet",
  ...
  "settings.general.row.releaseNotes.description": "Zeige What's New-Popups nach Updates an",
  ...
  "settings.shortcuts.group.prompt": "Eingabeaufforderung",
