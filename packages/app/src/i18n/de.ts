export const dict = {
  ...
  "error.page.authExpired.title": "Ihre Sitzung ist abgelaufen",
  "error.page.authExpired.description": "Ihre API-Anmeldedaten sind ungültig oder abgelaufen. Starten Sie die App neu, um sich erneut anzumelden.",
  "error.page.authExpired.restart": "Neu starten & Anmelden",
