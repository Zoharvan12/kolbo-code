...
export const dict = {
  ...
  "session.new.starter.ugc.prompt": "Create a 15-second UGC talking-head ad. I'm attaching (or will attach) two references: my PRODUCT photo and a CREATOR face reference — confirm you have both before producing anything, and ask me for whichever is missing. Casual selfie framing, natural lighting, authentic spoken review, the creator holding my exact product.",
