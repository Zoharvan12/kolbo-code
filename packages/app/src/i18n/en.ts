...
export const dict = {
  ...
  "session.new.starter.landing.prompt": "Build me a complete, polished landing page — start immediately, don't interview me. Here is the full brief (a demo; if I want my real product instead I'll say so after seeing it): the product is NORD, a smart insulated travel mug that keeps drinks at an exact chosen temperature for 12 hours via an app, brushed steel in four muted colors, $89, audience is design-conscious commuters and remote workers, tone is calm and premium like a Scandinavian hardware brand. Ship the full page in one pass — hero with a strong headline and a real value proposition (no lorem ipsum anywhere), social-proof strip with three believable customer quotes, three feature sections (exact temperature control, 12-hour hold, app pairing) each with generated imagery in one coherent art direction (soft daylight, neutral palette, product photography style), simple one-tier pricing block, 4-question FAQ, closing CTA. Dark-mode aware, responsive, real typography hierarchy. Generate the hero/section images yourself so the page ships looking finished, then open it for me to review — I'll iterate or swap in my real product from there.",
