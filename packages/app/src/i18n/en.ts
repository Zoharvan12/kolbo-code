...
export const dict = {
  ...
  "session.new.starter.ugc.prompt": "Create a 15-second multi-shot UGC ad VIDEO. Attached: @Image1 is the PRODUCT, @Image2 is the CREATOR — demo assets, so ask me first if I want to swap in my own. Then write the full prompt per the UGC craft: 4 connected phone shots, 15s total, 9:16, 480p resolution (sketch pass — never higher), Multishot ON, restate 9:16 vertical phone frame inside every shot. NEVER write the word cinematic. The creator from @Image2 talks to camera like a friend, handles the exact product from @Image1 (label to lens at least once), phone held at arm's length with slight sway and late reframes. Available light only, deep focus, flat computational-HDR contrast. Audio: room tone and her real voice — a short spoken review, no music, no captions.",
