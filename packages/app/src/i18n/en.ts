...
export const dict = {
  ...
  "dialog.server.description": "Switch which Kolbo Code server this app connects to.",
  ...
  "error.page.report.prefix": "Please report this error to the Kolbo Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Kolbo Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Kolbo Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Kolbo Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Kolbo Code",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Kolbo Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Kolbo Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Kolbo Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Kolbo Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Kolbo Code.",
