...
export const dict = {
  ...
  "session.new.starter.fashionCampaign.prompt": "Run a fashion campaign flow with hard approval stops: 1) Ask me about the brand, garment/product, and vibe, then write a short campaign plan (concept, styling, shot list) and WAIT for my approval before generating anything. 2) Generate exactly 4 candidate models (distinct looks, same brief, MIRAGE FILM 2, clean white studio) and WAIT for me to pick one. 3) Lock the chosen model as a Visual DNA via create_visual_dna. 4) Then produce the campaign: 8 angle variations of the model in a blank white photo studio, high quality (use the Angles Variations model on the hero frame, or 8 DNA-anchored shots), followed by the styled campaign set. Check in after the first batch. Never skip a stop.",
