...
export const dict = {
  ...
  "session.new.subtitle": "From a landing page to images, video, or music — describe the idea.",
  ...
  "session.new.starter.images.title": "Generate 4 images",
  "session.new.starter.images.body": "Tell me the concept — I'll create 4 variations with the right model for the style.",
  "session.new.starter.images.prompt": "Use the Creative Director tool to generate 4 images that tell a short story about an astronaut finding a hidden garden on the moon — keep the same character consistent across all 4 frames.",
  ...
  "session.new.starter.music.title": "Compose music or voiceover",
  "session.new.starter.music.body": "Describe the vibe or script — I'll produce audio with Suno or ElevenLabs.",
  "session.new.starter.music.prompt": "Compose a lofi track with mellow piano and soft beats — chill study vibe.",
  "session.new.starter.ugc.title": "Create a UGC ad",
  "session.new.starter.ugc.body": "Give me the product — I'll produce a talking-head UGC ad with a consistent creator.",
  "session.new.starter.ugc.prompt": "Create a 15-second UGC talking-head ad for a skincare serum — an authentic creator holding the product, casual selfie framing, natural lighting, with a short spoken review.",
  ...
  "session.new.starter.productAnimation.prompt": "Animate this product in motion — a slow cinematic 360° rotation of a sneaker on a clean studio background with soft moving light.",
  ...
  "session.new.starter.productPhotoshoot.prompt": "Create a studio product photoshoot for a glass perfume bottle — lifestyle hero shot on marble with soft shadows, plus a clean white-background pack shot.",
