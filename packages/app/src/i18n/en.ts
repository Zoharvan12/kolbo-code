...
export const dict = {
  ...
  "session.new.starter.productAnimation.prompt": "Animate the attached product photo (a demo asset — ask me first if I want to swap in my own product): a slow cinematic 360° rotation on a clean studio background with soft moving light, keeping the product's identity exactly as in the reference.",
