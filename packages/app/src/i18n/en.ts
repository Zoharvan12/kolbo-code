...
export const dict = {
  ...
  "session.new.starter.landing.prompt": "Build a landing page for a coffee subscription app called Brew — dark hero, warm orange CTA, three feature cards, and a pricing section.",
  "session.new.starter.video.title": "Make a short video",
  "session.new.starter.video.body": "Pitch the shot — I'll generate it (Kling, Seedance, Sora) and iterate on motion.",
  "session.new.starter.video.prompt": "Make a short video with multiple shots of a futuristic city at dusk using Seedance 2 — wide establishing shot, then a street-level pan, then a close-up on neon signs.",
  ...
  "session.new.starter.ugc.prompt": "Create a 15-second UGC talking-head ad. Two references are attached: a PRODUCT photo and a CREATOR face reference — these are demo assets, so first ask me if I want to swap in my own product photo and creator before producing anything. Real phone-capture look: deep focus, available light, authentic spoken review, the creator holding the exact product from the reference.",
  ...
  "session.new.starter.productAnimation.prompt": "Animate the attached product photo (a demo asset — ask me first if I want to swap in my own product) as a MULTI-SHOT product film: generate_elements with Seedance 2.5, 12 seconds, 1080p, the product image tagged as @Image1 in every shot. Write the full locked-intro prompt (GLOBAL LOOK / CAST / LOCATION, then timecoded shots): 4 connected shots — slow hero rotation, macro material detail, dynamic light sweep, final settle on the product — keeping the product's identity exactly as the reference in every shot.",
  ...
  "session.new.starter.productPhotoshoot.prompt": "Create a studio-quality product photoshoot from the attached product photo (a demo asset — ask me first if I want to swap in my own product). Keep the product's shape, materials and proportions exactly; deliver a lifestyle hero shot plus a clean pack shot.",
  "session.new.starter.aiInfluencer.title": "AI influencer",
  "session.new.starter.aiInfluencer.body": "Create a consistent virtual persona you can reuse across shots.",
  "session.new.starter.aiInfluencer.prompt": "Create a consistent AI influencer — a tech-savvy woman in her late 20s — and lock her identity with Visual DNA so I can reuse her across future posts and videos.",
