...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Kodu",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "prompt.toast.fileTooLarge.description": "Los archivos de audio y video deben ser menores de {{max}}.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Kodu se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Kodu ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Kodu",
  ...
  "sidebar.gettingStarted.line1": "Kodu incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Kodu dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Kodu",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Kodu en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Kodu sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Kodu.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Kodu",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Kodu.",
