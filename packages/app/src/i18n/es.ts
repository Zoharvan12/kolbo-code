export const dict = {
  ...
  "dialog.provider.kodu.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.kodu.tagline": "Modelos optimizados y fiables",
  "dialog.provider.koduGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.sort.label": "Ordenar",
  "dialog.model.sort.name": "Nombre",
  "dialog.model.sort.price": "Precio",
  ...
  "provider.connect.apiKey.description": "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Kodu.",
  ...
  "provider.connect.koduZen.line2": "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.koduZen.visit.prefix": "Visita ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix": " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Kodu.",
  ...
  "model.tag.cost.low": "Coste bajo",
  "model.tag.cost.medium": "Coste medio",
  "model.tag.cost.high": "Coste alto",
  "model.tag.default": "Predeterminado",
  ...
  "model.tooltip.pricing": "Precio: {{value}}",
  "model.tooltip.typicalCost.unit": "créditos por mensaje",
  "model.tooltip.typicalCost.hint": "Mensaje típico. Los chats más largos consumen más.",
  ...
  "prompt.approval.label": "Modo de aprobación",
  "prompt.approval.auto": "Auto-ejecutar",
  "prompt.approval.ask": "Preguntar primero",
  "prompt.approval.auto.long": "Ejecutar automáticamente sin preguntar",
  "prompt.approval.ask.long": "Confirmar antes de ejecutar",
  "prompt.mode.shell.exit": "esc para salir",
  "session.child.promptDisabled": "Las sesiones de subagente no pueden ser solicitadas.",
  "session.child.backToParent": "Volver a la sesión principal.",
  "session.working.for": "Trabajando por {{time}}",
  ...
  "prompt.dropzone.label": "Suelta imágenes, videos, PDFs o archivos de texto aquí",
  ...
  "prompt.action.uploading": "Subiendo archivos adjuntos…",
  "prompt.action.dictate": "Dictar (voz a texto)",
  "prompt.action.dictateStop": "Detener dictado",
  "prompt.voice.listening": "Escuchando…",
  "prompt.voice.error.notLoggedIn": "Inicia sesión en Kolbo para usar el dictado por voz",
  "prompt.voice.error.mic": "Micrófono no disponible: verifica los permisos del sistema",
  "prompt.voice.error.connection": "Servicio de voz no disponible: inténtalo de nuevo",
  ...
  "prompt.toast.fileTooLarge.description": "Los archivos multimedia deben ser menores de 200 MB.",
  ...
  "dialog.plugins.empty": "Plugins configurados en kodu.json",
  ...
  "dialog.server.default.description": "Conectar a este servidor al iniciar la app en lugar de iniciar un servidor local. Requiere reinicio.",
  ...
  "context.stats.creditsBalance": "Saldo de créditos",
  ...
  "context.usage.credits": "Créditos",
  "context.usage.credits.image": "Imagen",
  ...
  "dialog.login.confirmationCode": "Código de confirmación",
  "dialog.login.copy": "Copiar",
  "dialog.login.copied": "Copiado",
  "session.header.zoom.out": "Alejar (Ctrl/Cmd -)",
  "session.header.zoom.in": "Acercar (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Alejar",
  "session.header.zoom.in.ariaLabel": "Acercar",
  "session.header.colorScheme.toLightMode": "Cambiar a modo claro",
  "session.header.colorScheme.toDarkMode": "Cambiar a modo oscuro",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Revisión",
  "session.header.tab.files": "Archivos",
  "settings.general.row.downloadFolder.title": "Carpeta de descargas",
  "settings.general.row.downloadFolder.description": "Dónde se guardan los archivos descargados",
  "settings.general.row.downloadFolder.change": "Cambiar",
  ...
  "toast.update.downloading": "Descargando actualización... {{pct}}%",
  "toast.update.downloadingSize": "Descargando actualización... {{size}}",
  "toast.update.installing": "Instalando actualización...",
  ...
  "error.dev.rootNotFound": "Elemento raíz no encontrado. ¿Olvidaste añadirlo a tu index.html? ¿O tal vez el atributo id está mal escrito?",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (kodu.json)",
  ...
  "error.chain.configJsonInvalidWithMessage": "El archivo de configuración en {{path}} no es un JSON(C) válido: {{message}}",
  ...
  "session.tab.canvas": "Lienzo",
  "session.header.tab.canvas": "Lienzo",
  "command.canvas.toggle": "Alternar lienzo",
  "canvas.empty": "Las imágenes, vídeos, audios y recursos 3D generados en esta sesión aparecerán aquí.",
  "canvas.density": "Diseño",
  "canvas.density.cols": "{{count}} por fila",
  "canvas.select": "Seleccionar",
  "canvas.cancelSelection": "Cancelar selección",
  "canvas.clearSelection": "Limpiar",
  "canvas.selected.count": "{{count}} seleccionados",
  "canvas.downloadSelected": "Descargar",
  "canvas.downloadSelected.toast": "{{count}} archivos descargados",
  "canvas.downloadSelected.toastDescription": "Guardado en tu carpeta de descargas",
  "canvas.downloadSelected.partialFailed": "{{count}} descargas fallaron",
  "canvas.hideSelected": "Ocultar",
  "canvas.hideSelected.toast": "{{count}} elementos ocultos del lienzo",
  "canvas.hide.tooltip": "Ocultar del lienzo",
  "canvas.tab.session": "Sesión",
  "canvas.tab.library": "Biblioteca",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "Aún no hay contenido",
  "canvas.library.empty.caption.filtered": "No hay resultados que coincidan con los filtros actuales.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "Genera o sube algo para llenar tu biblioteca.",
  "canvas.library.search.placeholder": "Buscar en la biblioteca…",
  "canvas.library.project.all": "Todos los proyectos",
  "canvas.library.project.pick": "Elegir proyecto",
  "canvas.library.filter.type.all": "Todo",
  "canvas.library.filter.type.images": "Imágenes",
  "canvas.library.filter.type.videos": "Vídeos",
  "canvas.library.filter.type.audio": "Audio",
  "canvas.library.filter.category.all": "Todo",
  "canvas.library.filter.category.ai": "IA",
  "canvas.library.filter.category.uploaded": "Subido",
  "canvas.library.filter.category.favorites": "Favoritos",
  "canvas.library.filter.category.trash": "Papelera",
  "canvas.library.folder.pick": "Carpeta",
  "canvas.library.folder.all": "Todas las carpetas",
  "canvas.library.folder.owned": "Mis carpetas",
  "canvas.library.folder.shared": "Compartidas conmigo",
  "canvas.library.filter.category.edited": "Editado",
  "canvas.library.filter.category.training-lab": "Lab de entrenamiento",
  "canvas.library.favorite.add": "Añadir a favoritos",
  "canvas.library.favorite.remove": "Quitar de favoritos",
  "canvas.library.nsfw.hidden": "NSFW — tocar para mostrar",
  "canvas.library.nsfw.reveal": "Mostrar",
  "canvas.library.error": "Error al cargar la biblioteca",
  "canvas.library.retry": "Reintentar",
  "canvas.library.signedOut": "Inicia sesión en Kolbo para explorar tu biblioteca",
  "artifact.preview": "Vista previa",
  "artifact.code": "Código",
  "artifact.openInTab": "Abrir en una pestaña nueva",
  "artifact.publish": "Publicar",
  "artifact.publish.title": "Publicar artefacto",
  "artifact.publish.defaultTitle": "Artefacto de Kolbo Code",
  "artifact.publish.loading": "Publicando…",
  "artifact.publish.urlLabel": "URL pública",
  "artifact.publish.copy": "Copiar",
  "artifact.publish.copied": "Copiado",
  "artifact.publish.open": "Abrir en el navegador",
  "session.panel.reviewAndFiles": "Revisión y archivos",
  "session.panel.close": "Cerrar panel",
  ...
  "session.review.noSnapshot": "El seguimiento de instantáneas está deshabilitado en la configuración, por lo que los cambios de sesión no están disponibles",
  "session.review.noChanges": "Sin cambios",
  "session.review.noUncommittedChanges": "No hay cambios no confirmados aún",
  "session.review.noBranchChanges": "No hay cambios en la rama aún",
  ...
  "session.todo.dismiss": "Descartar",
  ...
  "session.new.title": "¿Qué vamos a crear hoy?",
  "session.new.subtitle": "Desde una página de aterrizaje hasta imágenes, vídeo o música: describe tu idea.",
  ...
  "session.new.starter.landing.title": "Crear una página de aterrizaje",
  "session.new.starter.landing.body": "Describe el producto o la idea: diseñaré y publicaré una página profesional.",
  "session.new.starter.landing.prompt": "Crea una landing page para una app de suscripción de café llamada Brew — hero oscuro, CTA naranja cálido, tres tarjetas de funciones y una sección de precios.",
  "session.new.starter.images.title": "Generar 4 imágenes",
  "session.new.starter.images.body": "Cuéntame el concepto: crearé 4 variaciones con el modelo adecuado para el estilo.",
  "session.new.starter.images.prompt": "Usa la herramienta Creative Director para generar 4 imágenes que cuenten una breve historia sobre un astronauta que descubre un jardín oculto en la luna — mantén el mismo personaje de forma consistente en los 4 cuadros.",
  "session.new.starter.video.title": "Hacer un vídeo corto",
  "session.new.starter.video.body": "Propón la toma: la generaré (Kling, Seedance, Sora) e iteraré sobre el movimiento.",
  "session.new.starter.video.prompt": "Haz un vídeo corto con varias tomas de una ciudad futurista al anochecer usando Seedance 2 — plano general amplio, luego un paneo a nivel de calle y por último un primer plano de letreros de neón.",
  "session.new.starter.music.title": "Componer música o voz en off",
  "session.new.starter.music.body": "Describe el ambiente o el guion: produciré audio con Suno o ElevenLabs.",
  "session.new.starter.music.prompt": "Compón una pista lofi con piano suave y ritmos delicados — ambiente relajado para estudiar.",
  "session.new.starter.ugc.title": "Crear un anuncio UGC",
  "session.new.starter.ugc.body": "Dime cuál es el producto y crearé un anuncio UGC tipo 'talking-head' con un creador constante.",
  "session.new.starter.ugc.prompt": "Crea un anuncio UGC tipo 'talking-head' de 15 segundos para un sérum facial: un creador auténtico sosteniendo el producto, encuadre tipo selfie casual, iluminación natural y una breve reseña hablada.",
  "session.new.starter.productAnimation.title": "Animar un producto",
  "session.new.starter.productAnimation.body": "Muéstrame el producto y lo haré cobrar vida con movimiento.",
  "session.new.starter.productAnimation.prompt": "Anima este producto: una rotación cinemática lenta de 360° de una zapatilla sobre un fondo de estudio limpio con iluminación suave en movimiento.",
  "session.new.starter.productPhotoshoot.title": "Sesión fotográfica de producto",
  "session.new.starter.productPhotoshoot.body": "Fotos de producto con calidad de estudio, sin necesidad de estudio; describe el estilo.",
  "session.new.starter.productPhotoshoot.prompt": "Crea una sesión fotográfica de estudio para un frasco de perfume de cristal: una foto publicitaria sobre mármol con sombras suaves y una toma sobre fondo blanco limpio.",
  "session.new.starter.aiInfluencer.title": "Influencer de IA",
  "session.new.starter.aiInfluencer.body": "Crea una personalidad virtual constante que puedas reutilizar en diferentes tomas.",
  "session.new.starter.aiInfluencer.prompt": "Crea una influencer de IA constante, una mujer experta en tecnología de unos 20 y tantos años, y fija su identidad con Visual DNA para que pueda reutilizarla en futuras publicaciones y videos.",
  ...
  "session.share.popover.description.shared": "Esta sesión es pública en la web. Es accesible para cualquiera con el enlace.",
  "session.share.popover.description.unshared": "Compartir sesión públicamente en la web. Será accesible para cualquiera con el enlace.",
  ...
  "common.showArchivedSessions": "Mostrar sesiones archivadas",
  "common.hideArchivedSessions": "Ocultar sesiones archivadas",
  ...
  "sidebar.empty.description": "Abre un proyecto para comenzar",
  "debugBar.ariaLabel": "Diagnóstico de rendimiento de desarrollo",
  "debugBar.na": "n/d",
  "debugBar.nav.label": "NAV",
  "debugBar.nav.tip": "Última transición de ruta completada tocando una página de sesión, medida desde el inicio del router hasta el primer pintado después de asentarse.",
  ...
  "debugBar.long.label": "LARGO",
  "debugBar.long.tip": "Tiempo bloqueado y recuento de tareas largas en los últimos 5 segundos. Tarea máx: {{max}}.",
  "debugBar.delay.label": "RETARDO",
  "debugBar.delay.tip": "Peor retraso de entrada observado en los últimos 5 segundos.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip": "Duración aproximada de la interacción en los últimos 5 segundos. Esto es similar a INP, no el INP oficial de Web Vitals.",
  ...
  "settings.general.row.followup.description": "Elige si los prompts de seguimiento se dirigen inmediatamente o esperan en una cola",
  ...
  "settings.general.row.reasoningSummaries.description": "Mostrar resúmenes del razonamiento del modelo en la línea de tiempo",
  "settings.general.row.shellToolPartsExpanded.title": "Expandir partes de la herramienta shell",
  "settings.general.row.shellToolPartsExpanded.description": "Mostrar las partes de la herramienta shell expandidas por defecto en la línea de tiempo",
  "settings.general.row.editToolPartsExpanded.title": "Expandir partes de la herramienta de edición",
  "settings.general.row.editToolPartsExpanded.description": "Mostrar las partes de las herramientas de edición, escritura y parcheado expandidas por defecto en la línea de tiempo",
  "settings.general.row.showSessionProgressBar.title": "Mostrar barra de progreso de la sesión",
  "settings.general.row.showSessionProgressBar.description": "Muestra la barra de progreso animada en la parte superior de la sesión cuando el agente está trabajando",
  "settings.general.row.wayland.title": "Usar Wayland nativo",
  "settings.general.row.wayland.description": "Deshabilitar fallback a X11 en Wayland. Requiere reinicio.",
  "settings.general.row.wayland.tooltip": "En Linux con monitores de frecuencia de actualización mixta, Wayland nativo puede ser más estable.",
  "settings.general.row.releaseNotes.title": "Notas de la versión",
  "settings.general.row.releaseNotes.description": "Mostrar ventanas emergentes de Novedades después de las actualizaciones",
  ...
  "settings.general.notifications.agent.description": "Mostrar notificación del sistema cuando el agente termine o necesite atención",
  "settings.general.notifications.permissions.title": "Permisos",
  "settings.general.notifications.permissions.description": "Mostrar notificación del sistema cuando se requiera un permiso",
  ...
  "settings.shortcuts.reset.toast.description": "Los atajos de teclado han sido restablecidos a los valores predeterminados.",
  ...
  "settings.shortcuts.group.prompt": "Indicaciones",
  ...
  "settings.permissions.tool.edit.description": "Modificar archivos, incluyendo ediciones, escrituras, parches y multi-ediciones",
