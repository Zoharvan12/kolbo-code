export const dict = {
  ...
  "error.page.authExpired.title": "Tu sesión ha caducado",
  "error.page.authExpired.description": "Tus credenciales de API no son válidas o han caducado. Reinicia la aplicación para iniciar sesión de nuevo.",
  "error.page.authExpired.restart": "Reiniciar e iniciar sesión",
  ...
  "sidebar.sessions.empty": "Aún no hay sesiones",
