export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Kodu",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "prompt.toast.fileTooLarge.description": "Les fichiers audio et vidéo doivent être inférieurs à {{max}}.",
  ...
  "dialog.server.description": "Changez le serveur Kodu auquel cette application se connecte.",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": "Bienvenue dans Kolbo Code",
  "dialog.login.subtitle": "Connectez-vous avec votre compte Kolbo.AI pour continuer",
  "dialog.login.button.continue": "Continuer avec Kolbo",
  ...
  "toast.update.description": "Une nouvelle version d'Kodu ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Kodu",
  ...
  "sidebar.gettingStarted.line1": "Kodu inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Kodu dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Kodu",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Kodu sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Kodu suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Kodu.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Kodu",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Kodu.",
