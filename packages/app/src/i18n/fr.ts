export const dict = {
  ...
  "dialog.provider.kodu.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.kodu.tagline": "Modèles optimisés et fiables",
  "dialog.provider.koduGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.sort.label": "Trier",
  "dialog.model.sort.name": "Nom",
  "dialog.model.sort.price": "Prix",
  ...
  "provider.connect.apiKey.description": "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Kodu.",
  ...
  "provider.connect.koduZen.line2": "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.koduZen.visit.prefix": "Visitez ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix": " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Kodu.",
  ...
  "model.tag.cost.low": "Coût faible",
  "model.tag.cost.medium": "Coût moyen",
  "model.tag.cost.high": "Coût élevé",
  "model.tag.default": "Par défaut",
  ...
  "model.tooltip.pricing": "Tarification : {{value}}",
  "model.tooltip.typicalCost.unit": "crédits par message",
  "model.tooltip.typicalCost.hint": "Message type. Les conversations plus longues en consomment plus.",
  ...
  "prompt.approval.auto": "Exécution auto",
  "prompt.approval.ask": "Demander d'abord",
  "prompt.approval.auto.long": "Exécuter automatiquement sans demander",
  "prompt.approval.ask.long": "Confirmer avant d'exécuter",
  "prompt.mode.shell.exit": "esc pour quitter",
  "session.child.promptDisabled": "Les sessions de sous-agent ne peuvent pas être invitées.",
  "session.child.backToParent": "Retour à la session principale.",
  "session.working.for": "En activité depuis {{time}}",
  ...
  "prompt.dropzone.label": "Déposez des images, des vidéos, des PDF ou des fichiers texte ici",
  ...
  "prompt.action.uploading": "Téléchargement des pièces jointes…",
  "prompt.action.dictate": "Dicter (voix en texte)",
  "prompt.action.dictateStop": "Arrêter la dictée",
  "prompt.voice.listening": "À l'écoute…",
  "prompt.voice.error.notLoggedIn": "Connectez-vous à Kolbo pour utiliser la dictée vocale",
  "prompt.voice.error.mic": "Microphone indisponible — vérifiez les autorisations système",
  "prompt.voice.error.connection": "Service vocal indisponible — réessayez",
  ...
  "prompt.toast.fileTooLarge.description": "Les fichiers multimédias doivent être inférieurs à 200 Mo.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans kodu.json",
  ...
  "context.stats.creditsBalance": "Solde de crédits",
  ...
  "context.usage.credits": "Crédits",
  "context.usage.credits.image": "Image",
  "context.usage.credits.video": "Vidéo",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.status.browserOpened": "Navigateur ouvert — connectez-vous là-bas",
  "dialog.login.confirmationCode": "Code de confirmation",
  "dialog.login.copy": "Copier",
  "dialog.login.copied": "Copié",
  "session.header.zoom.out": "Dézoomer (Ctrl/Cmd -)",
  "session.header.zoom.in": "Zoomer (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Dézoomer",
  "session.header.zoom.in.ariaLabel": "Zoomer",
  "session.header.colorScheme.toLightMode": "Passer en mode clair",
  "session.header.colorScheme.toDarkMode": "Passer en mode sombre",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Révision",
  "session.header.tab.files": "Fichiers",
  "settings.general.row.downloadFolder.title": "Dossier de téléchargement",
  "settings.general.row.downloadFolder.description": "Où les fichiers téléchargés sont enregistrés",
  "settings.general.row.downloadFolder.change": "Changer",
  ...
  "toast.update.downloading": "Téléchargement de la mise à jour... {{pct}}%",
  "toast.update.downloadingSize": "Téléchargement de la mise à jour... {{size}}",
  "toast.update.installing": "Installation de la mise à jour...",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (kodu.json) pour les noms de fournisseur/modèle",
  ...
  "session.tab.artifacts": "Artefacts",
  "session.tab.canvas": "Toile",
  "session.header.tab.canvas": "Toile",
  "command.canvas.toggle": "Basculer la toile",
  "canvas.empty": "Les images, vidéos, fichiers audio et ressources 3D générés au cours de cette session apparaîtront ici.",
  "canvas.density": "Mise en page",
  "canvas.density.cols": "{{count}} par ligne",
  "canvas.select": "Sélectionner",
  "canvas.cancelSelection": "Annuler la sélection",
  "canvas.clearSelection": "Effacer",
  "canvas.selected.count": "{{count}} sélectionnés",
  "canvas.downloadSelected": "Télécharger",
  "canvas.downloadSelected.toast": "{{count}} fichiers téléchargés",
  "canvas.downloadSelected.toastDescription": "Enregistré dans votre dossier de téléchargements",
  "canvas.downloadSelected.partialFailed": "{{count}} téléchargements ont échoué",
  "canvas.hideSelected": "Masquer",
  "canvas.hideSelected.toast": "{{count}} élément(s) masqué(s) du canevas",
  "canvas.hide.tooltip": "Masquer du canevas",
  "canvas.tab.session": "Session",
  "canvas.tab.library": "Bibliothèque",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "Aucun média pour l'instant",
  "canvas.library.empty.caption.filtered": "Aucun résultat ne correspond aux filtres actuels.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "Générez ou téléversez du contenu pour remplir votre bibliothèque.",
  "canvas.library.search.placeholder": "Rechercher dans la bibliothèque…",
  "canvas.library.project.all": "Tous les projets",
  "canvas.library.project.pick": "Choisir un projet",
  "canvas.library.filter.type.all": "Tout",
  "canvas.library.filter.type.images": "Images",
  "canvas.library.filter.type.videos": "Vidéos",
  "canvas.library.filter.type.audio": "Audio",
  "canvas.library.filter.category.all": "Tout",
  "canvas.library.filter.category.ai": "IA",
  "canvas.library.filter.category.uploaded": "Téléversé",
  "canvas.library.filter.category.favorites": "Favoris",
  "canvas.library.filter.category.trash": "Corbeille",
  "canvas.library.folder.pick": "Dossier",
  "canvas.library.folder.all": "Tous les dossiers",
  "canvas.library.folder.owned": "Mes dossiers",
  "canvas.library.folder.shared": "Partagés avec moi",
  "canvas.library.filter.category.edited": "Modifié",
  "canvas.library.filter.category.training-lab": "Labo d'entraînement",
  "canvas.library.favorite.add": "Ajouter aux favoris",
  "canvas.library.favorite.remove": "Retirer des favoris",
  "canvas.library.nsfw.hidden": "NSFW — cliquer pour afficher",
  "canvas.library.nsfw.reveal": "Afficher",
  "canvas.library.error": "Échec du chargement de la bibliothèque",
  "canvas.library.retry": "Réessayer",
  "canvas.library.signedOut": "Connectez-vous à Kolbo pour parcourir votre bibliothèque",
  "artifact.preview": "Prévisualisation",
  "artifact.code": "Code",
  "artifact.openInTab": "Ouvrir dans un nouvel onglet",
  "artifact.publish": "Publier",
  "artifact.publish.title": "Publier l'artefact",
  "artifact.publish.defaultTitle": "Artefact Kolbo Code",
  "artifact.publish.loading": "Publication en cours…",
  "artifact.publish.urlLabel": "URL publique",
  "artifact.publish.copy": "Copier",
  "artifact.publish.copied": "Copié",
  "artifact.publish.open": "Ouvrir dans le navigateur",
  "session.panel.reviewAndFiles": "Revue et fichiers",
  "session.panel.close": "Fermer le panneau",
  ...
  "session.review.noUncommittedChanges": "Aucun changement non validé pour l'instant",
  "session.review.noBranchChanges": "Aucun changement de branche pour l'instant",
  ...
  "session.followupDock.delete": "Supprimer",
  ...
  "session.new.title": "Que créons-nous aujourd'hui ?",
  "session.new.subtitle": "D'une page de destination à des images, vidéos ou de la musique — décrivez votre idée.",
  ...
  "session.new.starter.landing.title": "Créer une page de destination",
  "session.new.starter.landing.body": "Décrivez le produit ou l'idée — je concevrai et publierai une page élégante.",
  "session.new.starter.landing.prompt": "Crée une landing page pour une application d'abonnement café appelée Brew — hero sombre, CTA orange chaud, trois cartes de fonctionnalités et une section tarifs.",
  "session.new.starter.images.title": "Générer 4 images",
  "session.new.starter.images.body": "Donnez-moi le concept — je créerai 4 variantes avec le modèle adapté au style.",
  "session.new.starter.images.prompt": "Utilise l’outil Creative Director pour générer 4 images qui racontent une courte histoire sur un astronaute découvrant un jardin caché sur la lune — garde le même personnage de manière cohérente sur les 4 cadres.",
  "session.new.starter.video.title": "Réaliser une courte vidéo",
  "session.new.starter.video.body": "Proposez la scène — je la générerai (Kling, Seedance, Sora) et j'itérerai sur le mouvement.",
  "session.new.starter.video.prompt": "Réalise une courte vidéo avec plusieurs plans d'une ville futuriste au crépuscule en utilisant Seedance 2 — plan large d'établissement, puis un panoramique au niveau de la rue, puis un gros plan sur des enseignes au néon.",
  "session.new.starter.music.title": "Composer de la musique ou une voix off",
  "session.new.starter.music.body": "Décrivez l'ambiance ou le script — je produirai l'audio avec Suno ou ElevenLabs.",
  "session.new.starter.music.prompt": "Compose un morceau lofi avec un piano doux et des beats légers — ambiance chill pour étudier.",
  "session.new.starter.ugc.title": "Créer une publicité UGC",
  "session.new.starter.ugc.body": "Donnez-moi le produit — je réaliserai une publicité UGC face caméra avec un créateur cohérent.",
  "session.new.starter.ugc.prompt": "Crée une publicité UGC face caméra de 15 secondes pour un sérum de soin — un créateur authentique tenant le produit, cadrage selfie décontracté, éclairage naturel, avec un court avis parlé.",
  "session.new.starter.productAnimation.title": "Animer un produit",
  "session.new.starter.productAnimation.body": "Montrez-moi le produit — je lui donnerai vie en mouvement.",
  "session.new.starter.productAnimation.prompt": "Anime ce produit en mouvement — une rotation cinématique lente à 360° d'une basket sur un fond de studio épuré avec une lumière douce en mouvement.",
  "session.new.starter.productPhotoshoot.title": "Shooting photo produit",
  "session.new.starter.productPhotoshoot.body": "Des photos de produits de qualité studio, sans studio — décrivez le rendu souhaité.",
  "session.new.starter.productPhotoshoot.prompt": "Crée un shooting photo studio pour un flacon de parfum en verre — une photo lifestyle sur du marbre avec des ombres douces, ainsi qu'un packshot propre sur fond blanc.",
  "session.new.starter.aiInfluencer.title": "Influenceur IA",
  "session.new.starter.aiInfluencer.body": "Créez une personnalité virtuelle cohérente que vous pourrez réutiliser dans différentes prises de vue.",
  "session.new.starter.aiInfluencer.prompt": "Crée une influenceuse IA cohérente — une femme passionnée de technologie d'une trentaine d'années — et verrouille son identité avec Visual DNA afin que je puisse la réutiliser pour mes futurs posts et vidéos.",
  ...
  "common.showArchivedSessions": "Afficher les sessions archivées",
  "common.hideArchivedSessions": "Masquer les sessions archivées",
  ...
  "settings.general.row.releaseNotes.description": "Afficher les popups Quoi de neuf après les mises à jour",
