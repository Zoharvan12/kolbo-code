export const dict = {
  ...
  "error.page.authExpired.title": "Votre session a expiré",
  "error.page.authExpired.description": "Vos identifiants API sont invalides ou ont expiré. Redémarrez l'application pour vous reconnecter.",
  "error.page.authExpired.restart": "Redémarrer et se connecter",
  ...
  "sidebar.sessions.empty": "Aucune session pour l'instant",
