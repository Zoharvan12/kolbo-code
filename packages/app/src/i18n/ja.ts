export const dict = {
  ...
  "error.page.authExpired.title": "セッションの有効期限が切れました",
  "error.page.authExpired.description": "API認証情報が無効であるか、有効期限が切れています。アプリを再起動して再度サインインしてください。",
  "error.page.authExpired.restart": "再起動してサインイン",
  ...
  "sidebar.sessions.empty": "セッションがまだありません",
