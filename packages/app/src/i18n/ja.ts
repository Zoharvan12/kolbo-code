export const dict = {
  ...
  "dialog.provider.kodu.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.kodu.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.koduGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.sort.label": "並べ替え",
  "dialog.model.sort.name": "名前",
  "dialog.model.sort.price": "価格",
  ...
  "provider.connect.apiKey.description": "{{provider}}のAPIキーを入力してアカウントを接続し、Koduで{{provider}}モデルを使用します。",
  ...
  "provider.connect.koduZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.koduZen.visit.prefix": " ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix": " にアクセスして認証コードを取得し、アカウントを接続してKoduで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " にアクセスし、以下のコードを入力してアカウントを接続し、Koduで{{provider}}モデルを使用してください。",
  ...
  "provider.custom.field.name.placeholder": "私のAIプロバイダー",
  ...
  "provider.custom.headers.key.placeholder": "ヘッダー名",
  ...
  "model.tag.free": "無料",
  "model.tag.latest": "最新",
  "model.tag.cost.low": "低コスト",
  "model.tag.cost.medium": "中コスト",
  "model.tag.cost.high": "高コスト",
  "model.tag.default": "デフォルト",
  ...
  "model.tooltip.pricing": "価格: {{value}}",
  "model.tooltip.typicalCost.unit": "クレジット/メッセージ",
  "model.tooltip.typicalCost.hint": "標準的なメッセージの場合です。会話が長くなるほど多く消費します。",
  ...
  "prompt.approval.auto": "自動実行",
  "prompt.approval.ask": "毎回確認",
  "prompt.approval.auto.long": "確認せずに自動実行",
  "prompt.approval.ask.long": "実行前に確認",
  "prompt.mode.shell.exit": "escで終了",
  "session.child.promptDisabled": "サブエージェントセッションはプロンプトできません。",
  "session.child.backToParent": "メインセッションに戻る。",
  "session.working.for": "作業時間: {{time}}",
  ...
  "prompt.action.uploading": "添付ファイルをアップロード中…",
  "prompt.action.dictate": "音声入力 (テキストへ変換)",
  "prompt.action.dictateStop": "音声入力を停止",
  "prompt.voice.listening": "録音中…",
  "prompt.voice.error.notLoggedIn": "音声入力を使用するにはKolboにサインインしてください",
  "prompt.voice.error.mic": "マイクが利用できません — システムの権限設定を確認してください",
  "prompt.voice.error.connection": "音声サービスが利用できません — もう一度お試しください",
  ...
  "prompt.toast.fileTooLarge.description": "メディアファイルは200MB以下でなければなりません。",
  ...
  "dialog.plugins.empty": "kodu.jsonで設定されたプラグイン",
  ...
  "dialog.server.add.namePlaceholder": "ローカルホスト",
  ...
  "dialog.server.default.description": "ローカルサーバーを起動する代わりに、アプリ起動時にこのサーバーに接続します。再起動が必要です。",
  ...
  "context.stats.creditsBalance": "クレジット残高",
  ...
  "context.usage.credits": "クレジット",
  "context.usage.credits.image": "画像",
  "context.usage.credits.video": "動画",
  "context.usage.credits.audio": "音声",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.status.browserOpened": "ブラウザが開きました — そこでサインインしてください",
  "dialog.login.confirmationCode": "確認コード",
  "dialog.login.copy": "コピー",
  "dialog.login.copied": "コピーしました",
  "session.header.zoom.out": "ズームアウト (Ctrl/Cmd -)",
  "session.header.zoom.in": "ズームイン (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "ズームアウト",
  "session.header.zoom.in.ariaLabel": "ズームイン",
  "session.header.colorScheme.toLightMode": "ライトモードに切り替え",
  "session.header.colorScheme.toDarkMode": "ダークモードに切り替え",
  "session.header.tab.terminal": "ターミナル",
  "session.header.tab.review": "レビュー",
  "session.header.tab.files": "ファイル",
  "settings.general.row.downloadFolder.title": "ダウンロードフォルダー",
  "settings.general.row.downloadFolder.description": "ダウンロードしたファイルが保存される場所",
  "settings.general.row.downloadFolder.change": "変更",
  ...
  "error.dev.rootNotFound": "ルート要素が見つかりません。index.htmlに追加するのを忘れていませんか？またはid属性のスペルが間違っていませんか？",
  ...
  "error.chain.checkConfig": "config (kodu.json) のプロバイダー/モデル名を確認してください",
  ...
  "session.tab.artifacts": "アーティファクト",
  "session.tab.canvas": "Canvas",
  "session.header.tab.canvas": "Canvas",
  "command.canvas.toggle": "Canvasの切り替え",
  "canvas.empty": "このセッションで生成された画像、動画、音声、3Dアセットがここに表示されます。",
  "canvas.density": "レイアウト",
  "canvas.density.cols": "1行あたり{{count}}個",
  "canvas.select": "選択",
  "canvas.cancelSelection": "選択をキャンセル",
  "canvas.clearSelection": "クリア",
  "canvas.selected.count": "{{count}}件選択中",
  "canvas.downloadSelected": "ダウンロード",
  "canvas.downloadSelected.toast": "{{count}}個のファイルをダウンロードしました",
  "canvas.downloadSelected.toastDescription": "ダウンロードフォルダーに保存しました",
  "canvas.downloadSelected.partialFailed": "{{count}}件のダウンロードに失敗しました",
  "canvas.hideSelected": "非表示",
  "canvas.hideSelected.toast": "{{count}}件をキャンバスから非表示にしました",
  "canvas.hide.tooltip": "キャンバスから非表示",
  "canvas.tab.session": "セッション",
  "canvas.tab.library": "ライブラリ",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "メディアがありません",
  "canvas.library.empty.caption.filtered": "現在のフィルターに一致する項目がありません。",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "生成またはアップロードして、ライブラリに追加しましょう。",
  "canvas.library.search.placeholder": "ライブラリを検索…",
  "canvas.library.project.all": "すべてのプロジェクト",
  "canvas.library.project.pick": "プロジェクトを選択",
  "canvas.library.filter.type.all": "すべて",
  "canvas.library.filter.type.images": "画像",
  "canvas.library.filter.type.videos": "動画",
  "canvas.library.filter.type.audio": "オーディオ",
  "canvas.library.filter.category.all": "すべて",
  "canvas.library.filter.category.ai": "AI",
  "canvas.library.filter.category.uploaded": "アップロード済み",
  "canvas.library.filter.category.favorites": "お気に入り",
  "canvas.library.filter.category.trash": "ゴミ箱",
  "canvas.library.folder.pick": "フォルダー",
  "canvas.library.folder.all": "すべてのフォルダー",
  "canvas.library.folder.owned": "自分のフォルダー",
  "canvas.library.folder.shared": "共有されたフォルダー",
  "canvas.library.filter.category.edited": "編集済み",
  "canvas.library.filter.category.training-lab": "トレーニングラボ",
  "canvas.library.favorite.add": "お気に入りに追加",
  "canvas.library.favorite.remove": "お気に入りを解除",
  "canvas.library.nsfw.hidden": "NSFW — タップして表示",
  "canvas.library.nsfw.reveal": "表示",
  "canvas.library.error": "ライブラリの読み込みに失敗しました",
  "canvas.library.retry": "再試行",
  "canvas.library.signedOut": "ライブラリを閲覧するにはKolboにサインインしてください",
  "artifact.preview": "プレビュー",
  "artifact.code": "コード",
  "artifact.openInTab": "新しいタブで開く",
  "artifact.publish": "公開",
  "artifact.publish.title": "アーティファクトを公開",
  "artifact.publish.defaultTitle": "Kolbo Code アーティファクト",
  "artifact.publish.loading": "公開中...",
  "artifact.publish.urlLabel": "公開URL",
  "artifact.publish.copy": "コピー",
  "artifact.publish.copied": "コピーしました",
  "artifact.publish.open": "ブラウザで開く",
  "session.panel.reviewAndFiles": "レビューとファイル",
  "session.panel.close": "パネルを閉じる",
  ...
  "session.review.noUncommittedChanges": "未コミットの変更はありません",
  "session.review.noBranchChanges": "ブランチの変更はありません",
  ...
  "session.new.title": "今日は何を作成しますか？",
  "session.new.subtitle": "ランディングページから画像、動画、音楽まで、アイデアを記述してください。",
  ...
  "session.new.starter.landing.title": "ランディングページを作成",
  "session.new.starter.landing.body": "製品やアイデアを説明してください。洗練されたページをデザインして公開します。",
  "session.new.starter.landing.prompt": "Brew というコーヒーサブスクアプリ向けのランディングページを作成してください — ダークなヒーロー、温かみのあるオレンジの CTA、3 つのフィーチャーカード、価格セクション。",
  "session.new.starter.images.title": "画像を4枚生成",
  "session.new.starter.images.body": "コンセプトを教えてください。スタイルに最適なモデルを使って4つのバリエーションを作成します。",
  "session.new.starter.images.prompt": "Creative Director ツールを使って、月で隠された庭を見つける宇宙飛行士の短い物語を語る 4 枚の画像を生成してください — 4 枚のフレーム全体で同じキャラクターの一貫性を保ってください。",
  "session.new.starter.video.title": "短い動画を作成",
  "session.new.starter.video.body": "撮影イメージを提案してください。それを生成し（Kling、Seedance、Sora）、動きを調整します。",
  "session.new.starter.video.prompt": "Seedance 2 を使って、夕暮れ時の未来都市を複数のショットで構成した短い動画を作成してください — ワイドな設定ショット、その後ストリートレベルのパン、最後にネオンサインのクローズアップ。",
  "session.new.starter.music.title": "音楽やボイスオーバーを作成",
  "session.new.starter.music.body": "雰囲気や台本を説明してください。SunoやElevenLabsを使用してオーディオを生成します。",
  "session.new.starter.music.prompt": "柔らかなピアノと優しいビートを使った lofi トラックを作曲してください — 落ち着いた勉強向けの雰囲気。",
  "session.new.starter.ugc.title": "UGC広告を作成",
  "session.new.starter.ugc.body": "製品を教えてください。一貫したクリエイターによるトーク形式のUGC広告を作成します。",
  "session.new.starter.ugc.prompt": "スキンケア美容液の15秒間のトーク形式UGC広告を作成して。製品を持った自然体なクリエイターが、自撮り風の構図で、自然光の下で簡潔にレビューする動画にして。",
  "session.new.starter.productAnimation.title": "プロダクトをアニメーション化",
  "session.new.starter.productAnimation.body": "製品を見せてください。躍動感のある映像に仕上げます。",
  "session.new.starter.productAnimation.prompt": "この製品をアニメーション化して。清潔感のあるスタジオ背景で、スニーカーがゆっくりと360度回転するシネマティックな動画を、柔らかなライティングで作成して。",
  "session.new.starter.productPhotoshoot.title": "プロダクト撮影",
  "session.new.starter.productPhotoshoot.body": "スタジオ不要でプロ品質の製品写真を。イメージを教えてください。",
  "session.new.starter.productPhotoshoot.prompt": "ガラス製の香水ボトルのスタジオ撮影画像を作成して。大理石の上で柔らかな影を落としたライフスタイルヒーローショットと、背景を白抜きにした製品画像をセットで作成して。",
  "session.new.starter.aiInfluencer.title": "AIインフルエンサー",
  "session.new.starter.aiInfluencer.body": "複数のショットで使い回せる、一貫したバーチャルキャラクターを作成します。",
  "session.new.starter.aiInfluencer.prompt": "一貫性のあるAIインフルエンサーを作成して。20代後半のテックに詳しい女性で、Visual DNAを使ってキャラクターを固定し、今後の投稿や動画で繰り返し使用できるようにして。",
  ...
  "session.share.popover.description.shared": "このセッションはウェブで公開されています。リンクを知っている人なら誰でもアクセスできます。",
  "session.share.popover.description.unshared": "セッションをウェブで公開します。リンクを知っている人なら誰でもアクセスできるようになります。",
  ...
  "common.restore": "復元",
  "common.showArchivedSessions": "アーカイブ済みセッションを表示",
  "common.hideArchivedSessions": "アーカイブ済みセッションを非表示",
  "common.delete": "削除",
  "common.close": "閉じる",
  "common.edit": "編集",
  ...
  "sidebar.empty.title": "プロジェクトが開いていません",
  ...
  "debugBar.delay.label": "遅延",
  "debugBar.delay.tip": "過去5秒間で観測された最悪の入力遅延。",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip": "過去5秒間の概算インタラクション時間。これは INP に似ていますが、公式の Web Vitals INP ではありません。",
  "debugBar.cls.label": "CLS",
  "debugBar.cls.tip": "現在のアプリ寿命の累積レイアウトシフト。",
  "debugBar.mem.label": "メモリ",
  ...
  "settings.general.row.followup.description": "フォローアッププロンプトを即座に実行するか、キューで待機させるかを選択します",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "タイムラインで shell ツールパーツをデフォルトで展開して表示します",
  "settings.general.row.editToolPartsExpanded.title": "edit ツールパーツを展開",
  "settings.general.row.editToolPartsExpanded.description": "タイムラインで edit、write、patch ツールパーツをデフォルトで展開して表示します",
  "settings.general.row.showSessionProgressBar.title": "セッション進行状況バーを表示",
  "settings.general.row.showSessionProgressBar.description": "エージェントの処理中にセッション上部でアニメーション付きの進行状況バーを表示します",
  ...
  "settings.general.row.wayland.tooltip": "リフレッシュレートが混在するモニターを使用しているLinuxでは、ネイティブWaylandの方が安定する場合があります。",
  ...
  "settings.general.notifications.agent.description": "エージェントが完了したか、注意が必要な場合にシステム通知を表示します",
