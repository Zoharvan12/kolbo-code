export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Koduが提供する無料モデル",
  ...
  "provider.connect.koduZen.line1": "Kodu Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "prompt.toast.fileTooLarge.description": "音声および動画ファイルは{{max}}以下でなければなりません。",
  ...
  "dialog.server.description": "このアプリが接続するKoduサーバーを切り替えます。",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": "Kolbo Codeへようこそ",
  "dialog.login.subtitle": "続行するにはKolbo.AIアカウントでサインインしてください",
  "dialog.login.button.continue": "Kolboで続行",
  ...
  "toast.update.description": "Koduの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKoduチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "Koduには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKoduサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Koduの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのKoduの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Koduがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Koduのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Kodu の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Kodu は最新バージョンです。",
