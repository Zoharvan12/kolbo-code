export const dict = {
  ...
  "error.page.authExpired.title": "세션이 만료되었습니다",
  "error.page.authExpired.description": "API 자격 증명이 유효하지 않거나 만료되었습니다. 앱을 재시작하여 다시 로그인하세요.",
  "error.page.authExpired.restart": "재시작 및 로그인",
