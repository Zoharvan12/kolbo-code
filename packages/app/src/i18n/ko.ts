export const dict = {
  ...
  "dialog.provider.kodu.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.kodu.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.koduGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.sort.label": "정렬",
  "dialog.model.sort.name": "이름순",
  "dialog.model.sort.price": "가격순",
  ...
  "provider.connect.apiKey.description": "{{provider}} API 키를 입력하여 계정을 연결하고 Kodu에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.koduZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.koduZen.visit.prefix": "다음 ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  "provider.connect.oauth.code.visit.prefix": "다음 ",
  "provider.connect.oauth.code.visit.link": "이 링크",
  "provider.connect.oauth.code.visit.suffix": "를 방문하여 인증 코드를 받아 계정을 연결하고 Kodu에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix": "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Kodu에서 {{provider}} 모델을 사용하세요.",
  ...
  "model.tag.free": "무료",
  "model.tag.latest": "최신",
  "model.tag.cost.low": "낮은 비용",
  "model.tag.cost.medium": "중간 비용",
  "model.tag.cost.high": "높은 비용",
  "model.tag.default": "기본",
  ...
  "model.tooltip.pricing": "가격: {{value}}",
  "model.tooltip.typicalCost.unit": "크레딧/메시지",
  "model.tooltip.typicalCost.hint": "일반적인 메시지 기준입니다. 대화가 길어지면 더 많이 사용됩니다.",
  ...
  "prompt.approval.label": "승인 모드",
  "prompt.approval.auto": "자동 실행",
  "prompt.approval.ask": "먼저 묻기",
  "prompt.approval.auto.long": "확인 없이 자동 실행",
  "prompt.approval.ask.long": "실행 전 확인",
  "prompt.mode.shell.exit": "종료하려면 esc",
  "session.child.promptDisabled": "서브 에이전트 세션은 프롬프트를 받을 수 없습니다.",
  "session.child.backToParent": "메인 세션으로 돌아가기.",
  "session.working.for": "{{time}}째 작업 중",
  ...
  "prompt.action.uploading": "첸부 파일 업로드 중…",
  "prompt.action.dictate": "받아쓰기 (음성을 텍스트로)",
  "prompt.action.dictateStop": "받아쓰기 중지",
  "prompt.voice.listening": "듣는 중…",
  "prompt.voice.error.notLoggedIn": "음성 받아쓰기를 사용하려면 Kolbo에 로그인하세요",
  "prompt.voice.error.mic": "마이크를 사용할 수 없습니다 — 시스템 권한을 확인하세요",
  "prompt.voice.error.connection": "음성 서비스를 사용할 수 없습니다 — 다시 시도하세요",
  "prompt.toast.pasteUnsupported.title": "지원되지 않는 첨부 파일",
  "prompt.toast.pasteUnsupported.description": "이미지, PDF 또는 텍스트 파일만 첨부할 수 있습니다.",
  "prompt.toast.fileTooLarge.title": "파일이 너무 큽니다",
  "prompt.toast.fileTooLarge.description": "미디어 파일은 200MB 이하이어야 합니다.",
  ...
  "dialog.plugins.empty": "kodu.json에 구성된 플러그인",
  ...
  "dialog.server.add.namePlaceholder": "로컬호스트",
  ...
  "dialog.server.default.description": "로컬 서버를 시작하는 대신 앱 실행 시 이 서버에 연결합니다. 다시 시작해야 합니다.",
  ...
  "context.stats.creditsBalance": "크레딧 잔액",
  ...
  "context.usage.credits": "크레딧",
  "context.usage.credits.image": "이미지",
  "context.usage.credits.video": "비디오",
  "context.usage.credits.audio": "오디오",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.status.browserOpened": "브라우저가 열렸습니다 — 거기서 로그인하세요",
  "dialog.login.confirmationCode": "확인 코드",
  "dialog.login.copy": "복사",
  "dialog.login.copied": "복사됨",
  "session.header.zoom.out": "축소 (Ctrl/Cmd -)",
  "session.header.zoom.in": "확대 (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "축소",
  "session.header.zoom.in.ariaLabel": "확대",
  "session.header.colorScheme.toLightMode": "라이트 모드로 전환",
  "session.header.colorScheme.toDarkMode": "다크 모드로 전환",
  "session.header.tab.terminal": "터미널",
  "session.header.tab.review": "리뷰",
  "session.header.tab.files": "파일",
  "settings.general.row.downloadFolder.title": "다운로드 폴더",
  "settings.general.row.downloadFolder.description": "다운로드된 파일이 저장되는 위치",
  "settings.general.row.downloadFolder.change": "변경",
  ...
  "error.dev.rootNotFound": "루트 요소를 찾을 수 없습니다. index.html에 추가하는 것을 잊으셨나요? 또는 id 속성의 철자가 틀렸을 수 있습니다.",
  ...
  "error.chain.checkConfig": "구성(kodu.json)의 공급자/모델 이름을 확인하세요",
  ...
  "session.tab.artifacts": "아티팩트",
  "session.tab.canvas": "Canvas",
  "session.header.tab.canvas": "Canvas",
  "command.canvas.toggle": "Canvas 토글",
  "canvas.empty": "이 세션에서 생성된 이미지, 비디오, 오디오 및 3D 에셋이 여기에 표시됩니다.",
  "canvas.density": "레이아웃",
  "canvas.density.cols": "행당 {{count}}개",
  "canvas.select": "선택",
  "canvas.cancelSelection": "선택 취소",
  "canvas.clearSelection": "지우기",
  "canvas.selected.count": "{{count}}개 선택됨",
  "canvas.downloadSelected": "다운로드",
  "canvas.downloadSelected.toast": "{{count}}개 파일을 다운로드했습니다",
  "canvas.downloadSelected.toastDescription": "다운로드 폴더에 저장되었습니다",
  "canvas.downloadSelected.partialFailed": "{{count}}개 다운로드 실패",
  "canvas.hideSelected": "숨기기",
  "canvas.hideSelected.toast": "캔버스에서 {{count}}개 항목을 숨겼습니다",
  "canvas.hide.tooltip": "캔버스에서 숨기기",
  "canvas.tab.session": "세션",
  "canvas.tab.library": "라이브러리",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "미디어 없음",
  "canvas.library.empty.caption.filtered": "현재 필터에 일치하는 항목이 없습니다.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "무언가를 생성하거나 업로드하여 라이브러리를 채워보세요.",
  "canvas.library.search.placeholder": "라이브러리 검색…",
  "canvas.library.project.all": "모든 프로젝트",
  "canvas.library.project.pick": "프로젝트 선택",
  "canvas.library.filter.type.all": "전체",
  "canvas.library.filter.type.images": "이미지",
  "canvas.library.filter.type.videos": "비디오",
  "canvas.library.filter.type.audio": "오디오",
  "canvas.library.filter.category.all": "전체",
  "canvas.library.filter.category.ai": "AI",
  "canvas.library.filter.category.uploaded": "업로드됨",
  "canvas.library.filter.category.favorites": "즐겨찾기",
  "canvas.library.filter.category.trash": "휴지통",
  "canvas.library.folder.pick": "폴더",
  "canvas.library.folder.all": "모든 폴더",
  "canvas.library.folder.owned": "내 폴더",
  "canvas.library.folder.shared": "나와 공유됨",
  "canvas.library.filter.category.edited": "편집됨",
  "canvas.library.filter.category.training-lab": "트레이닝 랩",
  "canvas.library.favorite.add": "즐겨찾기",
  "canvas.library.favorite.remove": "즐겨찾기 해제",
  "canvas.library.nsfw.hidden": "NSFW — 탭하여 보기",
  "canvas.library.nsfw.reveal": "보기",
  "canvas.library.error": "라이브러리를 불러오지 못했습니다",
  "canvas.library.retry": "재시도",
  "canvas.library.signedOut": "라이브러리를 탐색하려면 Kolbo에 로그인하세요",
  "artifact.preview": "미리보기",
  "artifact.code": "코드",
  "artifact.openInTab": "새 탭에서 열기",
  "artifact.publish": "게시",
  "artifact.publish.title": "아티팩트 게시",
  "artifact.publish.defaultTitle": "Kolbo Code 아티팩트",
  "artifact.publish.loading": "게시 중…",
  "artifact.publish.urlLabel": "공개 URL",
  "artifact.publish.copy": "복사",
  "artifact.publish.copied": "복사됨",
  "artifact.publish.open": "브라우저에서 열기",
  "session.panel.reviewAndFiles": "검토 및 파일",
  "session.panel.close": "패널 닫기",
  ...
  "session.new.title": "오늘은 무엇을 만들어볼까요?",
  "session.new.subtitle": "랜딩 페이지부터 이미지, 비디오, 음악까지 무엇이든 아이디어를 알려주세요.",
  ...
  "session.new.starter.landing.title": "랜딩 페이지 만들기",
  "session.new.starter.landing.body": "제품이나 아이디어를 설명해 주세요. 세련된 페이지를 설계하고 완성해 드립니다.",
  "session.new.starter.landing.prompt": "Brew라는 커피 구독 앱을 위한 랜딩 페이지를 만들어 줘 — 어두운 히어로, 따뜻한 오렌지 CTA, 3개의 기능 카드, 그리고 가격 섹션.",
  "session.new.starter.images.title": "이미지 4장 생성",
  "session.new.starter.images.body": "콘셉트를 말씀해 주시면 스타일에 맞는 모델을 선택해 4가지 버전을 생성합니다.",
  "session.new.starter.images.prompt": "Creative Director 도구를 사용해 달에서 숨겨진 정원을 발견하는 우주비행사의 짧은 이야기를 담은 4장의 이미지를 생성해 줘 — 4개의 프레임 모두에서 동일한 캐릭터를 일관되게 유지해 줘.",
  "session.new.starter.video.title": "짧은 비디오 만들기",
  "session.new.starter.video.body": "장면을 설명해 주시면 Kling, Seedance, Sora를 사용해 생성하고 움직임을 조정합니다.",
  "session.new.starter.video.prompt": "Seedance 2를 사용해 황혼 무렵의 미래 도시를 여러 샷으로 담은 짧은 비디오를 만들어 줘 — 넓은 설정 샷, 거리 시점의 팬, 그리고 네온사인 클로즈업.",
  "session.new.starter.music.title": "음악 작곡 또는 보이스오버 제작",
  "session.new.starter.music.body": "분위기나 스크립트를 알려주시면 Suno나 ElevenLabs로 오디오를 제작합니다.",
  "session.new.starter.music.prompt": "부드러운 피아노와 잔잔한 비트가 어우러진 lofi 트랙을 작곡해 줘 — 차분한 공부 분위기.",
  "session.new.starter.ugc.title": "UGC 광고 만들기",
  "session.new.starter.ugc.body": "제품 정보를 알려주시면, 일관된 모델이 출연하는 UGC 광고를 제작해 드립니다.",
  "session.new.starter.ugc.prompt": "스킨케어 세럼을 위한 15초 분량의 UGC 광고를 만들어 줘. 제품을 들고 있는 자연스러운 셀카 구도와 자연광을 활용하고, 실제 사용 후기를 말하는 듯한 영상으로 제작해 줘.",
  "session.new.starter.productAnimation.title": "제품 애니메이션",
  "session.new.starter.productAnimation.body": "제품을 보여주시면 생생한 움직임을 입혀 드립니다.",
  "session.new.starter.productAnimation.prompt": "이 제품을 활용해 애니메이션을 만들어 줘. 깔끔한 스튜디오 배경에서 운동화가 360도로 천천히 회전하는 시네마틱한 영상을 만들고, 부드러운 조명 효과를 넣어 줘.",
  "session.new.starter.productPhotoshoot.title": "제품 화보 촬영",
  "session.new.starter.productPhotoshoot.body": "스튜디오 없이도 스튜디오 퀄리티의 제품 사진을 찍어 드립니다. 원하는 스타일을 알려주세요.",
  "session.new.starter.productPhotoshoot.prompt": "유리 향수병을 위한 스튜디오 제품 화보를 찍어 줘. 대리석 위에서 부드러운 그림자가 드리워진 라이프스타일 컷과, 깔끔한 흰색 배경의 패키지 컷을 포함해 줘.",
  "session.new.starter.aiInfluencer.title": "AI 인플루언서",
  "session.new.starter.aiInfluencer.body": "여러 작업에서 일관되게 활용할 수 있는 가상 인물을 생성하세요.",
  "session.new.starter.aiInfluencer.prompt": "일관된 외형을 가진 AI 인플루언서를 만들어 줘. 20대 후반의 테크에 능숙한 여성 모델로 설정하고, Visual DNA를 통해 고정된 페르소나를 생성해서 앞으로의 게시물이나 영상에서도 계속 재사용할 수 있게 해 줘.",
  ...
  "session.header.open.finder": "파인더",
  ...
  "session.share.popover.description.unshared": "세션을 웹에 공개적으로 공유합니다. 링크가 있는 누구나 액세스할 수 있습니다.",
  ...
  "common.archived": "보관됨",
  "common.restore": "복원",
  "common.showArchivedSessions": "보관된 세션 보기",
  "common.hideArchivedSessions": "보관된 세션 숨기기",
  "common.delete": "삭제",
  "common.close": "닫기",
  "common.edit": "편집",
  ...
  "debugBar.nav.tip": "세션 페이지에 닿은 마지막 완료된 라우트 전환. 라우터 시작부터 정착 후 첫 번째 페인트까지 측정됨.",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "타임라인에서 기본적으로 shell 도구 파트를 펼친 상태로 표시합니다",
  "settings.general.row.editToolPartsExpanded.title": "edit 도구 파트 펼치기",
  "settings.general.row.editToolPartsExpanded.description": "타임라인에서 기본적으로 edit, write, patch 도구 파트를 펼친 상태로 표시합니다",
  "settings.general.row.showSessionProgressBar.title": "세션 진행률 표시줄 표시",
  "settings.general.row.showSessionProgressBar.description": "에이전트가 작업 중일 때 세션 상단에 애니메이션 진행률 표시줄을 표시합니다",
  ...
  "settings.general.row.wayland.tooltip": "혼합 주사율 모니터가 있는 Linux에서는 네이티브 Wayland가 더 안정적일 수 있습니다.",
