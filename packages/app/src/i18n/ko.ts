export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kodu에서 제공하는 무료 모델",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "prompt.toast.fileTooLarge.description": "오디오 및 비디오 파일은 {{max}} 이하이어야 합니다.",
  ...
  "dialog.server.description": "이 앱이 연결할 Kodu 서버를 전환합니다.",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": "Kolbo Code에 오신 것을 환영합니다",
  "dialog.login.subtitle": "계속하려면 Kolbo.AI 계정으로 로그인하세요",
  "dialog.login.button.continue": "Kolbo로 계속하기",
  ...
  "toast.update.description": "Kodu의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Kodu 팀에 제보해 주세요: ",
  ...
  "sidebar.gettingStarted.line1": "Kodu에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Kodu 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Kodu 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Kodu가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Kodu가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Kodu 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Kodu를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Kodu를 사용 중입니다.",
