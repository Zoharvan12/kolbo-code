...
export const dict = {
  ...
  "dialog.provider.kodu.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.kodu.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.koduGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Kodu",
  ...
  "provider.connect.apiKey.description": "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Kodu.",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.koduZen.line2": "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.koduZen.visit.prefix": "Besøk ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix": " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Kodu.",
  ...
  "model.tag.cost.low": "Lav kostnad",
  "model.tag.cost.medium": "Middels kostnad",
  "model.tag.cost.high": "Høy kostnad",
  ...
  "model.tooltip.typicalCost.unit": "kreditter per melding",
  "model.tooltip.typicalCost.hint": "Typisk melding. Lengre samtaler bruker mer.",
  ...
  "session.child.promptDisabled": "Subagent-økter kan ikke bli bedt om.",
  ...
  "prompt.action.uploading": "Laster opp vedlegg…",
  "prompt.action.dictate": "Dikter (tale til tekst)",
  "prompt.action.dictateStop": "Stopp diktering",
  "prompt.voice.listening": "Lytter…",
  "prompt.voice.error.notLoggedIn": "Logg inn på Kolbo for å bruke talediktering",
  "prompt.voice.error.mic": "Mikrofonen er utilgjengelig — sjekk systemtillatelser",
  "prompt.voice.error.connection": "Taletjenesten er utilgjengelig — prøv igjen",
  ...
  "prompt.toast.fileTooLarge.title": "Fil for stor",
  "prompt.toast.fileTooLarge.description": "Mediefiler må være under 200 MB.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i kodu.json",
  ...
  "dialog.server.description": "Bytt hvilken Kodu-server denne appen kobler til.",
  ...
  "dialog.server.default.description": "Koble til denne serveren ved oppstart i stedet for å starte en lokal server. Krever omstart.",
  ...
  "context.stats.creditsBalance": "Kredittbalanse",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": `Velkommen til ${BRAND}`,
  "dialog.login.subtitle": "Logg inn med din Kolbo.AI-konto for å fortsette",
  "dialog.login.button.continue": "Fortsett med Kolbo",
  "dialog.login.status.browserOpened": "Nettleser åpnet — logg inn der",
  "dialog.login.confirmationCode": "Bekreftelseskode",
  "dialog.login.copy": "Kopier",
  "dialog.login.copied": "Kopiert",
  "session.header.zoom.out": "Zoom ut (Ctrl/Cmd -)",
  "session.header.zoom.in": "Zoom inn (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Zoom ut",
  "session.header.zoom.in.ariaLabel": "Zoom inn",
  "session.header.colorScheme.toLightMode": "Bytt til lys modus",
  "session.header.colorScheme.toDarkMode": "Bytt til mørk modus",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Gjennomgå",
  "session.header.tab.files": "Filer",
  "settings.general.row.downloadFolder.title": "Nedlastingsmappe",
  "settings.general.row.downloadFolder.description": "Hvor nedlastede filer lagres",
  "settings.general.row.downloadFolder.change": "Endre",
  ...
  "toast.update.description": "En ny versjon av Kodu ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Kodu-teamet",
  "error.page.report.discord": "på Discord",
  "error.page.version": "Versjon: {{version}}",
  "error.dev.rootNotFound": "Rotelement ikke funnet. Glemte du å legge det til i index.html? Eller kanskje id-attributten er feilstavet?",
  ...
  "directory.error.invalidUrl": "Ugyldig katalog i URL.",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (kodu.json)",
  ...
  "session.review.noSnapshot": "Snapshot-sporing er deaktivert i konfigurasjonen, så sesjonsendringer er ikke tilgjengelige",
  ...
  "session.share.popover.description.shared": "Denne sesjonen er offentlig på nettet. Den er tilgjengelig for alle med lenken.",
  "session.share.popover.description.unshared": "Del sesjonen offentlig på nettet. Den vil være tilgjengelig for alle med lenken.",
  ...
  "terminal.connectionLost.description": "Terminalforbindelsen ble avbrutt. Dette kan skje når serveren starter på nytt.",
  ...
  "sidebar.gettingStarted.line1": "Kodu inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "debugBar.nav.tip": "Siste fullførte ruteovergang som berører en sesjonsside, målt fra ruterstart til første opptegning etter at den har roet seg.",
  "debugBar.fps.label": "FPS",
  "debugBar.fps.tip": "Rullende bilder per sekund over de siste 5 sekundene.",
  "debugBar.frame.label": "RAMME",
  ...
  "debugBar.long.label": "LANG",
  "debugBar.long.tip": "Blokkert tid og antall lange oppgaver i de siste 5 sekundene. Maks oppgave: {{max}}.",
  "debugBar.delay.label": "FORSINKELSE",
  "debugBar.delay.tip": "Verste observerte inndataforsinkelse i de siste 5 sekundene.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip": "Omtrentlig interaksjonsvarighet over de siste 5 sekundene. Dette er INP-lignende, ikke den offisielle Web Vitals INP.",
  ...
  "settings.desktop.wsl.description": "Kjør Kodu-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Kodu",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Kodu ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Kodu skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Kodu er tematisert.",
  ...
  "settings.general.row.editToolPartsExpanded.description": "Vis edit-, write- og patch-verktøydeler utvidet som standard i tidslinjen",
  ...
  "settings.general.row.wayland.tooltip": "På Linux med skjermer med blandet oppdateringsfrekvens kan innebygd Wayland være mer stabilt.",
  "settings.general.row.releaseNotes.title": "Utgivelsesnotater",
  "settings.general.row.releaseNotes.description": "Vis Hva er nytt-popup etter oppdateringer",
  "settings.updates.row.startup.title": "Se etter oppdateringer ved oppstart",
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Kodu starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Kodu.",
  ...
  "settings.general.notifications.agent.description": "Vis systemvarsel når agenten er ferdig eller trenger oppmerksomhet",
  ...
  "session.working.for": "Jobbet i {{time}}",
  "session.new.starter.ugc.title": "Lag en UGC-annonse",
  "session.new.starter.ugc.body": "Gi meg produktet — jeg lager en «talking-head» UGC-annonse med en fast innholdsskaper.",
  "session.new.starter.ugc.prompt": "Lag en 15-sekunders UGC-annonse med en person som snakker om et hudpleieserum — en autentisk skaper som holder produktet, uformell selfie-vinkel, naturlig lys, med en kort muntlig anmeldelse.",
  "session.new.starter.productAnimation.title": "Animer et produkt",
  "session.new.starter.productAnimation.body": "Vis meg produktet — jeg gir det liv med bevegelse.",
  "session.new.starter.productAnimation.prompt": "Animer dette produktet i bevegelse — en langsom, filmatisk 360-graders rotasjon av en joggesko på en ren studiobakgrunn med mykt, bevegelig lys.",
  "session.new.starter.productPhotoshoot.title": "Produktfotografering",
  "session.new.starter.productPhotoshoot.body": "Produktbilder med studiokvalitet, uten studio — beskriv stilen.",
  "session.new.starter.productPhotoshoot.prompt": "Lag en produktfotografering i studio for en parfymeflaske i glass — et livsstilsbilde på marmor med myke skygger, pluss et rent produktbilde med hvit bakgrunn.",
  "session.new.starter.aiInfluencer.title": "AI-influencer",
  "session.new.starter.aiInfluencer.body": "Lag en konsistent virtuell person du kan gjenbruke i ulike bilder og videoer.",
  "session.new.starter.aiInfluencer.prompt": "Lag en konsistent AI-influencer — en teknologikyndig kvinne i slutten av 20-årene — og lås identiteten hennes med Visual DNA slik at jeg kan gjenbruke henne i fremtidige innlegg og videoer.",
}
