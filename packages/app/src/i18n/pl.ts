export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Kodu.",
  ...
  "provider.connect.koduZen.line1":
    "Kodu Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Kodu.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Kodu does not support MCP authentication yet.',
  ...
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Kodu ma używać motywu systemowego, jasnego czy ciemnego",
