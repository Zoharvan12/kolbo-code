...
export const dict = {
  ...
  "dialog.provider.kodu.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.kodu.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.koduGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Kodu",
  ...
  "provider.connect.apiKey.description": "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Kodu.",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.koduZen.line2": "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.koduZen.visit.prefix": "Odwiedź ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix": ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Kodu.",
  ...
  "model.tag.cost.low": "Niski koszt",
  "model.tag.cost.medium": "Średni koszt",
  "model.tag.cost.high": "Wysoki koszt",
  ...
  "model.tooltip.typicalCost.unit": "kredytów na wiadomość",
  "model.tooltip.typicalCost.hint": "Typowa wiadomość. Dłuższe rozmowy zużywają więcej.",
  ...
  "session.child.promptDisabled": "Sesje subagentów nie mogą być wywoływane.",
  ...
  "prompt.action.uploading": "Przesyłanie załączników…",
  "prompt.action.dictate": "Dyktowanie (głos na tekst)",
  "prompt.action.dictateStop": "Zatrzymaj dyktowanie",
  "prompt.voice.listening": "Słucham…",
  "prompt.voice.error.notLoggedIn": "Zaloguj się do Kolbo, aby korzystać z dyktowania głosowego",
  "prompt.voice.error.mic": "Mikrofon niedostępny — sprawdź uprawnienia systemowe",
  "prompt.voice.error.connection": "Usługa głosowa niedostępna — spróbuj ponownie",
  ...
  "prompt.toast.fileTooLarge.title": "Plik za duży",
  "prompt.toast.fileTooLarge.description": "Pliki multimedialne muszą mieć mniej niż 200 MB.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w kodu.json",
  ...
  "dialog.server.description": "Przełącz serwer Kodu, z którym łączy się ta aplikacja.",
  ...
  "dialog.project.edit.worktree.startup.description": "Uruchamia się po utworzeniu nowego obszaru roboczego (worktree).",
  ...
  "context.stats.creditsBalance": "Saldo kredytów",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": `Witamy w ${BRAND}`,
  "dialog.login.subtitle": "Zaloguj się za pomocą swojego konta Kolbo.AI, aby kontynuować",
  "dialog.login.button.continue": "Kontynuuj z Kolbo",
  "dialog.login.status.browserOpened": "Przeglądarka otwarta — zaloguj się tam",
  "dialog.login.confirmationCode": "Kod potwierdzający",
  "dialog.login.copy": "Kopiuj",
  "dialog.login.copied": "Skopiowano",
  "session.header.zoom.out": "Zmniejsz zoom (Ctrl/Cmd -)",
  "session.header.zoom.in": "Powiększ zoom (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Oddal",
  "session.header.zoom.in.ariaLabel": "Powiększ",
  "session.header.colorScheme.toLightMode": "Przełącz na tryb jasny",
  "session.header.colorScheme.toDarkMode": "Przełącz na tryb ciemny",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Przegląd",
  "session.header.tab.files": "Pliki",
  "settings.general.row.downloadFolder.title": "Folder pobierania",
  "settings.general.row.downloadFolder.description": "Gdzie zapisywane są pobrane pliki",
  "settings.general.row.downloadFolder.change": "Zmień",
  ...
  "toast.update.description": "Nowa wersja Kodu ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Kodu",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (kodu.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Kodu zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.title": "Integracja WSL",
  "settings.desktop.wsl.description": "Run the Kodu server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Kodu",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Kodu na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description": "Wybierz, czy Kodu ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Kodu.",
  ...
  "settings.general.row.editToolPartsExpanded.description": "Domyślnie pokazuj rozwinięte elementy narzędzi edit, write i patch na osi czasu",
  ...
  "settings.general.row.releaseNotes.description": "Pokaż powiadomienia Co nowego po aktualizacjach",
  "settings.updates.row.startup.title": "Sprawdzaj aktualizacje przy uruchomieniu",
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Kodu",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Kodu.",
  ...
  "sound.option.nope01": "Nie 01",
  "sound.option.nope02": "Nie 02",
  "sound.option.nope03": "Nie 03",
  "sound.option.nope04": "Nie 04",
  "sound.option.nope05": "Nie 05",
  "sound.option.nope06": "Nie 06",
  "sound.option.nope07": "Nie 07",
  "sound.option.nope08": "Nie 08",
  "sound.option.nope09": "Nie 09",
  "sound.option.nope10": "Nie 10",
  "sound.option.nope11": "Nie 11",
  "sound.option.nope12": "Nie 12",
  "sound.option.yup01": "Tak 01",
  "sound.option.yup02": "Tak 02",
  "sound.option.yup03": "Tak 03",
  "sound.option.yup04": "Tak 04",
  "sound.option.yup05": "Tak 05",
  "sound.option.yup06": "Tak 06",
  ...
  "settings.shortcuts.group.prompt": "Podpowiedź",
  ...
  "session.working.for": "Pracuję od {{time}}",
  "session.new.starter.ugc.title": "Stwórz reklamę UGC",
  "session.new.starter.ugc.body": "Podaj mi produkt, a ja przygotuję reklamę UGC typu talking-head z udziałem stałego twórcy.",
  "session.new.starter.ugc.prompt": "Stwórz 15-sekundową reklamę UGC typu talking-head dla serum do pielęgnacji skóry – autentyczny twórca trzymający produkt, w kadrze typu casual selfie, przy naturalnym oświetleniu, z krótką recenzją mówioną.",
  "session.new.starter.productAnimation.title": "Animuj produkt",
  "session.new.starter.productAnimation.body": "Pokaż mi produkt, a ja ożywię go w ruchu.",
  "session.new.starter.productAnimation.prompt": "Zanimuj ten produkt w ruchu – powolny, kinowy obrót buta sportowego o 360° na czystym tle studyjnym z delikatnie poruszającym się światłem.",
  "session.new.starter.productPhotoshoot.title": "Sesja zdjęciowa produktu",
  "session.new.starter.productPhotoshoot.body": "Zdjęcia produktowe w jakości studyjnej bez potrzeby wynajmowania studia – opisz oczekiwany efekt.",
  "session.new.starter.productPhotoshoot.prompt": "Stwórz sesję studyjną dla szklanej buteleczki perfum – hero shot w stylu lifestylowym na marmurze z miękkimi cieniami oraz packshot na czystym, białym tle.",
  "session.new.starter.aiInfluencer.title": "Influencer AI",
  "session.new.starter.aiInfluencer.body": "Stwórz spójną wirtualną postać, której możesz używać w wielu ujęciach.",
  "session.new.starter.aiInfluencer.prompt": "Stwórz spójnego influencera AI – obeznaną z technologią kobietę przed trzydziestką – i zablokuj jej tożsamość za pomocą Visual DNA, abym mógł wykorzystywać ją w przyszłych postach i filmach.",
}
