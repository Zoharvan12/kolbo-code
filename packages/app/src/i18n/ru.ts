export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Kodu",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "prompt.toast.fileTooLarge.description": "Аудио и видео файлы должны быть меньше {{max}}.",
  ...
  "dialog.server.description": "Переключите сервер Kodu к которому подключается приложение.",
  ...
  "language.he": "Иврит",
  "language.hi": "Хинди",
  "dialog.login.title": "Добро пожаловать в Kolbo Code",
  "dialog.login.subtitle": "Войдите с помощью вашей учетной записи Kolbo.AI, чтобы продолжить",
  "dialog.login.button.continue": "Продолжить с Kolbo",
  ...
  "toast.update.description": "Новая версия Kodu ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Kodu",
  ...
  "sidebar.gettingStarted.line1": "Kodu включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Kodu внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Kodu",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Kodu выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Kodu системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Kodu.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Kodu",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Kodu.",
