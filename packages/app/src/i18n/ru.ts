export const dict = {
  ...
  "dialog.provider.kodu.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.kodu.tagline": "Надежные оптимизированные модели",
  "dialog.provider.koduGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.sort.label": "Сортировка",
  "dialog.model.sort.name": "Имя",
  "dialog.model.sort.price": "Цена",
  ...
  "provider.connect.apiKey.description": "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Kodu.",
  ...
  "provider.connect.koduZen.line2": "С одним API ключом вы получите доступ к таким моделям как Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.koduZen.visit.prefix": "Посетите ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix": " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Kodu.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Kodu.",
  ...
  "provider.custom.field.providerID.placeholder": "мойпровайдер",
  ...
  "provider.custom.headers.key.placeholder": "Имя-Заголовка",
  ...
  "model.tag.cost.low": "Низкая стоимость",
  "model.tag.cost.medium": "Средняя стоимость",
  "model.tag.cost.high": "Высокая стоимость",
  "model.tag.default": "По умолчанию",
  ...
  "model.tooltip.pricing": "Стоимость: {{value}}",
  "model.tooltip.typicalCost.unit": "кредитов за сообщение",
  "model.tooltip.typicalCost.hint": "Типичное сообщение. Более длинные чаты расходуют больше.",
  ...
  "prompt.approval.label": "Режим подтверждения",
  "prompt.approval.auto": "Автозапуск",
  "prompt.approval.ask": "Спрашивать",
  "prompt.approval.auto.long": "Запускать автоматически без вопросов",
  "prompt.approval.ask.long": "Подтверждать перед запуском",
  "prompt.mode.shell.exit": "esc для выхода",
  "session.child.promptDisabled": "Сессии субагента не могут быть запрошены.",
  "session.child.backToParent": "Назад к основной сессии.",
  "session.working.for": "Работаю уже {{time}}",
  ...
  "prompt.action.uploading": "Загрузка вложений…",
  "prompt.action.dictate": "Диктовать (голос в текст)",
  "prompt.action.dictateStop": "Остановить диктовку",
  "prompt.voice.listening": "Слушаю…",
  "prompt.voice.error.notLoggedIn": "Войдите в Kolbo, чтобы использовать голосовую диктовку",
  "prompt.voice.error.mic": "Микрофон недоступен — проверьте системные разрешения",
  "prompt.voice.error.connection": "Голосовой сервис недоступен — попробуйте еще раз",
  ...
  "prompt.toast.fileTooLarge.title": "Файл слишком большой",
  "prompt.toast.fileTooLarge.description": "Медиафайлы должны быть меньше 200 МБ.",
  ...
  "dialog.plugins.empty": "Плагины настроены в kodu.json",
  ...
  "dialog.server.add.namePlaceholder": "Локальный хост",
  ...
  "context.stats.creditsBalance": "Баланс кредитов",
  ...
  "context.usage.credits": "Кредиты",
  "context.usage.credits.image": "Изображение",
  "context.usage.credits.video": "Видео",
  "context.usage.credits.audio": "Аудио",
  ...
  "language.he": "Иврит",
  "language.hi": "Хинди",
  "dialog.login.status.browserOpened": "Браузер открыт — войдите там",
  "dialog.login.confirmationCode": "Код подтверждения",
  "dialog.login.copy": "Копировать",
  "dialog.login.copied": "Скопировано",
  "session.header.zoom.out": "Уменьшить масштаб (Ctrl/Cmd -)",
  "session.header.zoom.in": "Увеличить масштаб (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Уменьшить масштаб",
  "session.header.zoom.in.ariaLabel": "Увеличить масштаб",
  "session.header.colorScheme.toLightMode": "Переключиться на светлый режим",
  "session.header.colorScheme.toDarkMode": "Переключиться на тёмный режим",
  "session.header.tab.terminal": "Терминал",
  "session.header.tab.review": "Обзор",
  "session.header.tab.files": "Файлы",
  "settings.general.row.downloadFolder.title": "Папка загрузок",
  "settings.general.row.downloadFolder.description": "Где сохраняются загруженные файлы",
  "settings.general.row.downloadFolder.change": "Изменить",
  ...
  "toast.update.downloading": "Загрузка обновления... {{pct}}%",
  "toast.update.downloadingSize": "Загрузка обновления... {{size}}",
  "toast.update.installing": "Установка обновления...",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (kodu.json)",
  ...
  "session.tab.artifacts": "Артефакты",
  "session.tab.canvas": "Canvas",
  "session.header.tab.canvas": "Canvas",
  "command.canvas.toggle": "Переключить Canvas",
  "canvas.empty": "Сгенерированные изображения, видео, аудио и 3D-объекты из этой сессии появятся здесь.",
  "canvas.density": "Макет",
  "canvas.density.cols": "{{count}} в ряду",
  "canvas.select": "Выбрать",
  "canvas.cancelSelection": "Отменить выбор",
  "canvas.clearSelection": "Очистить",
  "canvas.selected.count": "Выбрано: {{count}}",
  "canvas.downloadSelected": "Скачать",
  "canvas.downloadSelected.toast": "Загружено {{count}} файлов",
  "canvas.downloadSelected.toastDescription": "Сохранено в папку загрузок",
  "canvas.downloadSelected.partialFailed": "{{count}} загрузок не удалось",
  "canvas.hideSelected": "Скрыть",
  "canvas.hideSelected.toast": "Скрыто объектов: {{count}}",
  "canvas.hide.tooltip": "Скрыть с холста",
  "canvas.tab.session": "Сессия",
  "canvas.tab.library": "Библиотека",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "Здесь пока ничего нет",
  "canvas.library.empty.caption.filtered": "Ничего не найдено по текущим фильтрам.",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "Создайте или загрузите что-нибудь, чтобы наполнить библиотеку.",
  "canvas.library.search.placeholder": "Поиск по библиотеке…",
  "canvas.library.project.all": "Все проекты",
  "canvas.library.project.pick": "Выберите проект",
  "canvas.library.filter.type.all": "Все",
  "canvas.library.filter.type.images": "Изображения",
  "canvas.library.filter.type.videos": "Видео",
  "canvas.library.filter.type.audio": "Аудио",
  "canvas.library.filter.category.all": "Все",
  "canvas.library.filter.category.ai": "ИИ",
  "canvas.library.filter.category.uploaded": "Загруженные",
  "canvas.library.filter.category.favorites": "Избранное",
  "canvas.library.filter.category.trash": "Корзина",
  "canvas.library.folder.pick": "Папка",
  "canvas.library.folder.all": "Все папки",
  "canvas.library.folder.owned": "Мои папки",
  "canvas.library.folder.shared": "Доступные мне",
  "canvas.library.filter.category.edited": "Отредактировано",
  "canvas.library.filter.category.training-lab": "Лаборатория обучения",
  "canvas.library.favorite.add": "В избранное",
  "canvas.library.favorite.remove": "Убрать из избранного",
  "canvas.library.nsfw.hidden": "NSFW — нажмите, чтобы показать",
  "canvas.library.nsfw.reveal": "Показать",
  "canvas.library.error": "Не удалось загрузить библиотеку",
  "canvas.library.retry": "Повторить",
  "canvas.library.signedOut": "Войдите в Kolbo, чтобы просматривать свою библиотеку",
  "artifact.preview": "Предпросмотр",
  "artifact.code": "Код",
  "artifact.openInTab": "Открыть в новой вкладке",
  "artifact.publish": "Опубликовать",
  "artifact.publish.title": "Опубликовать артефакт",
  "artifact.publish.defaultTitle": "Артефакт Kolbo Code",
  "artifact.publish.loading": "Публикация…",
  "artifact.publish.urlLabel": "Публичная ссылка",
  "artifact.publish.copy": "Копировать",
  "artifact.publish.copied": "Скопировано",
  "artifact.publish.open": "Открыть в браузере",
  "session.panel.reviewAndFiles": "Обзор и файлы",
  "session.panel.close": "Закрыть панель",
  ...
  "session.review.noUncommittedChanges": "Нет незавершённых изменений",
  "session.review.noBranchChanges": "Нет изменений в ветке",
  ...
  "session.new.title": "Что создадим сегодня?",
  "session.new.subtitle": "От лендинга до изображений, видео или музыки — просто опишите идею.",
  ...
  "session.new.starter.landing.title": "Создать лендинг",
  "session.new.starter.landing.body": "Опишите продукт или идею — я спроектирую и подготовлю готовый лендинг.",
  "session.new.starter.landing.prompt": "Создай лендинг для приложения подписки на кофе под названием Brew — тёмный hero, тёплый оранжевый CTA, три карточки с функциями и блок с тарифами.",
  "session.new.starter.images.title": "Создать 4 изображения",
  "session.new.starter.images.body": "Расскажите концепцию — я создам 4 варианта, используя подходящую модель для выбранного стиля.",
  "session.new.starter.images.prompt": "Используй инструмент Creative Director, чтобы сгенерировать 4 изображения, рассказывающих короткую историю об астронавте, который находит скрытый сад на Луне — сохрани одного и того же персонажа на всех 4 кадрах.",
  "session.new.starter.video.title": "Сделать короткое видео",
  "session.new.starter.video.body": "Опишите сцену — я сгенерирую её (Kling, Seedance, Sora) и доработаю движение.",
  "session.new.starter.video.prompt": "Сделай короткое видео с несколькими планами футуристического города в сумерках с помощью Seedance 2 — широкий установочный план, затем панорама на уровне улицы, затем крупный план на неоновых вывесках.",
  "session.new.starter.music.title": "Написать музыку или озвучку",
  "session.new.starter.music.body": "Опишите атмосферу или сценарий — я создам аудио с помощью Suno или ElevenLabs.",
  "session.new.starter.music.prompt": "Сочини lofi-трек с мягким пианино и спокойными битами — расслабленная атмосфера для учёбы.",
  "session.new.starter.ugc.title": "Создать UGC-рекламу",
  "session.new.starter.ugc.body": "Дайте мне продукт — и я создам UGC-ролик с говорящей головой и постоянным персонажем.",
  "session.new.starter.ugc.prompt": "Создай 15-секундную UGC-рекламу сыворотки для лица: настоящий креатор держит продукт, съемка в стиле селфи, естественное освещение, короткий разговорный отзыв.",
  "session.new.starter.productAnimation.title": "Анимировать продукт",
  "session.new.starter.productAnimation.body": "Покажите продукт — и я оживлю его в движении.",
  "session.new.starter.productAnimation.prompt": "Анимируй этот продукт: медленное кинематографичное вращение кроссовка на 360 градусов на чистом студийном фоне с мягким скользящим светом.",
  "session.new.starter.productPhotoshoot.title": "Студийная фотосессия продукта",
  "session.new.starter.productPhotoshoot.body": "Студийное качество без студии — просто опишите, что нужно.",
  "session.new.starter.productPhotoshoot.prompt": "Сделай студийную фотосессию для стеклянного флакона духов: лайфстайл-снимок на мраморной поверхности с мягкими тенями, плюс предметное фото на чистом белом фоне.",
  "session.new.starter.aiInfluencer.title": "AI-инфлюенсер",
  "session.new.starter.aiInfluencer.body": "Создайте виртуального персонажа с постоянной внешностью для использования в разных сценах.",
  "session.new.starter.aiInfluencer.prompt": "Создай постоянного AI-инфлюенсера — технически подкованную девушку около 25-30 лет — и зафиксируй её внешность через Visual DNA, чтобы я мог использовать её в будущих постах и видео.",
  ...
  "common.showArchivedSessions": "Показать архивные сессии",
  "common.hideArchivedSessions": "Скрыть архивные сессии",
  ...
  "settings.general.row.showSessionProgressBar.title": "Показывать индикатор выполнения сессии",
  "settings.general.row.showSessionProgressBar.description": "Отображать анимированный индикатор выполнения в верхней части сессии во время работы агента",
  ...
  "sound.option.staplebops01": "Степлебопс 01",
  "sound.option.staplebops02": "Степлебопс 02",
  "sound.option.staplebops03": "Степлебопс 03",
  "sound.option.staplebops04": "Степлебопс 04",
  "sound.option.staplebops05": "Степлебопс 05",
  "sound.option.staplebops06": "Степлебопс 06",
  "sound.option.staplebops07": "Степлебопс 07",
  "sound.option.nope01": "Нет 01",
  "sound.option.nope02": "Нет 02",
  "sound.option.nope03": "Нет 03",
  "sound.option.nope04": "Нет 04",
  "sound.option.nope05": "Нет 05",
  "sound.option.nope06": "Нет 06",
  "sound.option.nope07": "Нет 07",
  "sound.option.nope08": "Нет 08",
  "sound.option.nope09": "Нет 09",
  "sound.option.nope10": "Нет 10",
  "sound.option.nope11": "Нет 11",
  "sound.option.nope12": "Нет 12",
  ...
  "settings.permissions.tool.todowrite.title": "Todo Запись",
  "settings.permissions.tool.todowrite.description": "Обновление списка задач",
  "settings.permissions.tool.webfetch.title": "Веб-запрос",
  ...
  "settings.permissions.tool.doom_loop.title": "Цикл Doom",
