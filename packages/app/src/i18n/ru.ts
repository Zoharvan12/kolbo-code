export const dict = {
  ...
  "error.page.authExpired.title": "Ваша сессия истекла",
  "error.page.authExpired.description": "Ваши учетные данные API недействительны или истек срок их действия. Перезапустите приложение, чтобы войти снова.",
  "error.page.authExpired.restart": "Перезапустить и войти",
  ...
  "sidebar.sessions.empty": "Сессий пока нет",
