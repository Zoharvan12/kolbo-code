export const dict = {
  ...
  "canvas.jumpToMessage": "Перейти к сообщению",
  ...
  "canvas.fit": "Подогнать",
  "canvas.fit.tooltip": "Показать изображение целиком без обрезки",
  "canvas.fill": "Заполнить",
  "canvas.fill.tooltip": "Заполнить ячейку, обрезая края при необходимости",
