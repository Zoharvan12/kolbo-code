...
export const dict = {
  ...
  "dialog.provider.kodu.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.kodu.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.koduGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Kodu",
  ...
  "provider.connect.apiKey.description": "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kodu",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.koduZen.line2": "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.koduZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix": " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kodu",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Kodu",
  ...
  "model.tag.cost.low": "ต้นทุนต่ำ",
  "model.tag.cost.medium": "ต้นทุนปานกลาง",
  "model.tag.cost.high": "ต้นทุนสูง",
  ...
  "model.tooltip.typicalCost.unit": "เครดิตต่อข้อความ",
  "model.tooltip.typicalCost.hint": "ข้อความทั่วไป การสนทนาที่ยาวขึ้นจะใช้มากกว่านี้",
  ...
  "session.child.promptDisabled": "ไม่สามารถเรียกใช้เซสชันย่อยได้",
  ...
  "prompt.action.uploading": "กำลังอัปโหลดไฟล์แนบ…",
  "prompt.action.dictate": "ป้อนตามคำบอก (เสียงเป็นข้อความ)",
  "prompt.action.dictateStop": "หยุดการป้อนตามคำบอก",
  "prompt.voice.listening": "กำลังฟัง…",
  "prompt.voice.error.notLoggedIn": "ลงชื่อเข้าใช้ Kolbo เพื่อใช้การป้อนข้อความด้วยเสียง",
  "prompt.voice.error.mic": "ไมโครโฟนไม่พร้อมใช้งาน — ตรวจสอบสิทธิ์ของระบบ",
  "prompt.voice.error.connection": "บริการเสียงไม่พร้อมใช้งาน — ลองอีกครั้ง",
  ...
  "prompt.toast.fileTooLarge.description": "ไฟล์มีเดียต้องมีขนาดไม่เกิน 200 MB.",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน kodu.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Kodu ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "context.stats.creditsBalance": "ยอดเครดิต",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": `ยินดีต้อนรับสู่ ${BRAND}`,
  "dialog.login.subtitle": "เข้าสู่ระบบด้วยบัญชี Kolbo.AI ของคุณเพื่อดำเนินการต่อ",
  "dialog.login.button.continue": "ดำเนินการต่อกับ Kolbo",
  "dialog.login.status.browserOpened": "เปิดเบราว์เซอร์ — ลงชื่อเข้าใช้ที่นั่น",
  "dialog.login.confirmationCode": "รหัสยืนยัน",
  "dialog.login.copy": "คัดลอก",
  "dialog.login.copied": "คัดลอกแล้ว",
  "session.header.zoom.out": "ซูมออก (Ctrl/Cmd -)",
  "session.header.zoom.in": "ซูมเข้า (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "ซูมออก",
  "session.header.zoom.in.ariaLabel": "ซูมเข้า",
  "session.header.colorScheme.toLightMode": "เปลี่ยนเป็นโหมดสว่าง",
  "session.header.colorScheme.toDarkMode": "เปลี่ยนเป็นโหมดมืด",
  "session.header.tab.terminal": "เทอร์มินัล",
  "session.header.tab.review": "ตรวจสอบ",
  "session.header.tab.files": "ไฟล์",
  "settings.general.row.downloadFolder.title": "โฟลเดอร์ดาวน์โหลด",
  "settings.general.row.downloadFolder.description": "ที่เก็บไฟล์ที่ดาวน์โหลด",
  "settings.general.row.downloadFolder.change": "เปลี่ยน",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Kodu ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Kodu",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (kodu.json) ชื่อผู้ให้บริการ/โมเดล",
  ...
  "session.review.noBranchChanges": "ยังไม่มีการเปลี่ยนแปลงสาขา",
  ...
  "sidebar.gettingStarted.line1": "Kodu รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Kodu ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Kodu",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Kodu มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Kodu ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Kodu มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Kodu เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Kodu เวอร์ชันล่าสุด",
  ...
  "sound.option.bipbop10": "บิป-บอป 10",
  "sound.option.staplebops01": "สเตปเลบอป 01",
  "sound.option.staplebops02": "สเตปเลบอป 02",
  "sound.option.staplebops03": "สเตปเลบอป 03",
  "sound.option.staplebops04": "สเตปเลบอป 04",
  "sound.option.staplebops05": "สเตปเลบอป 05",
  "sound.option.staplebops06": "สเตปเลบอป 06",
  "sound.option.staplebops07": "สเตปเลบอป 07",
  "sound.option.nope01": "ไม่ใช่ 01",
  "sound.option.nope02": "ไม่ใช่ 02",
  "sound.option.nope03": "ไม่ใช่ 03",
  "sound.option.nope04": "ไม่ใช่ 04",
  "sound.option.nope05": "ไม่ใช่ 05",
  "sound.option.nope06": "ไม่ใช่ 06",
  "sound.option.nope07": "ไม่ใช่ 07",
  "sound.option.nope08": "ไม่ใช่ 08",
  "sound.option.nope09": "ไม่ใช่ 09",
  "sound.option.nope10": "ไม่ใช่ 10",
  "sound.option.nope11": "ไม่ใช่ 11",
  "sound.option.nope12": "ไม่ใช่ 12",
  "sound.option.yup01": "ใช่ 01",
  "sound.option.yup02": "ใช่ 02",
  "sound.option.yup03": "ใช่ 03",
  "sound.option.yup04": "ใช่ 04",
  "sound.option.yup05": "ใช่ 05",
  "sound.option.yup06": "ใช่ 06",
  ...
  "session.working.for": "กำลังทำงานมา {{time}}",
  "session.new.starter.ugc.title": "สร้างโฆษณา UGC",
  "session.new.starter.ugc.body": "แค่บอกชื่อสินค้ามา เดี๋ยวฉันจะสร้างโฆษณา UGC แบบพูดหน้ากล้องให้ โดยใช้ครีเอเตอร์ที่มีคาแรคเตอร์สม่ำเสมอ",
  "session.new.starter.ugc.prompt": "สร้างโฆษณา UGC แบบพูดหน้ากล้องความยาว 15 วินาทีสำหรับเซรั่มบำรุงผิว โดยให้ครีเอเตอร์ที่ดูเป็นธรรมชาติถือสินค้า ถ่ายมุมเซลฟี่แบบสบายๆ แสงธรรมชาติ พร้อมบทรีวิวสั้นๆ",
  "session.new.starter.productAnimation.title": "ทำแอนิเมชันสินค้า",
  "session.new.starter.productAnimation.body": "ให้ฉันเห็นสินค้าของคุณ แล้วฉันจะทำให้มันเคลื่อนไหวได้อย่างมีชีวิตชีวา",
  "session.new.starter.productAnimation.prompt": "สร้างแอนิเมชันเคลื่อนไหวให้สินค้าชิ้นนี้ โดยให้หมุน 360 องศาแบบ cinematic ช้าๆ บนพื้นหลังสตูดิโอคลีนๆ พร้อมแสงที่เคลื่อนไหวอย่างนุ่มนวล",
  "session.new.starter.productPhotoshoot.title": "ถ่ายภาพสินค้า",
  "session.new.starter.productPhotoshoot.body": "ภาพถ่ายสินค้าคุณภาพระดับสตูดิโอโดยไม่ต้องง้อสตูดิโอ แค่บอกลักษณะที่ต้องการ",
  "session.new.starter.productPhotoshoot.prompt": "สร้างภาพถ่ายสตูดิโอสำหรับขวดน้ำหอมแก้ว โดยขอภาพไลฟ์สไตล์สวยๆ บนพื้นหินอ่อนพร้อมเงาละมุน และภาพสินค้าพื้นหลังสีขาวสะอาดตา",
  "session.new.starter.aiInfluencer.title": "AI influencer",
  "session.new.starter.aiInfluencer.body": "สร้างตัวตนเสมือนที่มีคาแรคเตอร์คงที่เพื่อนำไปใช้ในภาพต่างๆ ได้ไม่จำกัด",
  "session.new.starter.aiInfluencer.prompt": "สร้าง AI influencer ที่มีคาแรคเตอร์ชัดเจน เป็นผู้หญิงวัยทำงานที่ดูทันสมัยในวัย 20 ปลายๆ แล้วบันทึกตัวตนของเธอด้วย Visual DNA เพื่อที่ฉันจะได้นำไปใช้ในโพสต์และวิดีโออื่นๆ ต่อไป",
}
