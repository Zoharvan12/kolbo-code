...
export const dict = {
  ...
  "dialog.provider.kodu.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.kodu.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.koduGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Kodu tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description": "{{provider}} hesabınızı bağlamak ve Kodu'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  "provider.connect.koduZen.line2": "Tek bir API anahtarıyla Claude, GPT, Gemini, GLM ve daha fazlası gibi modellere erişebilirsiniz.",
  "provider.connect.koduZen.visit.prefix": "",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve Kodu'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix": " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Kodu'da {{provider}} modellerini kullanın.",
  ...
  "model.tag.cost.low": "Düşük maliyet",
  "model.tag.cost.medium": "Orta maliyet",
  "model.tag.cost.high": "Yüksek maliyet",
  ...
  "model.tooltip.typicalCost.unit": "kredi/mesaj",
  "model.tooltip.typicalCost.hint": "Tipik bir mesaj. Daha uzun sohbetler daha fazla harcar.",
  ...
  "session.child.promptDisabled": "Alt ajan oturumları yönlendirilemez.",
  ...
  "prompt.action.uploading": "Ekler yükleniyor…",
  "prompt.action.dictate": "Dikte (sesten metne)",
  "prompt.action.dictateStop": "Dikteyi durdur",
  "prompt.voice.listening": "Dinleniyor…",
  "prompt.voice.error.notLoggedIn": "Sesli dikteyi kullanmak için Kolbo'da oturum açın",
  "prompt.voice.error.mic": "Mikrofon kullanılamıyor — sistem izinlerini kontrol edin",
  "prompt.voice.error.connection": "Ses hizmeti kullanılamıyor — tekrar deneyin",
  ...
  "prompt.toast.fileTooLarge.title": "Dosya çok büyük",
  "prompt.toast.fileTooLarge.description": "Medya dosyaları 200 MB’ın altında olmalıdır.",
  ...
  "dialog.plugins.empty": "Eklentiler kodu.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Kodu sunucusuna bağlanacağını değiştirin.",
  ...
  "context.stats.creditsBalance": "Kredi Bakiyesi",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": `${BRAND}'a Hoş Geldiniz`,
  "dialog.login.subtitle": "Devam etmek için Kolbo.AI hesabınızla giriş yapın",
  "dialog.login.button.continue": "Kolbo ile devam et",
  "dialog.login.status.browserOpened": "Tarayıcı açıldı — orada giriş yapın",
  "dialog.login.confirmationCode": "Onay kodu",
  "dialog.login.copy": "Kopyala",
  "dialog.login.copied": "Kopyalandı",
  "session.header.zoom.out": "Uzaklaştır (Ctrl/Cmd -)",
  "session.header.zoom.in": "Yakınlaştır (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "Uzaklaştır",
  "session.header.zoom.in.ariaLabel": "Yakınlaştır",
  "session.header.colorScheme.toLightMode": "Açık moda geç",
  "session.header.colorScheme.toDarkMode": "Koyu moda geç",
  "session.header.tab.terminal": "Terminal",
  "session.header.tab.review": "Gözden Geçir",
  "session.header.tab.files": "Dosyalar",
  "settings.general.row.downloadFolder.title": "İndirme klasörü",
  "settings.general.row.downloadFolder.description": "İndirilen dosyaların kaydedildiği yer",
  "settings.general.row.downloadFolder.change": "Değiştir",
  ...
  "toast.update.description": "Kodu'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Kodu ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (kodu.json) sağlayıcı/model adlarını kontrol edin",
  ...
  "sidebar.gettingStarted.line1": "Kodu ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Kodu Masaüstü",
  ...
  "settings.desktop.wsl.description": "Kodu sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Kodu'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Kodu'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description": "Kodu'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Kodu'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Kodu başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Kodu'un en son sürümünü kullanıyorsunuz.",
  ...
  "session.working.for": "{{time}} süredir çalışılıyor",
  "session.new.starter.ugc.title": "UGC reklamı oluştur",
  "session.new.starter.ugc.body": "Ürünü bana ver — tutarlı bir içerik üreticisiyle konuşan kafa (talking-head) formatında bir UGC reklamı hazırlayayım.",
  "session.new.starter.ugc.prompt": "Bir cilt bakım serumu için 15 saniyelik konuşan kafa (talking-head) UGC reklamı oluştur; ürün elinde olan doğal bir içerik üreticisi, günlük selfie çekim açısı, doğal ışık ve kısa, samimi bir yorum ile.",
  "session.new.starter.productAnimation.title": "Ürünü canlandır",
  "session.new.starter.productAnimation.body": "Ürünü bana göster — hareket katarak onu canlandırayım.",
  "session.new.starter.productAnimation.prompt": "Bu ürünü hareketli bir şekilde canlandır; temiz bir stüdyo arka planında, yumuşak hareketli ışıklar eşliğinde spor ayakkabının 360 derecelik yavaş ve sinematik bir dönüşü olsun.",
  "session.new.starter.productPhotoshoot.title": "Ürün fotoğraf çekimi",
  "session.new.starter.productPhotoshoot.body": "Stüdyo gerekmeden stüdyo kalitesinde ürün fotoğrafları — istediğin görünümü tarif et.",
  "session.new.starter.productPhotoshoot.prompt": "Cam bir parfüm şişesi için stüdyo ürün çekimi oluştur; mermer üzerinde yumuşak gölgeli, lifestyle odaklı bir ana görsel ve ayrıca temiz, beyaz arka planlı bir ürün fotoğrafı olsun.",
  "session.new.starter.aiInfluencer.title": "AI influencer",
  "session.new.starter.aiInfluencer.body": "Çekimler boyunca tekrar kullanabileceğin tutarlı bir sanal kişilik yarat.",
  "session.new.starter.aiInfluencer.prompt": "Tutarlı bir AI influencer oluştur; 20'li yaşlarının sonlarında teknolojiyle arası iyi bir kadın karakter olsun ve Visual DNA ile kimliğini sabitle ki gelecekteki gönderilerimde ve videolarımda tekrar kullanabileyim.",
}
