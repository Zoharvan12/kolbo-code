export const dict = {
  ...
  "dialog.provider.kodu.note": "使用 Kodu Zen 或 API 密钥连接",
  "dialog.provider.kodu.tagline": "可靠的优化模型",
  "dialog.provider.koduGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.sort.label": "排序",
  "dialog.model.sort.name": "名称",
  "dialog.model.sort.price": "价格",
  ...
  "provider.connect.apiKey.description": "输入你的 {{provider}} API 密钥以连接帐户，并在 Kodu 中使用 {{provider}} 模型。",
  ...
  "provider.connect.koduZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.koduZen.visit.prefix": "访问 ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Kodu 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Kodu 中使用 {{provider}} 模型。",
  ...
  "provider.custom.headers.value.placeholder": "值",
  ...
  "model.tag.free": "免费",
  "model.tag.latest": "最新",
  "model.tag.cost.low": "低消耗",
  "model.tag.cost.medium": "中消耗",
  "model.tag.cost.high": "高消耗",
  "model.tag.default": "默认",
  ...
  "model.tooltip.pricing": "价格：{{value}}",
  "model.tooltip.typicalCost.unit": "积分/条消息",
  "model.tooltip.typicalCost.hint": "以典型消息为准，对话越长消耗越多。",
  ...
  "prompt.mode.normal": "提示",
  "prompt.approval.label": "审批模式",
  "prompt.approval.auto": "自动运行",
  "prompt.approval.ask": "先询问",
  "prompt.approval.auto.long": "自动运行无需询问",
  "prompt.approval.ask.long": "运行前确认",
  "prompt.mode.shell.exit": "按 esc 退出",
  "session.child.promptDisabled": "子代理会话无法被提示。",
  "session.child.backToParent": "返回主会话。",
  "session.working.for": "已工作 {{time}}",
  ...
  "prompt.dropzone.label": "将图片、视频、PDF 或文本文件拖放到此处",
  ...
  "prompt.action.uploading": "正在上传附件…",
  "prompt.action.dictate": "语音输入 (语音转文字)",
  "prompt.action.dictateStop": "停止语音输入",
  "prompt.voice.listening": "正在聆听…",
  "prompt.voice.error.notLoggedIn": "请登录 Kolbo 以使用语音输入功能",
  "prompt.voice.error.mic": "麦克风不可用 — 请检查系统权限",
  "prompt.voice.error.connection": "语音服务不可用 — 请重试",
  ...
  "prompt.toast.fileTooLarge.description": "媒体文件必须小于 200 MB。",
  ...
  "dialog.plugins.empty": "在 kodu.json 中配置的插件",
  ...
  "dialog.server.add.namePlaceholder": "本地主机",
  ...
  "context.stats.creditsBalance": "积分余额",
  ...
  "context.usage.credits": "积分",
  "context.usage.credits.image": "图像",
  "context.usage.credits.video": "视频",
  "context.usage.credits.audio": "音频",
  ...
  "language.he": "希伯来语",
  "language.hi": "印地语",
  "dialog.login.status.browserOpened": "浏览器已打开 — 在那里登录",
  "dialog.login.confirmationCode": "确认代码",
  "dialog.login.copy": "复制",
  "dialog.login.copied": "已复制",
  "session.header.zoom.out": "缩小 (Ctrl/Cmd -)",
  "session.header.zoom.in": "放大 (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "缩小",
  "session.header.zoom.in.ariaLabel": "放大",
  "session.header.colorScheme.toLightMode": "切换到亮色模式",
  "session.header.colorScheme.toDarkMode": "切换到暗色模式",
  "session.header.tab.terminal": "终端",
  "session.header.tab.review": "审查",
  "session.header.tab.files": "文件",
  "settings.general.row.downloadFolder.title": "下载文件夹",
  "settings.general.row.downloadFolder.description": "下载的文件保存位置",
  "settings.general.row.downloadFolder.change": "更改",
  ...
  "error.chain.checkConfig": "请检查你的配置 (kodu.json) 中的 provider/model 名称",
  ...
  "session.tab.artifacts": "制品",
  "session.tab.canvas": "画布",
  "session.header.tab.canvas": "画布",
  "command.canvas.toggle": "切换画布",
  "canvas.empty": "此会话中生成的图像、视频、音频和 3D 资源将显示在此处。",
  "canvas.density": "布局",
  "canvas.density.cols": "每行 {{count}} 个",
  "canvas.select": "选择",
  "canvas.cancelSelection": "取消选择",
  "canvas.clearSelection": "清除",
  "canvas.selected.count": "已选择 {{count}} 项",
  "canvas.downloadSelected": "下载",
  "canvas.downloadSelected.toast": "已下载 {{count}} 个文件",
  "canvas.downloadSelected.toastDescription": "已保存到您的下载文件夹",
  "canvas.downloadSelected.partialFailed": "{{count}} 个下载失败",
  "canvas.hideSelected": "隐藏",
  "canvas.hideSelected.toast": "已从画布隐藏 {{count}} 个项目",
  "canvas.hide.tooltip": "从画布隐藏",
  "canvas.tab.session": "会话",
  "canvas.tab.library": "库",
  "canvas.library.scope.all": "All media",
  "canvas.library.scope.session": "This session",
  "canvas.library.empty.title": "暂无媒体",
  "canvas.library.empty.caption.filtered": "没有匹配当前筛选条件的内容。",
  "canvas.library.empty.caption.session": "Nothing from this chat is in the library yet.",
  "canvas.library.empty.caption.default": "生成或上传内容以填充您的库。",
  "canvas.library.search.placeholder": "搜索库…",
  "canvas.library.project.all": "所有项目",
  "canvas.library.project.pick": "选择项目",
  "canvas.library.filter.type.all": "全部",
  "canvas.library.filter.type.images": "图像",
  "canvas.library.filter.type.videos": "视频",
  "canvas.library.filter.type.audio": "音频",
  "canvas.library.filter.category.all": "全部",
  "canvas.library.filter.category.ai": "AI",
  "canvas.library.filter.category.uploaded": "已上传",
  "canvas.library.filter.category.favorites": "收藏",
  "canvas.library.filter.category.trash": "回收站",
  "canvas.library.folder.pick": "文件夹",
  "canvas.library.folder.all": "全部文件夹",
  "canvas.library.folder.owned": "我的文件夹",
  "canvas.library.folder.shared": "分享给我的",
  "canvas.library.filter.category.edited": "已编辑",
  "canvas.library.filter.category.training-lab": "训练实验室",
  "canvas.library.favorite.add": "收藏",
  "canvas.library.favorite.remove": "取消收藏",
  "canvas.library.nsfw.hidden": "NSFW 内容 — 点击显示",
  "canvas.library.nsfw.reveal": "显示",
  "canvas.library.error": "加载库失败",
  "canvas.library.retry": "重试",
  "canvas.library.signedOut": "登录 Kolbo 以浏览您的库",
  "artifact.preview": "预览",
  "artifact.code": "代码",
  "artifact.openInTab": "在新标签页中打开",
  "artifact.publish": "发布",
  "artifact.publish.title": "发布产物",
  "artifact.publish.defaultTitle": "Kolbo Code 产物",
  "artifact.publish.loading": "发布中…",
  "artifact.publish.urlLabel": "公开链接",
  "artifact.publish.copy": "复制",
  "artifact.publish.copied": "已复制",
  "artifact.publish.open": "在浏览器中打开",
  "session.panel.reviewAndFiles": "审查和文件",
  "session.panel.close": "关闭面板",
  ...
  "session.followupDock.delete": "删除",
  ...
  "session.new.title": "今天我们要创作什么？",
  "session.new.subtitle": "从落地页到图像、视频或音乐 — 描述你的想法。",
  "session.new.worktree.main": "主分支",
  "session.new.worktree.mainWithBranch": "主分支（{{branch}}）",
  "session.new.worktree.create": "创建新的 worktree",
  "session.new.lastModified": "最后修改",
  "session.new.starter.landing.title": "构建落地页",
  "session.new.starter.landing.body": "描述产品或创意 — 我将为你设计并交付一个精美的页面。",
  "session.new.starter.landing.prompt": "为一款名为 Brew 的咖啡订阅应用构建一个落地页 — 深色主视觉、暖橙色 CTA、三张功能卡片和一个定价区块。",
  "session.new.starter.images.title": "生成 4 张图像",
  "session.new.starter.images.body": "告诉我构思 — 我将使用最适合该风格的模型创建 4 个变体。",
  "session.new.starter.images.prompt": "使用 Creative Director 工具生成 4 张图像，讲述一个宇航员在月球上发现隐秘花园的短故事——在所有 4 个画面中保持同一个角色的一致性。",
  "session.new.starter.video.title": "制作短视频",
  "session.new.starter.video.body": "描述镜头 — 我将生成它（Kling、Seedance、Sora）并根据动态进行迭代。",
  "session.new.starter.video.prompt": "使用 Seedance 2 制作一段短视频，包含多个黄昏时分未来都市的镜头 — 先是远景定场镜头，然后是街道层面的平移，最后是霓虹招牌的特写。",
  "session.new.starter.music.title": "创作音乐或配音",
  "session.new.starter.music.body": "描述氛围或脚本 — 我将使用 Suno 或 ElevenLabs 制作音频。",
  "session.new.starter.music.prompt": "创作一首 lofi 曲目，配上柔和的钢琴和轻柔的节奏 — 适合学习的放松氛围。",
  "session.new.starter.ugc.title": "制作 UGC 广告",
  "session.new.starter.ugc.body": "把产品交给我——我将通过固定的创作者形象制作一段口播类 UGC 广告。",
  "session.new.starter.ugc.prompt": "为一款护肤精华液制作一段 15 秒的 UGC 口播广告——画面呈现一位真实创作者手持产品，采用随性的自拍视角，光线自然，并包含简短的口播测评。",
  "session.new.starter.productAnimation.title": "产品动效制作",
  "session.new.starter.productAnimation.body": "把产品交给我——我将让它动起来，焕发活力。",
  "session.new.starter.productAnimation.prompt": "为这款产品制作动态展示——以干净的摄影棚为背景，对运动鞋进行缓慢的 360 度电影级旋转展示，并配合柔和的动态光效。",
  "session.new.starter.productPhotoshoot.title": "产品摄影大片",
  "session.new.starter.productPhotoshoot.body": "无需摄影棚也能获得影棚级产品照——告诉我你想要的风格。",
  "session.new.starter.productPhotoshoot.prompt": "为一款玻璃香水瓶拍摄影棚级产品照——呈现大理石台面上的生活方式主视觉图，带有柔和阴影，并附带一张纯白背景的产品精修图。",
  "session.new.starter.aiInfluencer.title": "AI 意见领袖 (Influencer)",
  "session.new.starter.aiInfluencer.body": "创建一个可重复用于各种场景的虚拟形象。",
  "session.new.starter.aiInfluencer.prompt": "创建一个稳定的 AI 意见领袖——一位精通科技的 20 多岁女性——并通过 Visual DNA 锁定她的身份特征，以便我在未来的帖子和视频中持续使用。",
  ...
  "lsp.label.connected": "{{count}} 个 LSP",
  ...
  "common.archived": "已归档",
  "common.restore": "恢复",
  "common.showArchivedSessions": "显示已归档会话",
  "common.hideArchivedSessions": "隐藏已归档会话",
  "common.delete": "删除",
  "common.close": "关闭",
  "common.edit": "编辑",
  ...
  "settings.general.row.showSessionProgressBar.description": "当智能体工作时，在会话顶部显示动画进度条",
