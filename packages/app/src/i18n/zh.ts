export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kodu 提供的免费模型",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "prompt.toast.fileTooLarge.description": "音频和视频文件必须小于 {{max}}。",
  ...
  "dialog.server.description": "切换此应用连接的 Kodu 服务器。",
  ...
  "language.he": "希伯来语",
  "language.hi": "印地语",
  "dialog.login.title": "欢迎来到 Kolbo Code",
  "dialog.login.subtitle": "使用您的 Kolbo.AI 账户登录以继续",
  "dialog.login.button.continue": "继续使用 Kolbo",
  ...
  "toast.update.description": "Kodu 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Kodu 团队",
  ...
  "sidebar.gettingStarted.line1": "Kodu 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Kodu 服务器。",
  ...
  "settings.general.row.language.description": "更改 Kodu 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Kodu 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Kodu 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Kodu 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Kodu 启动时自动检查更新",
