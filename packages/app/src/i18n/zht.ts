...
export const dict = {
  ...
  "dialog.provider.kodu.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.kodu.tagline": "可靠的優化模型",
  "dialog.provider.koduGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Kodu 提供的免費模型",
  ...
  "provider.connect.apiKey.description": "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Kodu 中使用 {{provider}} 模型。",
  ...
  "provider.connect.koduZen.line1": "Kodu Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.koduZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.koduZen.visit.prefix": "造訪 ",
  "provider.connect.koduZen.visit.link": "kodu.ai/zen",
  "provider.connect.koduZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Kodu 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Kodu 中使用 {{provider}} 模型。",
  ...
  "provider.custom.headers.key.placeholder": "標頭名稱",
  ...
  "model.tooltip.typicalCost.unit": "點數/則訊息",
  "model.tooltip.typicalCost.hint": "以一般訊息為準，對話越長消耗越多。",
  ...
  "session.child.promptDisabled": "子代理會話無法被提示。",
  ...
  "prompt.action.uploading": "正在上傳附件…",
  "prompt.action.dictate": "聽寫（語音轉文字）",
  "prompt.action.dictateStop": "停止聽寫",
  "prompt.voice.listening": "聆聽中…",
  "prompt.voice.error.notLoggedIn": "登入 Kolbo 以使用語音聽寫",
  "prompt.voice.error.mic": "麥克風無法使用 — 請檢查系統權限",
  "prompt.voice.error.connection": "語音服務無法使用 — 請再試一次",
  "prompt.toast.pasteUnsupported.title": "不支援的附件",
  "prompt.toast.pasteUnsupported.description": "此處僅能附加圖片、PDF 或文字檔案。",
  "prompt.toast.fileTooLarge.title": "檔案過大",
  "prompt.toast.fileTooLarge.description": "媒體檔案必須小於 200 MB。",
  ...
  "dialog.plugins.empty": "在 kodu.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Kodu 伺服器。",
  ...
  "dialog.server.add.namePlaceholder": "本地主機",
  ...
  "context.stats.creditsBalance": "餘額",
  ...
  "language.he": "עברית",
  "language.hi": "हिंदी",
  "dialog.login.title": `歡迎來到 ${BRAND}`,
  "dialog.login.subtitle": "使用您的 Kolbo.AI 帳戶登入以繼續",
  "dialog.login.button.continue": "繼續使用 Kolbo",
  "dialog.login.status.browserOpened": "瀏覽器已開啟 — 請在那裡登入",
  "dialog.login.confirmationCode": "確認碼",
  "dialog.login.copy": "複製",
  "dialog.login.copied": "已複製",
  "session.header.zoom.out": "縮小 (Ctrl/Cmd -)",
  "session.header.zoom.in": "放大 (Ctrl/Cmd +)",
  "session.header.zoom.out.ariaLabel": "縮小",
  "session.header.zoom.in.ariaLabel": "放大",
  "session.header.colorScheme.toLightMode": "切換到亮色模式",
  "session.header.colorScheme.toDarkMode": "切換到深色模式",
  "session.header.tab.terminal": "終端",
  "session.header.tab.review": "檢閱",
  "session.header.tab.files": "檔案",
  "settings.general.row.downloadFolder.title": "下載資料夾",
  "settings.general.row.downloadFolder.description": "下載的檔案儲存位置",
  ...
  "toast.update.description": "Kodu 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Kodu 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (kodu.json) 中的 provider/model 名稱",
  ...
  "sidebar.gettingStarted.line1": "Kodu 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Kodu 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Kodu 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Kodu 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Kodu 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Kodu 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Kodu 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Kodu。",
  "sound.option.none": "無",
  ...
  "settings.permissions.tool.doom_loop.title": "毀滅循環",
  ...
  "session.new.starter.ugc.title": "製作 UGC 廣告",
  "session.new.starter.ugc.body": "給我產品資訊，我將為您製作一支由固定創作者出鏡的 UGC 口播廣告。",
  "session.new.starter.ugc.prompt": "為一款護膚精華液製作 15 秒的 UGC 口播廣告——呈現真實的創作者手持產品、休閒自拍視角、自然光感，並配有簡短的使用心得分享。",
  "session.new.starter.productAnimation.title": "產品動畫製作",
  "session.new.starter.productAnimation.body": "展示您的產品，我將為您注入動態生命力。",
  "session.new.starter.productAnimation.prompt": "為此產品製作動態動畫——以純淨攝影棚為背景，將這雙運動鞋進行緩慢的 360 度電影感旋轉展示，並配合柔和的動態光影。",
  "session.new.starter.productPhotoshoot.title": "產品攝影棚拍攝",
  "session.new.starter.productPhotoshoot.body": "無需攝影棚，即可產出專業級產品照——請描述您想要的風格。",
  "session.new.starter.productPhotoshoot.prompt": "為玻璃香水瓶製作一組攝影棚級別的產品照——在大理石背景上拍攝生活感主視覺圖，需包含柔和陰影，以及一張純白背景的商品照。",
  "session.new.starter.aiInfluencer.title": "AI 網紅",
  "session.new.starter.aiInfluencer.body": "創建一個可在不同場景中重複使用的穩定虛擬人物形象。",
  "session.new.starter.aiInfluencer.prompt": "創建一位形象穩定的 AI 網紅——一位 20 多歲、精通科技的女性，並透過 Visual DNA 鎖定她的身份，以便我在未來的貼文和影片中重複使用她。",
}
