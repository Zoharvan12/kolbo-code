...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://kodu.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://kodu.ai/workspace/${authInfo.workspaceID}/members`
