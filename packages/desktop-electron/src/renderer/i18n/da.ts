export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Kodu",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Kodu er blevet downloadet. Vil du installere den og genstarte?",
