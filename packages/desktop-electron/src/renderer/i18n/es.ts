export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Kodu",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Kodu. ¿Quieres instalarla y reiniciar?",
