export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Kodu",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Kodu a été téléchargée. Voulez-vous l'installer et redémarrer ?",
