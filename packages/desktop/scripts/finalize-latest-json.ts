...
const releaseId = process.env.KODU_RELEASE
if (!releaseId) throw new Error("KODU_RELEASE is required")

const version = process.env.KODU_VERSION
if (!releaseId) throw new Error("KODU_VERSION is required")
