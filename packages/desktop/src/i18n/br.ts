export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentação do Kodu",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Kodu está ausente. Tente reinstalar o aplicativo de desktop.",
