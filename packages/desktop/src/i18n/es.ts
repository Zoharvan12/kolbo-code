export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentación de Kodu",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Kodu. Intenta reinstalar la aplicación de escritorio.",
