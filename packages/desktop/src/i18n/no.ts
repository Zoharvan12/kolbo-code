export const dict = {
  ...
  "desktop.menu.help.documentation": "Kodu Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Kodu CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
