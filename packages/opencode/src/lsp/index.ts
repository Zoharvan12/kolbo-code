...
export namespace LSP {
  ...
  const filterExperimentalServers = (servers: Record<string, LSPServer.Info>) => {
    if (Flag.KOLBO_EXPERIMENTAL_LSP_TY) {
      if (servers["pyright"]) {
        log.info("LSP server pyright is disabled because KOLBO_EXPERIMENTAL_LSP_TY is enabled")
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@kolbo/LSP") {}
