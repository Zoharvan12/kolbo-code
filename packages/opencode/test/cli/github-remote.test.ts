...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kodu.git")).toEqual({ owner: "sst", repo: "kodu" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/kodu")).toEqual({ owner: "sst", repo: "kodu" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kodu.git")).toEqual({ owner: "sst", repo: "kodu" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/kodu")).toEqual({ owner: "sst", repo: "kodu" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kodu.git")).toEqual({ owner: "sst", repo: "kodu" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/kodu")).toEqual({ owner: "sst", repo: "kodu" })
})
