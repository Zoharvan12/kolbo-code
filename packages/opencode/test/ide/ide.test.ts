...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders KODU_CALLER", () => {
    process.env["KODU_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode KODU_CALLER", () => {
    process.env["KODU_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown KODU_CALLER", () => {
    process.env["KODU_CALLER"] = "unknown"
