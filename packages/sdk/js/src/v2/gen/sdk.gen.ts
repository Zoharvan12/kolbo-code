...
import type {
  ...
  GlobalKolboArtifactPublishErrors,
  ...
  ProviderKolboMcpHealErrors,
  ProviderKolboMcpHealResponses,
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Kolbo configuration settings and preferences.
   */
   ...
   *
   * Update global Kolbo configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Kolbo server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Kolbo system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Kolbo instances, releasing all resources.
   */
   ...
   * Upgrade kolbo
   *
   * Upgrade kolbo to the specified version or latest if not specified.
   */
  ...
  /**
   * Get media credit spend for the current Kolbo Code app session
   *
   ...
   */
  public kolboSessionUsage<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalKolboSessionUsageResponses, unknown, ThrowOnError>({
      url: "/global/kolbo-session-usage",
      ...options,
    })
  }
   ...
   *
   * Fetch the authenticated user's Kolbo credit balance from kolbo-api.
   */
   ...
   */
  public kolboPricing<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalKolboPricingResponses, unknown, ThrowOnError>({
      url: "/global/kolbo-pricing",
      ...options,
    })
  }

  /**
   * Get Kolbo model pricing + avatar in one call
   *
   ...
   */
  public kolboModelMetadata<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalKolboModelMetadataResponses, unknown, ThrowOnError>({
      url: "/global/kolbo-model-metadata",
      ...options,
    })
  }

  /**
   * List Kolbo generation models for a generation type
   *
   ...
   */
  public kolboGenerationModels<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalKolboGenerationModelsResponses, unknown, ThrowOnError>({
      url: "/global/kolbo-generation-models",
      ...options,
    })
  }

  /**
   * Expose Kolbo API key + base URL to the TUI
   *
   ...
   */
  public kolboAuthContext<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalKolboAuthContextResponses, unknown, ThrowOnError>({
      url: "/global/kolbo-auth-context",
      ...options,
    })
  }

  /**
   * Proxy: upload a binary file to kolbo-api for multimodal chat
   *
   ...
   */
  public kolboFilesUpload<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<
      GlobalKolboFilesUploadResponses,
      GlobalKolboFilesUploadErrors,
      ThrowOnError
    >({ url: "/global/kolbo-files-upload", ...options })
  }

  /**
   * Proxy: read a local file by path and upload it to kolbo-api
   *
   ...
   */
  public kolboFilesUploadFromPath<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<
      GlobalKolboFilesUploadFromPathResponses,
      GlobalKolboFilesUploadFromPathErrors,
      ThrowOnError
    >({ url: "/global/kolbo-files-upload-from-path", ...options })
  }

  /**
   * Proxy: publish an HTML artifact to kolbo-api and get a shareable URL
   *
   ...
   */
  public kolboArtifactPublish<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<
      GlobalKolboArtifactPublishResponses,
      GlobalKolboArtifactPublishErrors,
      ThrowOnError
    >({ url: "/global/kolbo-artifact-publish", ...options })
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Kolbo system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Kolbo system.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Kolbo.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that Kolbo is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Kolbo.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Kolbo configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Kolbo configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Kolbo state.
   */
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Kolbo sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Kolbo session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Kolbo session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Artifact extends HeyApiClient {
   ...
   * Share HTML artifact
   *
   * Upload an HTML/SVG/Mermaid artifact to Kolbo and return a public URL.
   */
  public share<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<ArtifactShareResponses, ArtifactShareErrors, ThrowOnError>({
      url: "/artifact/share",
      ...options,
      ...params,
      headers: {
...
export class Mcp extends HeyApiClient {
  /**
   * Heal a stale Kolbo MCP credential
   *
   ...
   */
  public heal<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
    },
...
export class Kolbo extends HeyApiClient {
  private _mcp?: Mcp
  get mcp(): Mcp {
...
export class Provider extends HeyApiClient {
  ...
  private _kolbo?: Kolbo
  get kolbo(): Kolbo {
    return (this._kolbo ??= new Kolbo({ client: this.client }))
  }
}
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Kolbo instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Kolbo instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Kolbo system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
