export const dict = {
  ...
  "ui.message.expand": "عرض المزيد",
  "ui.message.collapse": "عرض أقل",
  "ui.message.copy": "نسخ",
  ...
  "ui.artifact.preview": "معاينة",
  "ui.kolbo.generatedImage": "صورة منشأة",
  ...
  "ui.kolbo.chip.ready": "أصبح {{label}} جاهزاً",
  "ui.kolbo.chip.readyCount": "أصبحت {{count}} {{label}} جاهزة",
  "ui.kolbo.chip.label.image": "صورة",
  "ui.kolbo.chip.label.images": "صور",
  "ui.kolbo.chip.label.video": "فيديو",
  "ui.kolbo.chip.label.videos": "فيديوهات",
  "ui.kolbo.chip.label.audio": "مقطع صوتي",
  "ui.kolbo.chip.label.music": "مقطوعة موسيقية",
  "ui.kolbo.chip.label.speech": "مقطع صوتي",
  "ui.kolbo.chip.label.sound": "مؤثر صوتي",
  "ui.kolbo.chip.label.model3d": "نموذج ثلاثي الأبعاد",
  "ui.kolbo.chip.label.asset": "أصل",
  "ui.kolbo.chip.label.assets": "أصول",
  ...
  "ui.download.saved": "تم الحفظ",
  "ui.download.downloaded": "تم التنزيل",
  "ui.download.downloading": "جارٍ التنزيل…",
  "ui.download.download": "تنزيل",
  "ui.download.failed": "فشل التنزيل",
  "ui.download.openInFolder": "فتح في المجلد",
  "ui.download.changeFolder": "تغيير المجلد",
  "ui.download.openingInBrowser": "جارٍ الفتح في المتصفح",
  "ui.permission.suggestChange.placeholder": "أو أخبر الوكيل بما يجب تغييره بدلاً من ذلك...",
  "ui.permission.sendChange": "إرسال التغيير",
  "ui.kolbo.chip.creditCost": "{{count}} رصيد",
}
