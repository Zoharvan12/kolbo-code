export const dict = {
  ...
  "ui.sessionTurn.error.authExpired": "انتهت صلاحية جلستك أو أن بيانات اعتماد API غير صالحة.",
  "ui.sessionTurn.error.signInAgain": "سجّل الدخول مجدداً →",
  ...
  "ui.kolbo.generatedImage": "صورة تم إنشاؤها",
