export const dict = {
  ...
  "ui.sessionTurn.error.authExpired": "Tu sesión ha caducado o las credenciales de la API no son válidas.",
  "ui.sessionTurn.error.signInAgain": "Inicia sesión de nuevo →",
