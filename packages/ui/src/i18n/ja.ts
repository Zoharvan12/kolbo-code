export const dict = {
  ...
  "ui.sessionReview.diffStyle.unified": "統合",
  ...
  "ui.sessionTurn.diffs.changed": "変更されました",
  ...
  "ui.list.emptyWithFilter.suffix": "に一致する項目が見つかりませんでした",
  ...
  "ui.message.expand": "もっと見る",
  "ui.message.collapse": "閉じる",
  "ui.message.copy": "コピー",
  ...
  "ui.artifact.preview": "プレビュー",
  "ui.kolbo.generatedImage": "生成された画像",
  "ui.kolbo.generatingImage": "画像を生成中…",
  "ui.kolbo.generatingVideo": "動画を生成中…",
  "ui.kolbo.generatingAudio": "音声を生成中…",
  "ui.kolbo.usedMedia": "メディア {{n}} 件",
  "ui.kolbo.chip.viewInCanvas": "キャンバスで表示",
  "ui.kolbo.chip.generating": "{{label}}を生成中…",
  "ui.kolbo.chip.generatingCount": "{{count}}個の{{label}}を生成中…",
  "ui.kolbo.chip.ready": "{{label}}の準備が完了しました",
  "ui.kolbo.chip.readyCount": "{{count}}個の{{label}}の準備が完了しました",
  "ui.kolbo.chip.label.image": "画像",
  "ui.kolbo.chip.label.images": "画像",
  "ui.kolbo.chip.label.video": "動画",
  "ui.kolbo.chip.label.videos": "動画",
  "ui.kolbo.chip.label.audio": "オーディオ",
  "ui.kolbo.chip.label.music": "音楽トラック",
  "ui.kolbo.chip.label.speech": "音声クリップ",
  "ui.kolbo.chip.label.sound": "効果音",
  "ui.kolbo.chip.label.model3d": "3Dモデル",
  "ui.kolbo.chip.label.asset": "アセット",
  "ui.kolbo.chip.label.assets": "アセット",
  ...
  "ui.download.saved": "保存されました",
  "ui.download.downloaded": "ダウンロードされました",
  "ui.download.downloading": "ダウンロード中…",
  "ui.download.download": "ダウンロード",
  "ui.download.failed": "ダウンロードに失敗しました",
  "ui.download.openInFolder": "フォルダーを開く",
  "ui.download.changeFolder": "フォルダーを変更",
  "ui.download.openingInBrowser": "ブラウザーで開いています",
  "ui.permission.suggestChange.placeholder": "またはエージェントに変更内容を指示する…",
  "ui.permission.sendChange": "変更を送信",
  "ui.kolbo.chip.creditCost": "{{count}} クレジット",
}
