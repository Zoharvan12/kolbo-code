export const dict = {
  ...
  "ui.sessionTurn.diffs.showLess": "덜 보기",
  "ui.sessionTurn.diffs.more": "+{{count}}개의 파일 더",
  ...
  "ui.list.emptyWithFilter.suffix": "필터 설정을 확인하거나 검색어를 변경해 보세요.",
  ...
  "ui.message.expand": "더 보기",
  "ui.message.collapse": "간단히 보기",
  "ui.message.copy": "복사",
  ...
  "ui.artifact.preview": "미리보기",
  "ui.kolbo.generatedImage": "생성된 이미지",
  "ui.kolbo.generatingImage": "이미지 생성 중…",
  "ui.kolbo.generatingVideo": "동영상 생성 중…",
  "ui.kolbo.generatingAudio": "오디오 생성 중…",
  "ui.kolbo.usedMedia": "미디어 {{n}}개",
  "ui.kolbo.chip.viewInCanvas": "캔버스에서 보기",
  "ui.kolbo.chip.generating": "{{label}} 생성 중…",
  "ui.kolbo.chip.generatingCount": "{{count}}개의 {{label}} 생성 중…",
  "ui.kolbo.chip.ready": "{{label}} 준비 완료",
  "ui.kolbo.chip.readyCount": "{{count}}개의 {{label}} 준비 완료",
  "ui.kolbo.chip.label.image": "이미지",
  "ui.kolbo.chip.label.images": "이미지",
  "ui.kolbo.chip.label.video": "비디오",
  "ui.kolbo.chip.label.videos": "비디오",
  "ui.kolbo.chip.label.audio": "오디오",
  "ui.kolbo.chip.label.music": "음악 트랙",
  "ui.kolbo.chip.label.speech": "음성 클립",
  "ui.kolbo.chip.label.sound": "효과음",
  "ui.kolbo.chip.label.model3d": "3D 모델",
  "ui.kolbo.chip.label.asset": "에셋",
  "ui.kolbo.chip.label.assets": "에셋",
  ...
  "ui.download.saved": "저장됨",
  "ui.download.downloaded": "다운로드됨",
  "ui.download.downloading": "다운로드 중…",
  "ui.download.download": "다운로드",
  "ui.download.failed": "다운로드 실패",
