export const dict = {
  ...
  "ui.lineComment.label.suffix": "(комментарий)",
  "ui.lineComment.editorLabel.prefix": "Комментирование: ",
  "ui.lineComment.editorLabel.suffix": "(редактор комментариев)",
  ...
  "ui.sessionTurn.diffs.more": "+{{count}} дополнительных файлов",
  ...
  "ui.list.emptyWithFilter.suffix": "по вашему запросу ничего не найдено",
  ...
  "ui.message.expand": "Показать больше",
  "ui.message.collapse": "Показать меньше",
  ...
  "ui.artifact.preview": "Предпросмотр",
  "ui.kolbo.generatedImage": "Сгенерированное изображение",
  "ui.kolbo.generatingImage": "Генерация изображения…",
  "ui.kolbo.generatingVideo": "Генерация видео…",
  "ui.kolbo.generatingAudio": "Генерация аудио…",
  "ui.kolbo.usedMedia": "{{n}} медиа",
  "ui.kolbo.chip.viewInCanvas": "Открыть в Canvas",
  "ui.kolbo.chip.generating": "Создание {{label}}…",
  "ui.kolbo.chip.generatingCount": "Создание {{count}} {{label}}…",
  "ui.kolbo.chip.ready": "{{label}} готово",
  "ui.kolbo.chip.readyCount": "{{count}} {{label}} готово",
  "ui.kolbo.chip.label.image": "изображения",
  "ui.kolbo.chip.label.images": "изображений",
  "ui.kolbo.chip.label.video": "видео",
  "ui.kolbo.chip.label.videos": "видео",
  "ui.kolbo.chip.label.audio": "аудио",
  "ui.kolbo.chip.label.music": "музыкального трека",
  "ui.kolbo.chip.label.speech": "голосового клипа",
  "ui.kolbo.chip.label.sound": "звукового эффекта",
  "ui.kolbo.chip.label.model3d": "3D-модели",
  "ui.kolbo.chip.label.asset": "ресурса",
  "ui.kolbo.chip.label.assets": "ресурсов",
  ...
  "ui.download.saved": "Сохранено",
  "ui.download.downloaded": "Загружено",
  "ui.download.downloading": "Загрузка…",
  "ui.download.download": "Скачать",
  "ui.download.failed": "Ошибка загрузки",
  "ui.download.openInFolder": "Открыть в папке",
  "ui.download.changeFolder": "Изменить папку",
  "ui.download.openingInBrowser": "Открытие в браузере",
  "ui.permission.suggestChange.placeholder": "Или подскажите агенту, что нужно изменить…",
  "ui.permission.sendChange": "Отправить изменения",
  "ui.kolbo.chip.creditCost": "{{count}} кр.",
}
