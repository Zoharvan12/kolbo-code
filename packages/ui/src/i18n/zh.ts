export const dict = {
  ...
  "ui.message.expand": "显示更多",
  "ui.message.collapse": "显示更少",
  "ui.message.copy": "复制",
  ...
  "ui.artifact.preview": "预览",
  "ui.kolbo.generatedImage": "已生成图片",
  "ui.kolbo.generatingImage": "正在生成图片…",
  "ui.kolbo.generatingVideo": "正在生成视频…",
  "ui.kolbo.generatingAudio": "正在生成音频…",
  "ui.kolbo.usedMedia": "{n} 个媒体",
  "ui.kolbo.chip.viewInCanvas": "在画布中查看",
  "ui.kolbo.chip.generating": "正在生成 {{label}}…",
  "ui.kolbo.chip.generatingCount": "正在生成 {{count}} 个 {{label}}…",
  "ui.kolbo.chip.ready": "{{label}} 已就绪",
  "ui.kolbo.chip.readyCount": "{{count}} 个 {{label}} 已就绪",
  "ui.kolbo.chip.label.image": "图像",
  "ui.kolbo.chip.label.images": "图像",
  "ui.kolbo.chip.label.video": "视频",
  "ui.kolbo.chip.label.videos": "视频",
  "ui.kolbo.chip.label.audio": "音频",
  "ui.kolbo.chip.label.music": "音乐轨道",
  "ui.kolbo.chip.label.speech": "语音片段",
  "ui.kolbo.chip.label.sound": "音效",
  "ui.kolbo.chip.label.model3d": "3D 模型",
  "ui.kolbo.chip.label.asset": "资源",
  "ui.kolbo.chip.label.assets": "资源",
  ...
  "ui.download.saved": "已保存",
  "ui.download.downloaded": "已下载",
  "ui.download.downloading": "正在下载…",
  "ui.download.download": "下载",
  "ui.download.failed": "下载失败",
