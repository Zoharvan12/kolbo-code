export const dict = {
  ...
  "ui.sessionTurn.error.insufficientCredits": "您的 Kolbo 點數已用完。請添加點數或升級計劃以繼續。",
  ...
  "ui.message.expand": "顯示更多",
  "ui.message.collapse": "顯示較少",
  "ui.message.copy": "複製",
  ...
  "ui.download.saved": "已儲存",
  "ui.download.downloaded": "已下載",
  "ui.download.downloading": "下載中…",
  "ui.download.download": "下載",
  "ui.download.failed": "下載失敗",
  ...
  "ui.permission.suggestChange.placeholder": "或者告訴代理程式該如何修改…",
  "ui.permission.sendChange": "發送修改",
  "ui.kolbo.chip.creditCost": "{{count}} 點數",
}
