...
يوجد نوعان من الوكلاء في Kodu: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Kodu مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Kodu مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Kodu مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `kodu.json`:
...
- عام: `~/.config/kodu/agents/`
- لكل مشروع: `.kodu/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Kodu القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Kodu العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Kodu الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Kodu Zen](/docs/zen)، فستستخدم `kodu/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `kodu models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/kodu).
:::
