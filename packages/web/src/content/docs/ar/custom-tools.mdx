...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في kodu.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في kodu مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.kodu/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/kodu/tools/`.
