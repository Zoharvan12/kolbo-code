---
title: خوادم LSP
description: يتكامل Kodu مع خوادم LSP لديك.
---

يتكامل Kodu مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Kodu مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `KODU_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات kodu.
