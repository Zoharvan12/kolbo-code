---
title: TUI
description: استخدام واجهة المستخدم TUI في Kodu.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Kodu واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Kodu إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Kodu في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Kodu. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Kodu. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Kodu.
...
استخدم `KODU_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
