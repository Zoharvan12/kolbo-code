...
Prilagođene komande su dodatak ugrađenim komandama kao što su `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Saznajte više](/docs/tui#commands).
...
Možete dodati prilagođene komande kroz Kodu konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Kodu [config](/docs/config):
...
- Globalno: `~/.config/kodu/commands/`
- Po projektu: `.kodu/commands/`
...
Kodu uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
