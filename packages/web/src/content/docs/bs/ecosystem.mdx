---
title: Ekosistem
description: Projekti i integracije izgrađeni uz Kodu.
---

Kolekcija projekata zajednice izgrađenih na Kodu.

:::note
Želite li na ovu listu dodati svoj Kodu projekat? Pošaljite PR.
:::

Također možete pogledati [awesome-kodu](https://github.com/awesome-kodu/awesome-kodu) i [kodu.cafe](https://kodu.cafe), zajednicu koja spaja ekosistem i zajednicu.
...
| Ime                                                                                                | Opis                                                                                                          |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatski pokrenite Kodu sesije u izoliranim Daytona sandboxovima uz git sinhronizaciju i preglede uživo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Pratite upotrebu Kodu sa Wakatime                                                                         |
...
| [oh-my-kodu](https://github.com/code-yeongyu/oh-my-kodu)                                   | Pozadinski agenti, unapred izgrađeni LSP/AST/MCP alati, kurirani agenti, kompatibilni sa Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Obavještenja na radnoj površini i zvučna upozorenja za Kodu sesije                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatsko imenovanje Zellij sesije na bazi Kodu konteksta                                                |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Dozvolite Kodu agentima da lijeno učitavaju upite na zahtjev uz otkrivanje vještina i ubrizgavanje        |
...
| [@plannotator/kodu](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktivni pregled plana s vizualnim napomenama i privatnim/offline dijeljenjem                             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Proširite kodu /komande u moćan sistem orkestracije sa granularnom kontrolom toka                         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifikacije izvornog OS-a za Kodu – znajte kada se zadaci dovrše                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git radna stabla bez trenja za Kodu                                                                       |
...
| Ime                                                                                        | Opis                                                                  |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot za kontrolu Kodu sesija, izgrađen na SDK              |
| [kodu.nvim](https://github.com/NickvanDyke/kodu.nvim)                              | Neovim dodatak za upite svjestan uređivača, izgrađen na API           |
| [portal](https://github.com/hosenur/portal)                                                | Mobilni korisnički interfejs za Kodu preko Tailscale/VPN          |
| [kodu plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Predložak za izgradnju Kodu dodataka                              |
| [kodu.nvim](https://github.com/sudo-tee/kodu.nvim)                                 | Neovim frontend za kodu - terminal baziran AI agent za kodiranje  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK dobavljač za korištenje Kodu putem @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App i VS Code Extension za Kodu                     |
| [Kodu-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian dodatak koji ugrađuje Kodu u Obsidian-ov UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa otvorenog koda Claudeu Coworku, pokretana pomoću Kodu |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Kodu menadžer ekstenzija sa prenosivim, izolovanim profilima.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile i Remote Client aplikacija za Kodu           |
