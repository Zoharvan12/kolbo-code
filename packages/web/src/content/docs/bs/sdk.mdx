---
title: SDK
description: Type-safe JS klijent za kodu server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

kodu JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `kodu.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu kodu instancu, mozete napraviti klijentsku instancu i povezati se na nju:
