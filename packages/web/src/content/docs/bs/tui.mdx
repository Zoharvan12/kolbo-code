---
title: TUI
description: Korištenje korisničkog interfejsa Kodu terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kodu pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Kodu pokreće TUI za trenutni direktorij.
...
Kada koristite Kodu TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Kodu. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Kodu. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `kodu.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `KODU_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
