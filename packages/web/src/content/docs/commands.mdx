...
Custom commands are in addition to the built-in commands like `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Learn more](/docs/tui#commands).
...
You can add custom commands through the Kodu config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Kodu [config](/docs/config):
...
kodu includes several built-in commands like `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [learn more](/docs/tui#commands).
