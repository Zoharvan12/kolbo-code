...
Brugerdefinerede kommandoer er ud over de indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Learn more](/docs/tui#commands).
...
Du kan tilføje brugerdefinerede kommandoer gennem Kodu-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Kodu [config](/docs/config):
...
kodu indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [learn more](/docs/tui#commands).
