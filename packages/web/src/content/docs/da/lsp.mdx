---
title: LSP-servere
description: Kodu integreres med dine LSP-servere.
---

Kodu integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Kodu leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `KODU_DISABLE_LSP_DOWNLOAD` til `true`.
:::
