...
Agentferdigheter lar Kodu oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Kodu opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Kodu viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `kodu.json`:
