---
title: TUI
description: Brug af Kodu-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kodu giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Kodu starter TUI for den nuværende mappe.
...
Når du bruger Kodu TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Kodu. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `kodu.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `KODU_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
