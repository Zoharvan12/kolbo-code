...
Benutzerdefinierte Befehle gibt es zusätzlich zu den integrierten Befehlen wie `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Mehr erfahren](/docs/tui#commands).
...
Erstellen Sie `.kodu/commands/test.md`:

```md title=".kodu/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Kodu-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Kodu [config](/docs/config):

```json title="kodu.jsonc" {4-12}
{
...
- Global: `~/.config/kodu/commands/`
- Pro Projekt: `.kodu/commands/`

```markdown title="~/.config/kodu/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".kodu/commands/component.md"
---
...
```md title=".kodu/commands/create-file.md"
---
...
```md title=".kodu/commands/analyze-coverage.md"
---
...
```md title=".kodu/commands/review-changes.md"
---
...
```md title=".kodu/commands/review-component.md"
---
...
Kodu enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
