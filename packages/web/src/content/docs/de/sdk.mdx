...
Das kodu JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und kodu programmatisch steuern.
...
`kodu.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn kodu bereits laeuft, kannst du nur einen Client erstellen und verbinden:
