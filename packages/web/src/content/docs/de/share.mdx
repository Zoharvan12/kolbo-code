---
title: Teilen
description: Teile Kodu-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Kodu-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Kodu Folgendes:
...
Kodu hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Kodu den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`kodu.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du kodu in deiner Organisation einsetzt.
