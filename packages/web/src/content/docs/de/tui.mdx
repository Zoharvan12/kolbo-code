---
title: TUI
description: Arbeite mit Kodu in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kodu bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Kodu die TUI im aktuellen Verzeichnis.
...
In der Kodu-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Kodu hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Dies ist getrennt von `kodu.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `KODU_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
