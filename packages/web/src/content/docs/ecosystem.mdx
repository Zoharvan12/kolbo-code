---
title: Ecosystem
description: Projects and integrations built with Kodu.
---

A collection of community projects built on Kodu.

:::note
Want to add your Kodu related project to this list? Submit a PR.
:::

You can also check out [awesome-kodu](https://github.com/awesome-kodu/awesome-kodu) and [kodu.cafe](https://kodu.cafe), a community that aggregates the ecosystem and community.
...
| Name                                                                                               | Description                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Kodu sessions in isolated Daytona sandboxes with git sync and live previews |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Kodu usage with Wakatime                                                                |
...
| [oh-my-kodu](https://github.com/code-yeongyu/oh-my-kodu)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible            |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Kodu sessions                                      |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Kodu context                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Kodu agents to lazy load prompts on demand with skill discovery and injection           |
...
| [@plannotator/kodu](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interactive plan review with visual annotation and private/offline sharing                        |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend kodu /commands into a powerful orchestration system with granular flow control         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Kodu – know when tasks complete                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Kodu                                                          |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Kodu sessions, built on the SDK       |
| [kodu.nvim](https://github.com/NickvanDyke/kodu.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Kodu over Tailscale/VPN              |
| [kodu plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Kodu plugins                           |
| [kodu.nvim](https://github.com/sudo-tee/kodu.nvim)                                 | Neovim frontend for kodu - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Kodu via @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Kodu             |
| [Kodu-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Kodu in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Kodu |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Kodu extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Kodu          |
