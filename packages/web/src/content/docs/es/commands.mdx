...
Los comandos personalizados se suman a los comandos integrados como `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Más información](/docs/tui#commands).
...
Puede agregar comandos personalizados a través de la configuración Kodu o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Kodu [config](/docs/config):
...
kodu incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [más información](/docs/tui#commands).
