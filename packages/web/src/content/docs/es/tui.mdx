---
title: TUI
description: Usando la interfaz de usuario del terminal Kodu.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kodu proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Kodu se inicia TUI para el directorio actual.
...
Cuando utilice Kodu TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Kodu. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `kodu.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `KODU_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
