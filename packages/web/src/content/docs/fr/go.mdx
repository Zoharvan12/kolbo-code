...
Kodu Go est un abonnement à bas coût — **5 $ pour votre premier mois**, puis **10 $/mois** — qui vous donne un accès fiable aux modèles de codage ouverts populaires.

:::note
Kodu Go est actuellement en version bêta.
:::

Go fonctionne comme n'importe quel autre fournisseur dans Kodu. Vous vous abonnez à Kodu Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Kodu.
...
Kodu Go vous donne accès à ces modèles pour **5 $ pour votre premier mois**, puis **10 $/mois**.

---

## Comment ça marche

Kodu Go fonctionne comme n'importe quel autre fournisseur dans Kodu.

1. Vous vous connectez à **<a href={console}>Kodu Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `Kodu Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à Kodu Go.
:::
...
Kodu Go inclut les limites suivantes :
...
| ------------ | ------------ | ------------------------------------------------ | --------------------------- |
| GLM-5.1      | glm-5.1      | `https://kodu.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5        | glm-5        | `https://kodu.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5    | kimi-k2.5    | `https://kodu.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Pro  | mimo-v2-pro  | `https://kodu.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Omni | mimo-v2-omni | `https://kodu.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M2.7 | minimax-m2.7 | `https://kodu.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5 | minimax-m2.5 | `https://kodu.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |

L'[ID de modèle](/docs/config/#models) dans votre configuration Kodu utilise le format `opencode-go/<model-id>`. Par exemple, pour Kimi K2.5, vous utiliseriez `opencode-go/kimi-k2.5` dans votre configuration.
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec Kodu également.
