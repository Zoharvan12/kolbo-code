...
I comandi personalizzati si aggiungono a quelli integrati come `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Scopri di piu](/docs/tui#commands).
...
Puoi aggiungere comandi personalizzati tramite la config di Kodu o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Kodu:
...
- Globale: `~/.config/kodu/commands/`
- Per progetto: `.kodu/commands/`
...
kodu include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
