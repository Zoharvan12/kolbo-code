---
title: Ecosistema
description: Progetti e integrazioni costruiti con Kodu.
---

Una raccolta di progetti della comunità costruiti su Kodu.

:::note
Vuoi aggiungere il tuo progetto legato a Kodu a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-kodu](https://github.com/awesome-kodu/awesome-kodu) e [kodu.cafe](https://kodu.cafe), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni Kodu in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di Kodu con Wakatime                                                            |
...
| [oh-my-kodu](https://github.com/code-yeongyu/oh-my-kodu)                                   | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni Kodu                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto Kodu                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti Kodu di caricare prompt al bisogno con discovery e injection di skill    |
...
| [@plannotator/kodu](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisione interattiva dei piani con annotazione visiva e condivisione privata/offline             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende kodu /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per Kodu: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per Kodu                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Kodu, costruito sull'SDK    |
| [kodu.nvim](https://github.com/NickvanDyke/kodu.nvim)                              | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Kodu su Tailscale/VPN                    |
| [kodu plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Kodu                               |
| [kodu.nvim](https://github.com/sudo-tee/kodu.nvim)                                 | Frontend Neovim per kodu: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Kodu tramite @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Kodu                   |
| [Kodu-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Kodu nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Kodu      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Kodu con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Kodu                |
