...
Egendefinerte kommandoer kommer i tillegg til de innebygde kommandoene som `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Finn ut mer](/docs/tui#commands).
...
Du kan legge til egendefinerte kommandoer gjennom Kodu-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Kodu [config](/docs/config):
...
- Globalt: `~/.config/kodu/commands/`
- Per prosjekt: `.kodu/commands/`
...
Kodu inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
