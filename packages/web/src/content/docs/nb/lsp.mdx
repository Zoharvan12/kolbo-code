---
title: LSP-servere
description: kodu integreres med LSP-serverne dine.
---

Kodu integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Kodu kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `KODU_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når kodu åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Kodu-konfigurasjonen.
