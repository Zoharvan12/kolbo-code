---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala kodu.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

kodu zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie kodu uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI kodu, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do kodu. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `kodu.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `KODU_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
