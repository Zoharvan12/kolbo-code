---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Kodu.
---
...
Kodu Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Kodu.

:::note
Kodu Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w Kodu. Logujesz się do Kodu Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Kodu.
:::
...
Kodu Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Kodu Zen działa jak każdy inny dostawca w Kodu.

1. Logujesz się do **<a href={console}>Kodu Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Kodu Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Kodu używa formatu
`kodu/<model-id>`. Na przykład dla GPT 5.3 Codex użyjesz w konfiguracji
`kodu/gpt-5.3-codex`.
...
- MiniMax M2.5 Free jest dostępny w Kodu przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Pro Free jest dostępny w Kodu przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Omni Free jest dostępny w Kodu przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Qwen3.6 Plus Free jest dostępny w Kodu przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w Kodu przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Kodu przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Kodu także dowolnego innego dostawcy.
