...
Comandos personalizados são adicionais aos comandos integrados como `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`. [Saiba mais](/docs/tui#commands).
...
Você pode adicionar comandos personalizados através da configuração do kodu ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do kodu:
...
kodu inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
