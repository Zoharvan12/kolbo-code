---
title: TUI
description: Использование TUI kodu.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

kodu предоставляет интерактивный terminal интерфейс или TUI для работы над вашими проектами с помощью LLM.

Запуск kodu запускает TUI для текущего каталога.
...
При использовании kodu TUI вы можете ввести `/`, а затем имя команды, чтобы быстро выполнить действия. Например:
...
Добавьте провайдера в kodu. Позволяет выбирать из доступных поставщиков и добавлять их ключи API.
...
Выйдите из kodu. _Псевдонимы_: `/quit`, `/q`
...
Это отдельный файл от `kodu.json`, который настраивает поведение сервера/выполнения.
...
Используйте `KODU_TUI_CONFIG` для загрузки пользовательского пути конфигурации TUI.
