...
คำสั่งแบบกำหนดเองเป็นส่วนเพิ่มเติมจากคำสั่งในตัว เช่น `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Kodu:
...
- ระดับผู้ใช้ (Global): `~/.config/kodu/commands/`
- ระดับโปรเจ็กต์: `.kodu/commands/`
...
Kodu มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/rewind`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
