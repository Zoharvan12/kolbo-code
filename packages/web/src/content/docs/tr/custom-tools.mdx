---
title: Özel Araçlar
description: LLM'un kodu'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. kodu'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.kodu/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/kodu/tools/` içine yerleştirerek.
