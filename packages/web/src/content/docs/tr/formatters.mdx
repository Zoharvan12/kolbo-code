...
description: kodu dile özgü biçimlendiriciler kullanır.
---

kodu, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

kodu, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, kodu bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

kodu bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri kodu yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
