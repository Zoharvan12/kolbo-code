---
title: Paylasim
description: kodu konusmalarini genel baglantilarla paylasin.
---

kodu'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda kodu:
...
kodu, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak kodu manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `kodu.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda kodu kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
