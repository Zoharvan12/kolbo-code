---
title: Zen
description: kodu tarafından sağlanan seçilmiş modeller listesi.
---
...
Kodu Zen, Kodu ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

:::note
Kodu Zen şu anda beta olarak mevcut.
:::

Zen, Kodu'daki diğer sağlayıcılar gibi çalışır. Kodu Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Kodu kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Kodu ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Kodu Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Kodu Zen, Kodu'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Kodu Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Kodu Zen'i seçin ve API anahtarınızı yapıştırın.
...
Kodu yapılandırmanızdaki [model id](/docs/config/#models) `kodu/<model-id>` biçimini kullanır. Örneğin, GPT 5.3 Codex için yapılandırmanızda `kodu/gpt-5.3-codex` kullanırsınız.
...
- MiniMax M2.5 Free, sınırlı bir süre için Kodu'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Pro Free, sınırlı bir süre için Kodu'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Omni Free, sınırlı bir süre için Kodu'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Qwen3.6 Plus Free, sınırlı bir süre için Kodu'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için Kodu'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Kodu'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Kodu Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Kodu ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
